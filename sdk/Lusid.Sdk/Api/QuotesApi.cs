...
namespace Lusid.Sdk.Api
{
    ...
    public interface IQuotesApi : IApiAccessor
    {
        ...
        /// <param name="effectiveFrom">The date/time from which the quote is effective (optional)</param>
        ...
        ApiResponse<DeleteQuotesResponse> DeleteQuoteWithHttpInfo (string scope, string id = null, DateTimeOffset? effectiveFrom = null);
        /// <summary>
        /// Get quotes
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<ResourceListOfQuote> GetQuotesWithHttpInfo (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        /// <summary>
        /// Add quotes
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the quotes</param>
        /// <param name="quotes">The quotes to add (optional)</param>
        /// <param name="effectiveAt">Optional. The date/time from which the quotes are effective (optional)</param>
        ...
        ApiResponse<UpsertQuotesResponse> UpsertQuotesWithHttpInfo (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null);
        ...
        System.Threading.Tasks.Task<DeleteQuotesResponse> DeleteQuoteAsync (string scope, string id = null, DateTimeOffset? effectiveFrom = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeleteQuotesResponse>> DeleteQuoteAsyncWithHttpInfo (string scope, string id = null, DateTimeOffset? effectiveFrom = null);
        /// <summary>
        /// Get quotes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfQuote> GetQuotesAsync (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfQuote>> GetQuotesAsyncWithHttpInfo (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        /// <summary>
        /// Add quotes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertQuotesResponse> UpsertQuotesAsync (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertQuotesResponse>> UpsertQuotesAsyncWithHttpInfo (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null);
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        /// <summary>
        /// Delete a quote Delete the specified quote. In order for a quote to be deleted the id and effectiveFrom date must exactly match.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the quote</param>
        /// <param name="id">The quote id (optional)</param>
        /// <param name="effectiveFrom">The date/time from which the quote is effective (optional)</param>
        /// <returns>DeleteQuotesResponse</returns>
        public DeleteQuotesResponse DeleteQuote (string scope, string id = null, DateTimeOffset? effectiveFrom = null)
        {
             ApiResponse<DeleteQuotesResponse> localVarResponse = DeleteQuoteWithHttpInfo(scope, id, effectiveFrom);
        ...
        /// <param name="effectiveFrom">The date/time from which the quote is effective (optional)</param>
        /// <returns>ApiResponse of DeleteQuotesResponse</returns>
        public ApiResponse< DeleteQuotesResponse > DeleteQuoteWithHttpInfo (string scope, string id = null, DateTimeOffset? effectiveFrom = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->DeleteQuote");
            ...
            if (effectiveFrom != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "effectiveFrom", effectiveFrom)); // query parameter
        ...
        /// <param name="effectiveFrom">The date/time from which the quote is effective (optional)</param>
        /// <returns>Task of DeleteQuotesResponse</returns>
        public async System.Threading.Tasks.Task<DeleteQuotesResponse> DeleteQuoteAsync (string scope, string id = null, DateTimeOffset? effectiveFrom = null)
        {
             ApiResponse<DeleteQuotesResponse> localVarResponse = await DeleteQuoteAsyncWithHttpInfo(scope, id, effectiveFrom);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveFrom">The date/time from which the quote is effective (optional)</param>
        /// <returns>Task of ApiResponse (DeleteQuotesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeleteQuotesResponse>> DeleteQuoteAsyncWithHttpInfo (string scope, string id = null, DateTimeOffset? effectiveFrom = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->DeleteQuote");
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>ResourceListOfQuote</returns>
        public ResourceListOfQuote GetQuotes (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfQuote> localVarResponse = GetQuotesWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>ApiResponse of ResourceListOfQuote</returns>
        public ApiResponse< ResourceListOfQuote > GetQuotesWithHttpInfo (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (scope != null) localVarPathParams.Add("scope", this.Configuration.ApiClient.ParameterToString(scope)); // path parameter
            if (quoteIds != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("multi", "quoteIds", quoteIds)); // query parameter
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>Task of ResourceListOfQuote</returns>
        public async System.Threading.Tasks.Task<ResourceListOfQuote> GetQuotesAsync (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
             ApiResponse<ResourceListOfQuote> localVarResponse = await GetQuotesAsyncWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfQuote)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfQuote>> GetQuotesAsyncWithHttpInfo (string scope, List<string> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->GetQuotes");
        ...
        /// <summary>
        /// Add quotes Add quotes effective at the specified time. If a quote is added with the same id (and is effective at the same time) as an existing quote, then the more recently added quote will be returned when queried
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the quotes</param>
        /// <param name="quotes">The quotes to add (optional)</param>
        /// <param name="effectiveAt">Optional. The date/time from which the quotes are effective (optional)</param>
        /// <returns>UpsertQuotesResponse</returns>
        public UpsertQuotesResponse UpsertQuotes (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null)
        {
             ApiResponse<UpsertQuotesResponse> localVarResponse = UpsertQuotesWithHttpInfo(scope, quotes, effectiveAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">Optional. The date/time from which the quotes are effective (optional)</param>
        /// <returns>ApiResponse of UpsertQuotesResponse</returns>
        public ApiResponse< UpsertQuotesResponse > UpsertQuotesWithHttpInfo (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="effectiveAt">Optional. The date/time from which the quotes are effective (optional)</param>
        /// <returns>Task of UpsertQuotesResponse</returns>
        public async System.Threading.Tasks.Task<UpsertQuotesResponse> UpsertQuotesAsync (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null)
        {
             ApiResponse<UpsertQuotesResponse> localVarResponse = await UpsertQuotesAsyncWithHttpInfo(scope, quotes, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">Optional. The date/time from which the quotes are effective (optional)</param>
        /// <returns>Task of ApiResponse (UpsertQuotesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertQuotesResponse>> UpsertQuotesAsyncWithHttpInfo (string scope, List<UpsertQuoteRequest> quotes = null, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->UpsertQuotes");
