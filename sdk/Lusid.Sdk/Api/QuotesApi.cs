...
namespace Lusid.Sdk.Api
{
    ...
    public interface IQuotesApi : IApiAccessor
    {
        ...
        ApiResponse<GetQuotesResponse> GetQuotesWithHttpInfo (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        /// <summary>
        /// Upsert quotes
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<GetQuotesResponse> GetQuotesAsync (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetQuotesResponse>> GetQuotesAsyncWithHttpInfo (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null);
        /// <summary>
        /// Upsert quotes
        /// </summary>
        /// <remarks>
    ...
    public partial class QuotesApi : IQuotesApi
    {
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>GetQuotesResponse</returns>
        public GetQuotesResponse GetQuotes (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
             ApiResponse<GetQuotesResponse> localVarResponse = GetQuotesWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>ApiResponse of GetQuotesResponse</returns>
        public ApiResponse< GetQuotesResponse > GetQuotesWithHttpInfo (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>Task of GetQuotesResponse</returns>
        public async System.Threading.Tasks.Task<GetQuotesResponse> GetQuotesAsync (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
             ApiResponse<GetQuotesResponse> localVarResponse = await GetQuotesAsyncWithHttpInfo(scope, quoteIds, effectiveAt, asAt, maxAge, page, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">Optional. The number of results per page (optional)</param>
        /// <returns>Task of ApiResponse (GetQuotesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetQuotesResponse>> GetQuotesAsyncWithHttpInfo (string scope, List<QuoteId> quoteIds = null, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, string maxAge = null, int? page = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling QuotesApi->GetQuotes");
