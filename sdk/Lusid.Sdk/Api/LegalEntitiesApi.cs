...
namespace Lusid.Sdk.Api
{
    ...
    public partial class LegalEntitiesApi : ILegalEntitiesApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfLegalEntity> localVarResponse = await ListAllLegalEntitiesWithHttpInfoAsync(effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfLegalEntity> localVarResponse = await ListLegalEntitiesWithHttpInfoAsync(idTypeScope, idTypeCode, effectiveAt, asAt, page, limit, filter, sortBy, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
