...
namespace Lusid.Sdk.Api
{
    ...
    public interface ILegalEntitiesApiSync : IApiAccessor
    {
        ...
        LegalEntity GetLegalEntity(string idTypeScope, string idTypeCode, string code, List<string> propertyKeys = default(List<string>), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> relationshipDefinitionIds = default(List<string>));
        ...
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        Dictionary<string, List<AccessMetadataValue>> PatchLegalEntityAccessMetadata(string idTypeScope, string idTypeCode, string code, List<AccessMetadataOperation> accessMetadataOperation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? effectiveUntil = default(DateTimeOffset?));
        ...
        ApiResponse<UpsertLegalEntitiesResponse> UpsertLegalEntitiesWithHttpInfo(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody);
        /// <summary>
    ...
    public interface ILegalEntitiesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<UpsertLegalEntitiesResponse> UpsertLegalEntitiesAsync(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertLegalEntitiesResponse>> UpsertLegalEntitiesWithHttpInfoAsync(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] UpsertLegalEntity: Upsert Legal Entity
        /// </summary>
        /// <remarks>
    ...
    public partial class LegalEntitiesApi : ILegalEntitiesApi
    {
        ...
        /// <param name="relationshipDefinitionIds">A list of relationship definitions that are used to decorate related entities              onto the legal entity in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}. (optional)</param>
        /// <returns>LegalEntity</returns>
        public LegalEntity GetLegalEntity(string idTypeScope, string idTypeCode, string code, List<string> propertyKeys = default(List<string>), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> relationshipDefinitionIds = default(List<string>))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<LegalEntity> localVarResponse = await GetLegalEntityWithHttpInfoAsync(idTypeScope, idTypeCode, code, propertyKeys, effectiveAt, asAt, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfLegalEntity> localVarResponse = ListAllLegalEntitiesWithHttpInfo(effectiveAt, asAt, page, limit, filter, propertyKeys, relationshipDefinitionIds);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfLegalEntity> localVarResponse = await ListAllLegalEntitiesWithHttpInfoAsync(effectiveAt, asAt, page, limit, filter, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfLegalEntity> localVarResponse = ListLegalEntitiesWithHttpInfo(idTypeScope, idTypeCode, effectiveAt, asAt, page, limit, filter, propertyKeys, relationshipDefinitionIds);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfLegalEntity> localVarResponse = await ListLegalEntitiesWithHttpInfoAsync(idTypeScope, idTypeCode, effectiveAt, asAt, page, limit, filter, propertyKeys, relationshipDefinitionIds, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveUntil">The effective datetime until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next &#39;effectiveAt&#39; datetime of the Access Metadata (optional)</param>
        /// <returns>Dictionary&lt;string, List&lt;AccessMetadataValue&gt;&gt;</returns>
        public Dictionary<string, List<AccessMetadataValue>> PatchLegalEntityAccessMetadata(string idTypeScope, string idTypeCode, string code, List<AccessMetadataOperation> accessMetadataOperation, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? effectiveUntil = default(DateTimeOffset?))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Dictionary<string, List<AccessMetadataValue>>> localVarResponse = await PatchLegalEntityAccessMetadataWithHttpInfoAsync(idTypeScope, idTypeCode, code, accessMetadataOperation, effectiveAt, effectiveUntil, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="requestBody">A collection of requests to create or update Legal Entities.</param>
        /// <returns>UpsertLegalEntitiesResponse</returns>
        public UpsertLegalEntitiesResponse UpsertLegalEntities(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody)
        {
        ...
        /// <param name="requestBody">A collection of requests to create or update Legal Entities.</param>
        /// <returns>ApiResponse of UpsertLegalEntitiesResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<UpsertLegalEntitiesResponse> UpsertLegalEntitiesWithHttpInfo(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of UpsertLegalEntitiesResponse</returns>
        public async System.Threading.Tasks.Task<UpsertLegalEntitiesResponse> UpsertLegalEntitiesAsync(string successMode, Dictionary<string, UpsertLegalEntityRequest> requestBody, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<UpsertLegalEntitiesResponse> localVarResponse = await UpsertLegalEntitiesWithHttpInfoAsync(successMode, requestBody, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
