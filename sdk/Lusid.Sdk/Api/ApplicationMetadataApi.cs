...
namespace Lusid.Sdk.Api
{
    ...
    public interface IApplicationMetadataApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ICollection&lt;AccessControlledAction&gt;</returns>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ICollection&lt;AccessControlledAction&gt;</returns>
        ApiResponse<ICollection<AccessControlledAction>> ListAccessControlledActionsWithHttpInfo ();
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ICollection&lt;AccessControlledAction&gt;</returns>
        System.Threading.Tasks.Task<ICollection<AccessControlledAction>> ListAccessControlledActionsAsync ();
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ICollection&lt;AccessControlledAction&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<ICollection<AccessControlledAction>>> ListAccessControlledActionsAsyncWithHttpInfo ();
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ICollection&lt;AccessControlledAction&gt;</returns>
        public ICollection<AccessControlledAction> ListAccessControlledActions ()
        {
             ApiResponse<ICollection<AccessControlledAction>> localVarResponse = ListAccessControlledActionsWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of ICollection&lt;AccessControlledAction&gt;</returns>
        public ApiResponse< ICollection<AccessControlledAction> > ListAccessControlledActionsWithHttpInfo ()
        {

            var localVarPath = "./api/metadata/access/actions";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListAccessControlledActions", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ICollection<AccessControlledAction>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key,  x => String.Join(",", x.Value.ToArray())),
                (ICollection<AccessControlledAction>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<AccessControlledAction>)));
        }
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ICollection&lt;AccessControlledAction&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<AccessControlledAction>> ListAccessControlledActionsAsync ()
        {
             ApiResponse<ICollection<AccessControlledAction>> localVarResponse = await ListAccessControlledActionsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (ICollection&lt;AccessControlledAction&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ICollection<AccessControlledAction>>> ListAccessControlledActionsAsyncWithHttpInfo ()
        {
