...
namespace Lusid.Sdk.Api
{
    ...
    public partial class PortfolioGroupsApi : IPortfolioGroupsApi
    {
        ...
        /// <summary>
        /// Add portfolio to group Adds a portfolio to a previously defined portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group to which a portfolio is being added</param>
        /// <param name="code">The code of the portfolio group to which a portfolio is being added</param>
        ...
        /// <summary>
        /// Add group to group Adds a portfolio group, as a sub-group, to an existing portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group to which a sub-group is being added</param>
        /// <param name="code">The code of the portfolio group to which a sub-group is being added</param>
        ...
        /// <summary>
        /// Create group Create a new portfolio group.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope into which the portfolio group will be created</param>
        /// <param name="request">The definition of the new portfolio group (optional)</param>
        ...
        /// <summary>
        /// Remove portfolio from group Removes a portfolio from a portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
        ...
        /// <summary>
        /// Delete group Deletes the definition of the specified portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
        ...
        /// <summary>
        /// Remove group from group Remove a portfolio group (sub-group) from a parent portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
        ...
        /// <summary>
        /// Get portfolio group Get the definition of the specified portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
        ...
        /// <summary>
        /// Get commands Gets all commands that modified a specific portfolio group
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
        ...
        /// <summary>
        /// Get a full expansion of a portfolio group Lists all portfolios in a group, and all sub groups. Portfolios are decorated with their properties.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">The code of the portfolio</param>
        ...
        /// <summary>
        /// List groups in scope Lists all portfolio groups in a specified scope
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope</param>
        /// <param name="asAt">Optional. The AsAt date of the data (optional)</param>
        ...
        /// <summary>
        /// Update group Update the definition of the specified existing portfolio group.    Not all elements within a portfolio group definition are modifiable after creation.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio group</param>
        /// <param name="code">The code of the portfolio group</param>
