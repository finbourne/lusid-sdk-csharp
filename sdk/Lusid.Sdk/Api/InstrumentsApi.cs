...
namespace Lusid.Sdk.Api
{
    ...
    public interface IInstrumentsApi : IApiAccessor
    {
        ...
        /// <returns>FindInstrumentsResponse</returns>
        ...
        /// <param name="codeType">The type of codes to search for (optional)</param>
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>ApiResponse of FindInstrumentsResponse</returns>
        ApiResponse<FindInstrumentsResponse> FindExternalInstrumentsWithHttpInfo (string codeType = null, List<string> codes = null);
        /// <summary>
        ...
        /// <param name="codeType">The type of codes to search for (optional)</param>
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>Task of FindInstrumentsResponse</returns>
        System.Threading.Tasks.Task<FindInstrumentsResponse> FindExternalInstrumentsAsync (string codeType = null, List<string> codes = null);
        ...
        /// <param name="codeType">The type of codes to search for (optional)</param>
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>Task of ApiResponse (FindInstrumentsResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<FindInstrumentsResponse>> FindExternalInstrumentsAsyncWithHttpInfo (string codeType = null, List<string> codes = null);
        /// <summary>
        /// Search instrument definition
        /// </summary>
        /// <remarks>
    ...
    public partial class InstrumentsApi : IInstrumentsApi
    {
        ...
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>FindInstrumentsResponse</returns>
        public FindInstrumentsResponse FindExternalInstruments (string codeType = null, List<string> codes = null)
        {
             ApiResponse<FindInstrumentsResponse> localVarResponse = FindExternalInstrumentsWithHttpInfo(codeType, codes);
             return localVarResponse.Data;
        }
        ...
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>ApiResponse of FindInstrumentsResponse</returns>
        public ApiResponse< FindInstrumentsResponse > FindExternalInstrumentsWithHttpInfo (string codeType = null, List<string> codes = null)
        {
            ...
            return new ApiResponse<FindInstrumentsResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key,  x => String.Join(",", x.Value.ToArray())),
                (FindInstrumentsResponse) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(FindInstrumentsResponse)));
        }
        ...
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>Task of FindInstrumentsResponse</returns>
        public async System.Threading.Tasks.Task<FindInstrumentsResponse> FindExternalInstrumentsAsync (string codeType = null, List<string> codes = null)
        {
             ApiResponse<FindInstrumentsResponse> localVarResponse = await FindExternalInstrumentsAsyncWithHttpInfo(codeType, codes);
             return localVarResponse.Data;
        ...
        /// <param name="codes">The collection of instruments to search for (optional)</param>
        /// <returns>Task of ApiResponse (FindInstrumentsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<FindInstrumentsResponse>> FindExternalInstrumentsAsyncWithHttpInfo (string codeType = null, List<string> codes = null)
        {
