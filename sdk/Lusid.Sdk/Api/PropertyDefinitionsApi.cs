...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPropertyDefinitionsApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="propertyKeys">One or more property keys which identify each property that a definition should              be retrieved for. The format for each property key is {domain}/{scope}/{code}, e.g. \&quot;Instrument/system/Name\&quot;.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the property definition/s. (optional)</param>
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the property definition. (optional)</param>
        /// <returns>PropertyDefinition</returns>
    ...
    public partial class PropertyDefinitionsApi : IPropertyDefinitionsApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Get property definition Retrieve the definition of the specified property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="domain">The domain of the specified property.</param>
        /// <param name="scope">The scope of the specified property.</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Update property definition Update display name of specified existing property.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="domain">The domain of the property being updated.</param>
        /// <param name="scope">The scope of the property being updated.</param>
