...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICalendarsApiSync : IApiAccessor
    {
        ...
        Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse> ResolveTenorsWithHttpInfo(ResolveTenorsRequest resolveTenorsRequest, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
    ...
    public interface ICalendarsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse>> ResolveTenorsWithHttpInfoAsync(ResolveTenorsRequest resolveTenorsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EARLY ACCESS] UpdateCalendar: Update a calendar
        /// </summary>
        /// <remarks>
    ...
    public partial class CalendarsApi : ICalendarsApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse> localVarResponse = ResolveTenorsWithHttpInfo(resolveTenorsRequest, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ResolveTenorsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse> ResolveTenorsWithHttpInfo(ResolveTenorsRequest resolveTenorsRequest, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'resolveTenorsRequest' is set
            if (resolveTenorsRequest == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'resolveTenorsRequest' when calling CalendarsApi->ResolveTenors");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ResolveTenorsResponse>("/api/calendars/tenors/resolve", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse> localVarResponse = await ResolveTenorsWithHttpInfoAsync(resolveTenorsRequest, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResolveTenorsResponse>> ResolveTenorsWithHttpInfoAsync(ResolveTenorsRequest resolveTenorsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ResolveTenorsResponse>("/api/calendars/tenors/resolve", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
