...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISystemConfigurationApiSync : IApiAccessor
    {
        ...
        ApiResponse<TransactionSetConfigurationData> CreateConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest transactionConfigurationDataRequest = default(TransactionConfigurationDataRequest));
        /// <summary>
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the transaction types. Defaults              to returning the latest versions if not specified. (optional)</param>
        /// <returns>ApiResponse of TransactionSetConfigurationData</returns>
        ApiResponse<TransactionSetConfigurationData> ListConfigurationTransactionTypesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?));
    ...
    public partial class SystemConfigurationApi : ISystemConfigurationApi
    {
        ...
        /// <param name="transactionConfigurationDataRequest">A transaction type definition. (optional)</param>
        /// <returns>ApiResponse of TransactionSetConfigurationData</returns>
        public Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> CreateConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest transactionConfigurationDataRequest = default(TransactionConfigurationDataRequest))
        {
        ...
        /// <param name="asAt">The asAt datetime at which to retrieve the transaction types. Defaults              to returning the latest versions if not specified. (optional)</param>
        /// <returns>ApiResponse of TransactionSetConfigurationData</returns>
        public Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> ListConfigurationTransactionTypesWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionSetConfigurationData)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData>> ListConfigurationTransactionTypesWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
