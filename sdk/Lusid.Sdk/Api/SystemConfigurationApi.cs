...
namespace Lusid.Sdk.Api
{
    ...
    public interface ISystemConfigurationApiSync : IApiAccessor
    {
        ...
        TransactionSetConfigurationData CreateConfigurationTransactionType (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest));
        ...
        ApiResponse<TransactionSetConfigurationData> CreateConfigurationTransactionTypeWithHttpInfo (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest));
        /// <summary>
    ...
    public interface ISystemConfigurationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TransactionSetConfigurationData> CreateConfigurationTransactionTypeAsync (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest));
        ...
        System.Threading.Tasks.Task<ApiResponse<TransactionSetConfigurationData>> CreateConfigurationTransactionTypeAsyncWithHttpInfo (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest));
        /// <summary>
        /// [EARLY ACCESS] List transaction types
        /// </summary>
        /// <remarks>
    ...
    public partial class SystemConfigurationApi : ISystemConfigurationApi
    {
        ...
        /// <param name="type">A transaction type definition (optional)</param>
        /// <returns>TransactionSetConfigurationData</returns>
        public TransactionSetConfigurationData CreateConfigurationTransactionType (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest))
        {
             Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> localVarResponse = CreateConfigurationTransactionTypeWithHttpInfo(type);
        ...
        /// <param name="type">A transaction type definition (optional)</param>
        /// <returns>ApiResponse of TransactionSetConfigurationData</returns>
        public Lusid.Sdk.Client.ApiResponse< TransactionSetConfigurationData > CreateConfigurationTransactionTypeWithHttpInfo (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest))
        {
        ...
        /// <param name="type">A transaction type definition (optional)</param>
        /// <returns>Task of TransactionSetConfigurationData</returns>
        public async System.Threading.Tasks.Task<TransactionSetConfigurationData> CreateConfigurationTransactionTypeAsync (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest))
        {
             Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> localVarResponse = await CreateConfigurationTransactionTypeAsyncWithHttpInfo(type);
             return localVarResponse.Data;
        ...
        /// <param name="type">A transaction type definition (optional)</param>
        /// <returns>Task of ApiResponse (TransactionSetConfigurationData)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData>> CreateConfigurationTransactionTypeAsyncWithHttpInfo (TransactionConfigurationDataRequest type = default(TransactionConfigurationDataRequest))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<TransactionSetConfigurationData>("/api/systemconfiguration/transactions/type", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> localVarResponse = ListConfigurationTransactionTypesWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of TransactionSetConfigurationData</returns>
        public Lusid.Sdk.Client.ApiResponse< TransactionSetConfigurationData > ListConfigurationTransactionTypesWithHttpInfo ()
        {
            Lusid.Sdk.Client.RequestOptions localVarRequestOptions = new Lusid.Sdk.Client.RequestOptions();
        ...
        {
             Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData> localVarResponse = await ListConfigurationTransactionTypesAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (TransactionSetConfigurationData)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<TransactionSetConfigurationData>> ListConfigurationTransactionTypesAsyncWithHttpInfo ()
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<TransactionSetConfigurationData>("/api/systemconfiguration/transactions", localVarRequestOptions, this.Configuration);
