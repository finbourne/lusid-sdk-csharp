...
namespace Lusid.Sdk.Api
{
    ...
    public partial class RelationDefinitionsApi : IRelationDefinitionsApi
    {
        ...
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteRelationDefinitionWithHttpInfo(string scope, string code, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling RelationDefinitionsApi->DeleteRelationDefinition");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling RelationDefinitionsApi->DeleteRelationDefinition");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Delete<DeletedEntityResponse>("/api/relationdefinitions/{scope}/{code}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse>> DeleteRelationDefinitionWithHttpInfoAsync(string scope, string code, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.DeleteAsync<DeletedEntityResponse>("/api/relationdefinitions/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
