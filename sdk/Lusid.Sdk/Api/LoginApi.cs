...
namespace Lusid.Sdk.Api
{
    ...
    public partial class LoginApi : ILoginApi
    {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<string> localVarResponse = await GetSamlIdentityProviderIdAsyncWithHttpInfo(domain);
             return localVarResponse.Data;
        ...
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<string>> GetSamlIdentityProviderIdAsyncWithHttpInfo (string domain)
        {
            // verify the required parameter 'domain' is set
            if (domain == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'domain' when calling LoginApi->GetSamlIdentityProviderId");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<string>("/api/login/saml/{domain}", localVarRequestOptions, this.Configuration);
