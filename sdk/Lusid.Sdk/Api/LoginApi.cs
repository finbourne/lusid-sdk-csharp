...
namespace Lusid.Sdk.Api
{
    ...
    public interface ILoginApi : IApiAccessor
    {
        ...
        /// <returns>LusidProblemDetails</returns>
        LusidProblemDetails GetSamlIdentityProviderId (string domain);
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>ApiResponse of LusidProblemDetails</returns>
        ApiResponse<LusidProblemDetails> GetSamlIdentityProviderIdWithHttpInfo (string domain);
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>Task of LusidProblemDetails</returns>
        System.Threading.Tasks.Task<LusidProblemDetails> GetSamlIdentityProviderIdAsync (string domain);
        ...
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>Task of ApiResponse (LusidProblemDetails)</returns>
        System.Threading.Tasks.Task<ApiResponse<LusidProblemDetails>> GetSamlIdentityProviderIdAsyncWithHttpInfo (string domain);
    ...
    public partial class LoginApi : ILoginApi
    {
        ...
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>LusidProblemDetails</returns>
        public LusidProblemDetails GetSamlIdentityProviderId (string domain)
        {
             ApiResponse<LusidProblemDetails> localVarResponse = GetSamlIdentityProviderIdWithHttpInfo(domain);
        ...
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>ApiResponse of LusidProblemDetails</returns>
        public ApiResponse< LusidProblemDetails > GetSamlIdentityProviderIdWithHttpInfo (string domain)
        {
            ...
            return new ApiResponse<LusidProblemDetails>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key,  x => String.Join(",", x.Value.ToArray())),
                (LusidProblemDetails) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(LusidProblemDetails)));
        }
        ...
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>Task of LusidProblemDetails</returns>
        public async System.Threading.Tasks.Task<LusidProblemDetails> GetSamlIdentityProviderIdAsync (string domain)
        {
             ApiResponse<LusidProblemDetails> localVarResponse = await GetSamlIdentityProviderIdAsyncWithHttpInfo(domain);
             return localVarResponse.Data;
        ...
        /// <param name="domain">The domain that the user will be logging in to</param>
        /// <returns>Task of ApiResponse (LusidProblemDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LusidProblemDetails>> GetSamlIdentityProviderIdAsyncWithHttpInfo (string domain)
        {
            // verify the required parameter 'domain' is set
            if (domain == null)
                throw new ApiException(400, "Missing required parameter 'domain' when calling LoginApi->GetSamlIdentityProviderId");
