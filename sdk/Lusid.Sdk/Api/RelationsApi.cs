...
namespace Lusid.Sdk.Api
{
    ...
    public partial class RelationsApi : IRelationsApi
    {
        ...
        /// <summary>
        /// [DEPRECATED] Create Relation Create a relation between two entity objects by their identifiers
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the relation definition</param>
        /// <param name="code">The code of the relation definition</param>
        ...
        /// <summary>
        /// [DEPRECATED] Delete a relation Delete a relation between two entity objects represented by their identifiers
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the relation definition</param>
        /// <param name="code">The code of the relation definition</param>
