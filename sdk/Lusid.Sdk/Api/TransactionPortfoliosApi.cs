...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApi : IApiAccessor
    {
        ...
        ApiResponse<UpsertTransactionPropertiesResponse> UpsertTransactionPropertiesWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        /// <summary>
        ...
        System.Threading.Tasks.Task<UpsertTransactionPropertiesResponse> UpsertTransactionPropertiesAsync (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertTransactionPropertiesResponse>> UpsertTransactionPropertiesAsyncWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        /// <summary>
        /// [EARLY ACCESS] Upsert transactions
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="transactionProperties">The properties with their associated values to update or insert onto the              transaction.</param>
        /// <returns>UpsertTransactionPropertiesResponse</returns>
        public UpsertTransactionPropertiesResponse UpsertTransactionProperties (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
        ...
        /// <param name="transactionProperties">The properties with their associated values to update or insert onto the              transaction.</param>
        /// <returns>ApiResponse of UpsertTransactionPropertiesResponse</returns>
        public ApiResponse< UpsertTransactionPropertiesResponse > UpsertTransactionPropertiesWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="transactionProperties">The properties with their associated values to update or insert onto the              transaction.</param>
        /// <returns>Task of UpsertTransactionPropertiesResponse</returns>
        public async System.Threading.Tasks.Task<UpsertTransactionPropertiesResponse> UpsertTransactionPropertiesAsync (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
        ...
        /// <param name="transactionProperties">The properties with their associated values to update or insert onto the              transaction.</param>
        /// <returns>Task of ApiResponse (UpsertTransactionPropertiesResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertTransactionPropertiesResponse>> UpsertTransactionPropertiesAsyncWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->UpsertTransactionProperties");
