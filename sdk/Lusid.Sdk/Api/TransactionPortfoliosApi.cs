...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="transactionId">The unique id of the transaction to upsert properties against.</param>
        /// <param name="transactionProperties">The properties with their associated values to upsert onto the              transaction.</param>
        ...
        ApiResponse<AddTransactionPropertyResponse> AddTransactionPropertyWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        /// <summary>
        /// Adjust holdings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="effectiveAt">The effectiveAt datetime at which the holdings should be set to the provided targets.</param>
        ...
        /// <param name="asAt">The asAt datetime at which to build the transactions. Defaults to the current              datetime if not specified. (optional)</param>
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Trade\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Trade/strategy/quantsignal\&quot;. (optional)</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="effectiveAt">The effectiveAt datetime at which the holding adjustments should be undone.</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>DeletedEntityResponse</returns>
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        ApiResponse<DeletedEntityResponse> DeleteExecutionsWithHttpInfo (string scope, string code, List<string> executionIds);
        /// <summary>
        ...
        /// <param name="transactionPropertyKey">The property key of the property value to delete from the transaction.              This must be from the \&quot;Trade\&quot; domain and will have the format {domain}/{scope}/{code} e.g.              \&quot;Trade/strategy/quantsignal\&quot;.</param>
        /// <returns>DeletedEntityResponse</returns>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>DeletedEntityResponse</returns>
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        ApiResponse<DeletedEntityResponse> DeleteTransactionsWithHttpInfo (string scope, string code, List<string> transactionIds);
        /// <summary>
        /// Get details
        /// </summary>
        /// <remarks>
        ...
        /// <param name="effectiveAt">The effectiveAt datetime at which to retrieve the details of the transaction              portfolio. Defaults to the current datetime if not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the details of the transaction portfolio. Defaults              to the current datetime if not specified. (optional)</param>
        ...
        /// <param name="effectiveAt">The effectiveAt datetime at which to retrieve the holdings of the transaction              portfolio. Defaults to the current datetime if not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the holdings of the transaction portfolio. Defaults              to the current datetime if not specified. (optional)</param>
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="effectiveAt">The effectiveAt datetime of the holdings adjustment.</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the holdings adjustment. Defaults to the current              datetime if not specified. (optional)</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="fromTransactionDate">The lower bound effectiveAt datetime (inclusive) from which to retrieve the transactions.              There is no lower bound if this is not specified. (optional)</param>
        /// <param name="toTransactionDate">The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions.              There is no upper bound if this is not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the transactions. Defaults to the current              datetime if not specified. (optional)</param>
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Trade\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Trade/strategy/quantsignal\&quot;. (optional)</param>
        /// <param name="filter">Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="fromEffectiveAt">The lower bound effectiveAt datetime (inclusive) from which to retrieve the holdings              adjustments. There is no lower bound if this is not specified. (optional)</param>
        /// <param name="toEffectiveAt">The upper bound effectiveAt datetime (inclusive) from which to retrieve the holdings              adjustments. There is no upper bound if this is not specified. (optional)</param>
        /// <param name="asAt">The asAt datetime at which to retrieve the holdings adjustments. Defaults to the              current datetime if not specified. (optional)</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="executions">The executions to be upserted. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio to upsert details for.</param>
        /// <param name="code">The code of the transaction portfolio to upsert details for. Together with the              scope this uniquely identifies the transaction portfolio.</param>
        /// <param name="effectiveAt">The effectiveAt datetime at which the upserted details should take effect. Defaults              to the current datetime if not specified. (optional)</param>
        /// <param name="details">The details to upsert to the specified transaction portfolio. (optional)</param>
        /// <returns>PortfolioDetails</returns>
        ...
        System.Threading.Tasks.Task<AddTransactionPropertyResponse> AddTransactionPropertyAsync (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        ...
        System.Threading.Tasks.Task<ApiResponse<AddTransactionPropertyResponse>> AddTransactionPropertyAsyncWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties);
        /// <summary>
        /// Adjust holdings
        /// </summary>
        /// <remarks>
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteExecutionsAsync (string scope, string code, List<string> executionIds);
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteExecutionsAsyncWithHttpInfo (string scope, string code, List<string> executionIds);
        /// <summary>
        /// Delete property from transaction
        /// </summary>
        /// <remarks>
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteTransactionsAsync (string scope, string code, List<string> transactionIds);
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteTransactionsAsyncWithHttpInfo (string scope, string code, List<string> transactionIds);
        /// <summary>
        /// Get details
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <summary>
        /// Add transaction property Upsert one or more transaction properties to a single transaction in a transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <param name="transactionProperties">The properties with their associated values to upsert onto the              transaction.</param>
        /// <returns>AddTransactionPropertyResponse</returns>
        public AddTransactionPropertyResponse AddTransactionProperty (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
        ...
        /// <param name="transactionProperties">The properties with their associated values to upsert onto the              transaction.</param>
        /// <returns>ApiResponse of AddTransactionPropertyResponse</returns>
        public ApiResponse< AddTransactionPropertyResponse > AddTransactionPropertyWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
            ...
            if (transactionProperties == null)
                throw new ApiException(400, "Missing required parameter 'transactionProperties' when calling TransactionPortfoliosApi->AddTransactionProperty");
        ...
        /// <param name="transactionProperties">The properties with their associated values to upsert onto the              transaction.</param>
        /// <returns>Task of AddTransactionPropertyResponse</returns>
        public async System.Threading.Tasks.Task<AddTransactionPropertyResponse> AddTransactionPropertyAsync (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
        ...
        /// <param name="transactionProperties">The properties with their associated values to upsert onto the              transaction.</param>
        /// <returns>Task of ApiResponse (AddTransactionPropertyResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<AddTransactionPropertyResponse>> AddTransactionPropertyAsyncWithHttpInfo (string scope, string code, string transactionId, Dictionary<string, PerpetualPropertyValue> transactionProperties)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->AddTransactionProperty");
        ...
        /// <summary>
        /// Build transactions Builds and returns all transactions that affect the holdings of a portfolio over a given interval of  effectiveAt time into a set of output transactions. This includes transactions automatically generated by  LUSID such as holding adjustments.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// Cancel adjust holdings Cancel all previous holding adjustments made on the specified transaction portfolio for a given effectiveAt  datetime. This should be used to undo holding adjustments made via set holdings or adjust holdings.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteExecutions (string scope, string code, List<string> executionIds)
        {
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeleteExecutionsWithHttpInfo (string scope, string code, List<string> executionIds)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (executionIds == null)
                throw new ApiException(400, "Missing required parameter 'executionIds' when calling TransactionPortfoliosApi->DeleteExecutions");
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteExecutionsAsync (string scope, string code, List<string> executionIds)
        {
        ...
        /// <param name="executionIds">The ids of the executions to delete.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteExecutionsAsyncWithHttpInfo (string scope, string code, List<string> executionIds)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->DeleteExecutions");
        ...
        /// <summary>
        /// Delete property from transaction Delete a single property value from a single transaction in a transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// Delete transactions Delete one or more transactions from the specified transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeleteTransactionsWithHttpInfo (string scope, string code, List<string> transactionIds)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (transactionIds == null)
                throw new ApiException(400, "Missing required parameter 'transactionIds' when calling TransactionPortfoliosApi->DeleteTransactions");
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteTransactionsAsync (string scope, string code, List<string> transactionIds)
        {
        ...
        /// <param name="transactionIds">The ids of the transactions to delete.</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteTransactionsAsyncWithHttpInfo (string scope, string code, List<string> transactionIds)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->DeleteTransactions");
        ...
        /// <summary>
        /// Get holdings adjustment Get a holdings adjustment made to a transaction portfolio at a specific effectiveAt datetime. Note that a  holdings adjustment will only be returned if one exists for the specified effectiveAt datetime.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// Get transactions Get the transactions from the specified transaction portfolio over a given interval of effectiveAt time.     When the specified portfolio is a derived transaction portfolio, the returned set of transactions is the  union set of all transactions of the parent (and ancestors) and the specified derived transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// List holdings adjustments List the holdings adjustments made to a transaction portfolio over a given interval of effectiveAt time.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// Upsert executions Upsert executions into the specified transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        ...
        /// <summary>
        /// Upsert portfolio details Upsert details for the specified transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio to upsert details for.</param>
        /// <param name="code">The code of the transaction portfolio to upsert details for. Together with the              scope this uniquely identifies the transaction portfolio.</param>
        ...
        /// <summary>
        /// Upsert transactions Upsert transactions into the specified transaction portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
