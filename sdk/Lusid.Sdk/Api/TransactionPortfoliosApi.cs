...
namespace Lusid.Sdk.Api
{
    ...
    public interface ITransactionPortfoliosApi : IApiAccessor
    {
        ...
        ApiResponse<VersionedResourceListOfOutputTransaction> BuildTransactionsWithHttpInfo (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        ...
        /// <param name="createTransactionPortfolioRequest">The definition and details of the transaction portfolio.</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio to retrieve the CashStatement for.</param>
        /// <param name="code">The code of the portfolio to retrieve the CashStatement for. Together with the scope this              uniquely identifies the portfolio.</param>
        ...
        ApiResponse<UpsertPortfolioExecutionsResponse> UpsertExecutionsWithHttpInfo (string scope, string code, List<ExecutionRequest> executionRequest = null);
        /// <summary>
        ...
        /// <param name="requestBody">The properties with their associated values to update or insert onto the              transaction.</param>
        ...
        /// <param name="scope">The scope of the transaction portfolio.</param>
        /// <param name="code">The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.</param>
        /// <param name="transactionRequest">The transactions to be updated or inserted.</param>
        /// <returns>UpsertPortfolioTransactionsResponse</returns>
        ...
        System.Threading.Tasks.Task<VersionedResourceListOfOutputTransaction> BuildTransactionsAsync (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<VersionedResourceListOfOutputTransaction>> BuildTransactionsAsyncWithHttpInfo (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null);
        /// <summary>
        /// Cancel adjust holdings
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpsertPortfolioExecutionsResponse> UpsertExecutionsAsync (string scope, string code, List<ExecutionRequest> executionRequest = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<UpsertPortfolioExecutionsResponse>> UpsertExecutionsAsyncWithHttpInfo (string scope, string code, List<ExecutionRequest> executionRequest = null);
        /// <summary>
        /// Upsert portfolio details
        /// </summary>
        /// <remarks>
    ...
    public partial class TransactionPortfoliosApi : ITransactionPortfoliosApi
    {
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Transaction\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Transaction/strategy/quantsignal\&quot;. (optional)</param>
        /// <returns>VersionedResourceListOfOutputTransaction</returns>
        public VersionedResourceListOfOutputTransaction BuildTransactions (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<VersionedResourceListOfOutputTransaction> localVarResponse = BuildTransactionsWithHttpInfo(scope, code, transactionQueryParameters, asAt, filter, propertyKeys);
             return localVarResponse.Data;
        }
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Transaction\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Transaction/strategy/quantsignal\&quot;. (optional)</param>
        /// <returns>ApiResponse of VersionedResourceListOfOutputTransaction</returns>
        public ApiResponse< VersionedResourceListOfOutputTransaction > BuildTransactionsWithHttpInfo (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Transaction\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Transaction/strategy/quantsignal\&quot;. (optional)</param>
        /// <returns>Task of VersionedResourceListOfOutputTransaction</returns>
        public async System.Threading.Tasks.Task<VersionedResourceListOfOutputTransaction> BuildTransactionsAsync (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null)
        {
             ApiResponse<VersionedResourceListOfOutputTransaction> localVarResponse = await BuildTransactionsAsyncWithHttpInfo(scope, code, transactionQueryParameters, asAt, filter, propertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;Transaction\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Transaction/strategy/quantsignal\&quot;. (optional)</param>
        /// <returns>Task of ApiResponse (VersionedResourceListOfOutputTransaction)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<VersionedResourceListOfOutputTransaction>> BuildTransactionsAsyncWithHttpInfo (string scope, string code, TransactionQueryParameters transactionQueryParameters, DateTimeOffset? asAt = null, string filter = null, List<string> propertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->BuildTransactions");
        ...
        /// <summary>
        /// [EARLY ACCESS] Get CashStatement for the given portfolio. Get CashStatement for the given portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio to retrieve the CashStatement for.</param>
        /// <param name="code">The code of the portfolio to retrieve the CashStatement for. Together with the scope this              uniquely identifies the portfolio.</param>
        ...
        /// <param name="executionRequest">The executions to update or insert. (optional)</param>
        /// <returns>UpsertPortfolioExecutionsResponse</returns>
        public UpsertPortfolioExecutionsResponse UpsertExecutions (string scope, string code, List<ExecutionRequest> executionRequest = null)
        {
             ApiResponse<UpsertPortfolioExecutionsResponse> localVarResponse = UpsertExecutionsWithHttpInfo(scope, code, executionRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="executionRequest">The executions to update or insert. (optional)</param>
        /// <returns>ApiResponse of UpsertPortfolioExecutionsResponse</returns>
        public ApiResponse< UpsertPortfolioExecutionsResponse > UpsertExecutionsWithHttpInfo (string scope, string code, List<ExecutionRequest> executionRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="executionRequest">The executions to update or insert. (optional)</param>
        /// <returns>Task of UpsertPortfolioExecutionsResponse</returns>
        public async System.Threading.Tasks.Task<UpsertPortfolioExecutionsResponse> UpsertExecutionsAsync (string scope, string code, List<ExecutionRequest> executionRequest = null)
        {
             ApiResponse<UpsertPortfolioExecutionsResponse> localVarResponse = await UpsertExecutionsAsyncWithHttpInfo(scope, code, executionRequest);
             return localVarResponse.Data;
        ...
        /// <param name="executionRequest">The executions to update or insert. (optional)</param>
        /// <returns>Task of ApiResponse (UpsertPortfolioExecutionsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpsertPortfolioExecutionsResponse>> UpsertExecutionsAsyncWithHttpInfo (string scope, string code, List<ExecutionRequest> executionRequest = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling TransactionPortfoliosApi->UpsertExecutions");
