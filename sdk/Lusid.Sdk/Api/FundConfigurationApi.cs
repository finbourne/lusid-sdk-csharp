...
namespace Lusid.Sdk.Api
{
    ...
    public interface IFundConfigurationApiSync : IApiAccessor
    {
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        ApiResponse<FundConfiguration> PatchFundConfigurationWithHttpInfo(string scope, string code, List<Operation> operation, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
    ...
    public interface IFundConfigurationApiAsync : IApiAccessor
    {
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (FundConfiguration)</returns>
        System.Threading.Tasks.Task<ApiResponse<FundConfiguration>> PatchFundConfigurationWithHttpInfoAsync(string scope, string code, List<Operation> operation, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EXPERIMENTAL] UpsertFundConfigurationProperties: Upsert FundConfiguration properties
        /// </summary>
        /// <remarks>
    ...
    public partial class FundConfigurationApi : IFundConfigurationApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = PatchFundConfigurationWithHttpInfo(scope, code, operation, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of FundConfiguration</returns>
        public Lusid.Sdk.Client.ApiResponse<FundConfiguration> PatchFundConfigurationWithHttpInfo(string scope, string code, List<Operation> operation, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<FundConfiguration> localVarResponse = await PatchFundConfigurationWithHttpInfoAsync(scope, code, operation, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
