...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICorporateActionSourcesApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">Optional. The start effective date of the data (optional)</param>
        ...
        ApiResponse<DeletedEntityResponse> DeleteCorporateActionSourceWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="effectiveAt">Optional. The start effective date of the data range (optional)</param>
        /// <param name="asAt">Optional. The AsAt date of the data (optional)</param>
        /// <param name="sortBy">Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)</param>
        /// <param name="start">Optional. When paginating, skip this number of results (optional)</param>
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many (optional)</param>
        ...
        ApiResponse<ResourceListOfCorporateActionSource> ListCorporateActionSourcesWithHttpInfo (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteCorporateActionSourceAsync (string scope, string code, DateTimeOffset? effectiveAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteCorporateActionSourceAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null);
        /// <summary>
        /// Get corporate actions
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ResourceListOfCorporateActionSource> ListCorporateActionSourcesAsync (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfCorporateActionSource>> ListCorporateActionSourcesAsyncWithHttpInfo (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
    ...
    public partial class CorporateActionSourcesApi : ICorporateActionSourcesApi
    {
        ...
        /// <param name="effectiveAt">Optional. The start effective date of the data (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteCorporateActionSource (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
             ApiResponse<DeletedEntityResponse> localVarResponse = DeleteCorporateActionSourceWithHttpInfo(scope, code, effectiveAt);
             return localVarResponse.Data;
        }
        ...
        /// <param name="effectiveAt">Optional. The start effective date of the data (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeleteCorporateActionSourceWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="effectiveAt">Optional. The start effective date of the data (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteCorporateActionSourceAsync (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
             ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteCorporateActionSourceAsyncWithHttpInfo(scope, code, effectiveAt);
             return localVarResponse.Data;
        ...
        /// <param name="effectiveAt">Optional. The start effective date of the data (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteCorporateActionSourceAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CorporateActionSourcesApi->DeleteCorporateActionSource");
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ResourceListOfCorporateActionSource</returns>
        public ResourceListOfCorporateActionSource ListCorporateActionSources (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfCorporateActionSource> localVarResponse = ListCorporateActionSourcesWithHttpInfo(effectiveAt, asAt, sortBy, start, limit, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of ResourceListOfCorporateActionSource</returns>
        public ApiResponse< ResourceListOfCorporateActionSource > ListCorporateActionSourcesWithHttpInfo (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ResourceListOfCorporateActionSource</returns>
        public async System.Threading.Tasks.Task<ResourceListOfCorporateActionSource> ListCorporateActionSourcesAsync (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfCorporateActionSource> localVarResponse = await ListCorporateActionSourcesAsyncWithHttpInfo(effectiveAt, asAt, sortBy, start, limit, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfCorporateActionSource)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfCorporateActionSource>> ListCorporateActionSourcesAsyncWithHttpInfo (DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
