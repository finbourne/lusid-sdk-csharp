...
namespace Lusid.Sdk.Api
{
    ...
    public interface ICorporateActionsApi : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfCorporateAction> GetCorporateActionsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ResourceListOfCorporateAction> GetCorporateActionsAsync (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfCorporateAction>> GetCorporateActionsAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
    ...
    public partial class CorporateActionsApi : ICorporateActionsApi
    {
        ...
        /// <returns></returns>
        public CorporateActionsApi(Lusid.Sdk.Client.Configuration configuration = null)
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ResourceListOfCorporateAction</returns>
        public ResourceListOfCorporateAction GetCorporateActions (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfCorporateAction> localVarResponse = GetCorporateActionsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of ResourceListOfCorporateAction</returns>
        public ApiResponse< ResourceListOfCorporateAction > GetCorporateActionsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ResourceListOfCorporateAction</returns>
        public async System.Threading.Tasks.Task<ResourceListOfCorporateAction> GetCorporateActionsAsync (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfCorporateAction> localVarResponse = await GetCorporateActionsAsyncWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfCorporateAction)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfCorporateAction>> GetCorporateActionsAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling CorporateActionsApi->GetCorporateActions");
