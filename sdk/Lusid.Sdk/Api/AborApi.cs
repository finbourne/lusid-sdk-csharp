...
namespace Lusid.Sdk.Api
{
    ...
    public interface IAborApiSync : IApiAccessor
    {
        ...
        /// <param name="page">The pagination token to use to continue listing Abor; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)</param>
        ...
        PagedResourceListOfAbor ListAbors(DateTimeOrCutLabel? effectiveAt = default(DateTimeOrCutLabel?), DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int? start = default(int?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0);
        ...
        /// <param name="page">The pagination token to use to continue listing diary entries; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)</param>
        /// <param name="limit">When paginating, limit the results to this number. Defaults to 100 if not specified. (optional)</param>
    ...
    public partial class AborApi : IAborApi
    {
        ...
        public Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfJournalEntryLine> GetJELinesWithHttpInfo(string scope, string code, JELinesQueryParameters jELinesQueryParameters, DateTimeOffset? asAt = default(DateTimeOffset?), int? limit = default(int?), string? page = default(string?), int operationIndex = 0)
        {
            ...
            localVarRequestOptions.Operation = "AborApi.GetJELines";
            localVarRequestOptions.OperationIndex = operationIndex;
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfAbor> localVarResponse = ListAborsWithHttpInfo(effectiveAt, asAt, page, start, limit, filter, propertyKeys);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfAbor> localVarResponse = await ListAborsWithHttpInfoAsync(effectiveAt, asAt, page, start, limit, filter, propertyKeys, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfDiaryEntry> localVarResponse = await ListDiaryEntriesWithHttpInfoAsync(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
