...
namespace Lusid.Sdk.Api
{
    ...
    public interface IDerivedTransactionPortfoliosApi : IApiAccessor
    {
        ...
        ApiResponse<DeletedEntityResponse> DeleteDerivedPortfolioDetailsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null);
        ...
        System.Threading.Tasks.Task<DeletedEntityResponse> DeleteDerivedPortfolioDetailsAsync (string scope, string code, DateTimeOffset? effectiveAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteDerivedPortfolioDetailsAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null);
    ...
    public partial class DerivedTransactionPortfoliosApi : IDerivedTransactionPortfoliosApi
    {
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeleteDerivedPortfolioDetails (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeleteDerivedPortfolioDetailsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeleteDerivedPortfolioDetailsAsync (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
        ...
        /// <param name="effectiveAt">The effective date of the change (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeleteDerivedPortfolioDetailsAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling DerivedTransactionPortfoliosApi->DeleteDerivedPortfolioDetails");
