...
namespace Lusid.Sdk.Api
{
    ...
    public interface IFundsApiSync : IApiAccessor
    {
        ...
        /// <param name="scope">The scope of the Fund.</param>
        /// <param name="code">The code of the Fund. Together with the scope this uniquely identifies the Fund.</param>
        /// <param name="seriesDefinitionRequest">The definitions of the Series to add.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="opts">Options for this request.</param>
        /// <returns>Fund</returns>
    ...
    public partial class FundsApi : IFundsApi
    {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = AddAllocationGroupsWithHttpInfo(scope, code, allocationGroupDefinition, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of Fund</returns>
        public Lusid.Sdk.Client.ApiResponse<Fund> AddAllocationGroupsWithHttpInfo(string scope, string code, List<AllocationGroupDefinition> allocationGroupDefinition, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->AddAllocationGroups");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->AddAllocationGroups");
            }

            // verify the required parameter 'allocationGroupDefinition' is set
            if (allocationGroupDefinition == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'allocationGroupDefinition' when calling FundsApi->AddAllocationGroups");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Fund>("/api/funds/{scope}/{code}/allocationgroups", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = await AddAllocationGroupsWithHttpInfoAsync(scope, code, allocationGroupDefinition, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (Fund)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Fund>> AddAllocationGroupsWithHttpInfoAsync(string scope, string code, List<AllocationGroupDefinition> allocationGroupDefinition, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Fund>("/api/funds/{scope}/{code}/allocationgroups", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Fund</returns>
        public Fund AddSeries(string scope, string code, List<SeriesDefinitionRequest> seriesDefinitionRequest, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = AddSeriesWithHttpInfo(scope, code, seriesDefinitionRequest, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of Fund</returns>
        public Lusid.Sdk.Client.ApiResponse<Fund> AddSeriesWithHttpInfo(string scope, string code, List<SeriesDefinitionRequest> seriesDefinitionRequest, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->AddSeries");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->AddSeries");
            }

            // verify the required parameter 'seriesDefinitionRequest' is set
            if (seriesDefinitionRequest == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'seriesDefinitionRequest' when calling FundsApi->AddSeries");
            }
            ...
            localVarRequestOptions.PathParameters.Add("scope", Lusid.Sdk.Client.ClientUtils.ParameterToString(scope)); // path parameter
            localVarRequestOptions.PathParameters.Add("code", Lusid.Sdk.Client.ClientUtils.ParameterToString(code)); // path parameter
            localVarRequestOptions.Data = seriesDefinitionRequest;

            localVarRequestOptions.Operation = "FundsApi.AddSeries";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Fund>("/api/funds/{scope}/{code}/series", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of Fund</returns>
        public async System.Threading.Tasks.Task<Fund> AddSeriesAsync(string scope, string code, List<SeriesDefinitionRequest> seriesDefinitionRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = await AddSeriesWithHttpInfoAsync(scope, code, seriesDefinitionRequest, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (Fund)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Fund>> AddSeriesWithHttpInfoAsync(string scope, string code, List<SeriesDefinitionRequest> seriesDefinitionRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Fund>("/api/funds/{scope}/{code}/series", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = DeactivateNavTypesWithHttpInfo(scope, code, requestBody, deleteMode, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of Fund</returns>
        public Lusid.Sdk.Client.ApiResponse<Fund> DeactivateNavTypesWithHttpInfo(string scope, string code, List<string> requestBody, string? deleteMode = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->DeactivateNavTypes");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->DeactivateNavTypes");
            }

            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'requestBody' when calling FundsApi->DeactivateNavTypes");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Fund>("/api/funds/{scope}/{code}/deactivateNavTypes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<Fund> localVarResponse = await DeactivateNavTypesWithHttpInfoAsync(scope, code, requestBody, deleteMode, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (Fund)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Fund>> DeactivateNavTypesWithHttpInfoAsync(string scope, string code, List<string> requestBody, string? deleteMode = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Fund>("/api/funds/{scope}/{code}/deactivateNavTypes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteNavActivityAdjustmentsWithHttpInfo(string scope, string code, string valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, string? navTypeCode = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->DeleteNavActivityAdjustments");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->DeleteNavActivityAdjustments");
            }
            ...
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'navActivityAdjustment' when calling FundsApi->DeleteNavActivityAdjustments");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<DeletedEntityResponse>("/api/funds/{scope}/{code}/navAdjustment/$delete", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse>> DeleteNavActivityAdjustmentsWithHttpInfoAsync(string scope, string code, string valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, string? navTypeCode = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DeletedEntityResponse>("/api/funds/{scope}/{code}/navAdjustment/$delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = DeleteValuationPointWithHttpInfo(scope, code, diaryEntryCode, diaryEntryCodeVariant, navTypeCode, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteValuationPointWithHttpInfo(string scope, string code, string diaryEntryCode, string? diaryEntryCodeVariant = default(string?), string? navTypeCode = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
            ...
            if (diaryEntryCodeVariant != null)
            {
                ...
                localVarRequestOptions.QueryParameters.Add(Lusid.Sdk.Client.ClientUtils.ParameterToMultiMap("", "diaryEntryCodeVariant", diaryEntryCodeVariant));
            }
            if (navTypeCode != null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> localVarResponse = await DeleteValuationPointWithHttpInfoAsync(scope, code, diaryEntryCode, diaryEntryCodeVariant, navTypeCode, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfHoldingContributor> GetHoldingContributorsForFundWithHttpInfo(string scope, string code, long holdingId, ValuationPointDataQueryParameters valuationPointDataQueryParameters, string? navTypeCode = default(string?), bool? includeHistoric = default(bool?), string? taxLotId = default(string?), bool? includeUnsettledMovements = default(bool?), int? limit = default(int?), DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->GetHoldingContributorsForFund");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<VersionedResourceListOfHoldingContributor>("/api/funds/{scope}/{code}/holdings/{holdingId}/contributors", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<VersionedResourceListOfHoldingContributor>> GetHoldingContributorsForFundWithHttpInfoAsync(string scope, string code, long holdingId, ValuationPointDataQueryParameters valuationPointDataQueryParameters, string? navTypeCode = default(string?), bool? includeHistoric = default(bool?), string? taxLotId = default(string?), bool? includeUnsettledMovements = default(bool?), int? limit = default(int?), DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<VersionedResourceListOfHoldingContributor>("/api/funds/{scope}/{code}/holdings/{holdingId}/contributors", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ValuationPointResourceListOfTrialBalance> localVarResponse = GetValuationPointTrialBalanceWithHttpInfo(scope, code, valuationPointDataQueryParameters, generalLedgerProfileCode, asAt, filter, limit, page, propertyKeys, navTypeCode, excludeCleardownModule, opts: opts);
            return localVarResponse.Data;
        }
        ...
        public Lusid.Sdk.Client.ApiResponse<ValuationPointResourceListOfTrialBalance> GetValuationPointTrialBalanceWithHttpInfo(string scope, string code, ValuationPointDataQueryParameters valuationPointDataQueryParameters, string? generalLedgerProfileCode = default(string?), DateTimeOffset? asAt = default(DateTimeOffset?), string? filter = default(string?), int? limit = default(int?), string? page = default(string?), List<string>? propertyKeys = default(List<string>?), string? navTypeCode = default(string?), bool? excludeCleardownModule = default(bool?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (excludeCleardownModule != null)
            {
                ...
                localVarRequestOptions.QueryParameters.Add(Lusid.Sdk.Client.ClientUtils.ParameterToMultiMap("", "excludeCleardownModule", excludeCleardownModule));
            }
            localVarRequestOptions.Data = valuationPointDataQueryParameters;
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntry> localVarResponse = ListFundCalendarWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, opts: opts);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntry> localVarResponse = await ListFundCalendarWithHttpInfoAsync(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntries> localVarResponse = ListFundCalendarEntriesWithHttpInfo(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of PagedResourceListOfFundCalendarEntries</returns>
        public Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntries> ListFundCalendarEntriesWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int? limit = default(int?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->ListFundCalendarEntries");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->ListFundCalendarEntries");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PagedResourceListOfFundCalendarEntries>("/api/funds/{scope}/{code}/calendars", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntries> localVarResponse = await ListFundCalendarEntriesWithHttpInfoAsync(scope, code, asAt, page, limit, filter, sortBy, propertyKeys, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfFundCalendarEntries)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<PagedResourceListOfFundCalendarEntries>> ListFundCalendarEntriesWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int? limit = default(int?), string? filter = default(string?), List<string>? sortBy = default(List<string>?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfFundCalendarEntries>("/api/funds/{scope}/{code}/calendars", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfNavActivityAdjustment> ListNavActivityAdjustmentsWithHttpInfo(string scope, string code, string valuationPointCode, string? navTypeCode = default(string?), DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int? limit = default(int?), string? filter = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->ListNavActivityAdjustments");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->ListNavActivityAdjustments");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceListOfNavActivityAdjustment>("/api/funds/{scope}/{code}/navAdjustment", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfNavActivityAdjustment>> ListNavActivityAdjustmentsWithHttpInfoAsync(string scope, string code, string valuationPointCode, string? navTypeCode = default(string?), DateTimeOffset? asAt = default(DateTimeOffset?), string? page = default(string?), int? limit = default(int?), string? filter = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfNavActivityAdjustment>("/api/funds/{scope}/{code}/navAdjustment", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public Lusid.Sdk.Client.ApiResponse<ValuationPointDataResponse> RevertValuationPointToEstimateWithHttpInfo(string scope, string code, RevertValuationPointDataRequest revertValuationPointDataRequest, string? navTypeCode = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->RevertValuationPointToEstimate");
            }
        ...
        public Lusid.Sdk.Client.ApiResponse<DateTimeOffset> UpsertNavActivityAdjustmentsWithHttpInfo(string scope, string code, string valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, string? navTypeCode = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling FundsApi->UpsertNavActivityAdjustments");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'code' when calling FundsApi->UpsertNavActivityAdjustments");
            }
            ...
            if (navActivityAdjustment == null)
            {
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'navActivityAdjustment' when calling FundsApi->UpsertNavActivityAdjustments");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<DateTimeOffset>("/api/funds/{scope}/{code}/navAdjustment", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<DateTimeOffset>> UpsertNavActivityAdjustmentsWithHttpInfoAsync(string scope, string code, string valuationPointCode, List<NavActivityAdjustment> navActivityAdjustment, string? navTypeCode = default(string?), string? valuationPointCodeVariant = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DateTimeOffset>("/api/funds/{scope}/{code}/navAdjustment", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
