...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReferencePortfolioApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>));
        ...
        System.Threading.Tasks.Task<ResourceListOfConstituentsAdjustmentHeader> ListConstituentsAdjustmentsAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAtTime = default(DateTimeOffset?));
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfConstituentsAdjustmentHeader>> ListConstituentsAdjustmentsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAtTime = default(DateTimeOffset?));
        /// <summary>
        /// Add constituents
        /// </summary>
        /// <remarks>
    ...
    public partial class ReferencePortfolioApi : IReferencePortfolioApi
    {
        ...
        {
             Lusid.Sdk.Client.ApiResponse<Portfolio> localVarResponse = CreateReferencePortfolioWithHttpInfo(scope, referencePortfolio);
        ...
        /// <param name="referencePortfolio">The portfolio creation request object</param>
        /// <returns>ApiResponse of Portfolio</returns>
        public Lusid.Sdk.Client.ApiResponse< Portfolio > CreateReferencePortfolioWithHttpInfo (string scope, CreateReferencePortfolioRequest referencePortfolio)
        {
            ...
            if (referencePortfolio == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'referencePortfolio' when calling ReferencePortfolioApi->CreateReferencePortfolio");
            ...
            localVarRequestOptions.Data = referencePortfolio;
        ...
        {
             Lusid.Sdk.Client.ApiResponse<Portfolio> localVarResponse = await CreateReferencePortfolioAsyncWithHttpInfo(scope, referencePortfolio);
             return localVarResponse.Data;
        ...
        /// <param name="referencePortfolio">The portfolio creation request object</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<Portfolio>> CreateReferencePortfolioAsyncWithHttpInfo (string scope, CreateReferencePortfolioRequest referencePortfolio)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ReferencePortfolioApi->CreateReferencePortfolio");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Portfolio>("/api/referenceportfolios/{scope}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="propertyKeys">A list of property keys from the \&quot;Instrument\&quot; or \&quot;ReferenceHolding\&quot; domain to decorate onto              the constituents. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;ReferenceHolding/strategy/quantsignal\&quot;. Defaults to return all available instrument and reference holding properties if not specified. (optional)</param>
        /// <returns>Task of GetReferencePortfolioConstituentsResponse</returns>
        public async System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
             Lusid.Sdk.Client.ApiResponse<GetReferencePortfolioConstituentsResponse> localVarResponse = await GetReferencePortfolioConstituentsAsyncWithHttpInfo(scope, code, effectiveAt, asAt, propertyKeys);
             return localVarResponse.Data;
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<GetReferencePortfolioConstituentsResponse>> GetReferencePortfolioConstituentsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), List<string> propertyKeys = default(List<string>))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetReferencePortfolioConstituentsResponse>("/api/referenceportfolios/{scope}/{code}/constituents", localVarRequestOptions, this.Configuration);
        ...
        public Lusid.Sdk.Client.ApiResponse< ResourceListOfConstituentsAdjustmentHeader > ListConstituentsAdjustmentsWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAtTime = default(DateTimeOffset?))
        {
            ...
            if (asAtTime != null)
            {
                foreach (var _kvp in Lusid.Sdk.Client.ClientUtils.ParameterToMultiMap("", "asAtTime", asAtTime))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        /// <param name="asAtTime">The as-at time for which the result is valid. (optional)</param>
        /// <returns>Task of ResourceListOfConstituentsAdjustmentHeader</returns>
        public async System.Threading.Tasks.Task<ResourceListOfConstituentsAdjustmentHeader> ListConstituentsAdjustmentsAsync (string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAtTime = default(DateTimeOffset?))
        {
             Lusid.Sdk.Client.ApiResponse<ResourceListOfConstituentsAdjustmentHeader> localVarResponse = await ListConstituentsAdjustmentsAsyncWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAtTime);
             return localVarResponse.Data;
        ...
        /// <param name="asAtTime">The as-at time for which the result is valid. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfConstituentsAdjustmentHeader)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfConstituentsAdjustmentHeader>> ListConstituentsAdjustmentsAsyncWithHttpInfo (string scope, string code, DateTimeOrCutLabel fromEffectiveAt, DateTimeOrCutLabel toEffectiveAt, DateTimeOffset? asAtTime = default(DateTimeOffset?))
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ReferencePortfolioApi->ListConstituentsAdjustments");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfConstituentsAdjustmentHeader>("/api/referenceportfolios/{scope}/{code}/constituentsadjustments", localVarRequestOptions, this.Configuration);
        ...
        {
             Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentsResponse> localVarResponse = UpsertReferencePortfolioConstituentsWithHttpInfo(scope, code, constituents);
             return localVarResponse.Data;
        }
        ...
        /// <param name="constituents">The constituents to upload to the portfolio</param>
        /// <returns>ApiResponse of UpsertReferencePortfolioConstituentsResponse</returns>
        public Lusid.Sdk.Client.ApiResponse< UpsertReferencePortfolioConstituentsResponse > UpsertReferencePortfolioConstituentsWithHttpInfo (string scope, string code, UpsertReferencePortfolioConstituentsRequest constituents)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            if (constituents == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'constituents' when calling ReferencePortfolioApi->UpsertReferencePortfolioConstituents");
            ...
            if (code != null)
                localVarRequestOptions.PathParameters.Add("code", Lusid.Sdk.Client.ClientUtils.ParameterToString(code)); // path parameter
            localVarRequestOptions.Data = constituents;
        ...
        {
             Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentsResponse> localVarResponse = await UpsertReferencePortfolioConstituentsAsyncWithHttpInfo(scope, code, constituents);
             return localVarResponse.Data;
        ...
        /// <param name="constituents">The constituents to upload to the portfolio</param>
        /// <returns>Task of ApiResponse (UpsertReferencePortfolioConstituentsResponse)</returns>
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<UpsertReferencePortfolioConstituentsResponse>> UpsertReferencePortfolioConstituentsAsyncWithHttpInfo (string scope, string code, UpsertReferencePortfolioConstituentsRequest constituents)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'scope' when calling ReferencePortfolioApi->UpsertReferencePortfolioConstituents");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<UpsertReferencePortfolioConstituentsResponse>("/api/referenceportfolios/{scope}/{code}/constituents", localVarRequestOptions, this.Configuration);
