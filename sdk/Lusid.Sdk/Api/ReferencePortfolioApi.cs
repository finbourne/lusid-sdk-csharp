...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReferencePortfolioApi : IApiAccessor
    {
        ...
        ApiResponse<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsWithHttpInfo (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetReferencePortfolioConstituentsResponse>> GetReferencePortfolioConstituentsAsyncWithHttpInfo (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null);
        /// <summary>
        /// [EARLY ACCESS] Gets constituents adjustments in an interval of effective time.
        /// </summary>
        /// <remarks>
    ...
    public partial class ReferencePortfolioApi : IReferencePortfolioApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Create reference portfolio Create a new reference portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The intended scope of the portfolio</param>
        /// <param name="referencePortfolio">The portfolio creation request object (optional)</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Get constituents Get all the constituents in the specified reference portfolio
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">The code of the portfolio</param>
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>GetReferencePortfolioConstituentsResponse</returns>
        public GetReferencePortfolioConstituentsResponse GetReferencePortfolioConstituents (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>ApiResponse of GetReferencePortfolioConstituentsResponse</returns>
        public ApiResponse< GetReferencePortfolioConstituentsResponse > GetReferencePortfolioConstituentsWithHttpInfo (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>Task of GetReferencePortfolioConstituentsResponse</returns>
        public async System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, string effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
        ...
        /// <summary>
        /// [EARLY ACCESS] Gets constituents adjustments in an interval of effective time. Specify a time period in which you&#39;d like to see the list of times that adjustments where made to this portfolio
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">Code for the portfolio</param>
        ...
        /// <summary>
        /// [EARLY ACCESS] Add constituents Add constituents to the specified reference portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">The code of the portfolio</param>
