...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReferencePortfolioApi : IApiAccessor
    {
        ...
        /// <param name="createReferencePortfolioRequest">The portfolio creation request object</param>
        ...
        /// <param name="upsertReferencePortfolioConstituentsRequest">The constituents to upload to the portfolio</param>
