...
namespace Lusid.Sdk.Api
{
    ...
    public interface IReferencePortfolioApi : IApiAccessor
    {
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        ...
        ApiResponse<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null);
    ...
    public partial class ReferencePortfolioApi : IReferencePortfolioApi
    {
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>GetReferencePortfolioConstituentsResponse</returns>
        public GetReferencePortfolioConstituentsResponse GetReferencePortfolioConstituents (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
             ApiResponse<GetReferencePortfolioConstituentsResponse> localVarResponse = GetReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys);
             return localVarResponse.Data;
        }
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>ApiResponse of GetReferencePortfolioConstituentsResponse</returns>
        public ApiResponse< GetReferencePortfolioConstituentsResponse > GetReferencePortfolioConstituentsWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>Task of GetReferencePortfolioConstituentsResponse</returns>
        public async System.Threading.Tasks.Task<GetReferencePortfolioConstituentsResponse> GetReferencePortfolioConstituentsAsync (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
             ApiResponse<GetReferencePortfolioConstituentsResponse> localVarResponse = await GetReferencePortfolioConstituentsAsyncWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys);
             return localVarResponse.Data;
        ...
        /// <param name="instrumentPropertyKeys">Optional. The Properties of the constituents (optional)</param>
        /// <returns>Task of ApiResponse (GetReferencePortfolioConstituentsResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetReferencePortfolioConstituentsResponse>> GetReferencePortfolioConstituentsAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null, List<string> instrumentPropertyKeys = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ReferencePortfolioApi->GetReferencePortfolioConstituents");
