...
namespace Lusid.Sdk.Api
{
    ...
    public interface IEntitiesApi : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfChange> GetPortfolioChangesWithHttpInfo (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ResourceListOfChange> GetPortfolioChangesAsync (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfChange>> GetPortfolioChangesAsyncWithHttpInfo (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null);
    ...
    public partial class EntitiesApi : IEntitiesApi
    {
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>ResourceListOfChange</returns>
        public ResourceListOfChange GetPortfolioChanges (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null)
        {
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfChange</returns>
        public ApiResponse< ResourceListOfChange > GetPortfolioChangesWithHttpInfo (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null)
        {
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>Task of ResourceListOfChange</returns>
        public async System.Threading.Tasks.Task<ResourceListOfChange> GetPortfolioChangesAsync (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null)
        {
        ...
        /// <param name="asAt">The as-at date of the origin. (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfChange)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfChange>> GetPortfolioChangesAsyncWithHttpInfo (string scope, DateTimeOffset? effectiveAt, DateTimeOffset? asAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling EntitiesApi->GetPortfolioChanges");
