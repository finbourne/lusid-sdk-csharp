...
namespace Lusid.Sdk.Api
{
    ...
    public interface IStructuredResultDataApiSync : IApiAccessor
    {
        ...
        ResourceListOfAddressKeyDefinition GetAddressKeyDefinitionsForDocument(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
        ...
        ApiResponse<ResourceListOfAddressKeyDefinition> GetAddressKeyDefinitionsForDocumentWithHttpInfo(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?));
    ...
    public partial class StructuredResultDataApi : IStructuredResultDataApi
    {
        ...
        /// <param name="asAt">The asAt datetime to query the document for which the address key definitions are retrieved.              Defaults to querying the latest version if not specified. (optional)</param>
        /// <returns>ResourceListOfAddressKeyDefinition</returns>
        public ResourceListOfAddressKeyDefinition GetAddressKeyDefinitionsForDocument(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
        ...
        /// <param name="asAt">The asAt datetime to query the document for which the address key definitions are retrieved.              Defaults to querying the latest version if not specified. (optional)</param>
        /// <returns>ApiResponse of ResourceListOfAddressKeyDefinition</returns>
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfAddressKeyDefinition> GetAddressKeyDefinitionsForDocumentWithHttpInfo(string scope, string code, string source, string resultType, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfAddressKeyDefinition> localVarResponse = await GetAddressKeyDefinitionsForDocumentWithHttpInfoAsync(scope, code, source, resultType, effectiveAt, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
