...
namespace Lusid.Sdk.Api
{
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        public Lusid.Sdk.Client.ApiResponse<DeletedEntityResponse> DeleteKeyFromPortfolioAccessMetadataWithHttpInfo(string scope, string code, string metadataKey, DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel))
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "0.11.3887");
        ...
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = GetPortfolioAggregatedReturnsWithHttpInfo(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt);
            return localVarResponse.Data;
        }
        ...
        public Lusid.Sdk.Client.ApiResponse<ResourceListOfAggregatedReturn> GetPortfolioAggregatedReturnsWithHttpInfo(string scope, string code, string returnScope, string returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, DateTimeOrCutLabel fromEffectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel toEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            ...
            // verify the required parameter 'returnScope' is set
            if (returnScope == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'returnScope' when calling PortfoliosApi->GetPortfolioAggregatedReturns");

            // verify the required parameter 'returnCode' is set
            if (returnCode == null)
                throw new Lusid.Sdk.Client.ApiException(400, "Missing required parameter 'returnCode' when calling PortfoliosApi->GetPortfolioAggregatedReturns");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ResourceListOfAggregatedReturn</returns>
        public async System.Threading.Tasks.Task<ResourceListOfAggregatedReturn> GetPortfolioAggregatedReturnsAsync(string scope, string code, string returnScope, string returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, DateTimeOrCutLabel fromEffectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel toEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Lusid.Sdk.Client.ApiResponse<ResourceListOfAggregatedReturn> localVarResponse = await GetPortfolioAggregatedReturnsWithHttpInfoAsync(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Lusid.Sdk.Client.ApiResponse<ResourceListOfAggregatedReturn>> GetPortfolioAggregatedReturnsWithHttpInfoAsync(string scope, string code, string returnScope, string returnCode, AggregatedReturnsRequest aggregatedReturnsRequest, DateTimeOrCutLabel fromEffectiveAt = default(DateTimeOrCutLabel), DateTimeOrCutLabel toEffectiveAt = default(DateTimeOrCutLabel), DateTimeOffset? asAt = default(DateTimeOffset?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<ResourceListOfAggregatedReturn>("/api/portfolios/{scope}/{code}/returns/{returnScope}/{returnCode}/$aggregated", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
