...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>ApiResponse of Portfolio</returns>
        ApiResponse<Portfolio> UpdatePortfolioWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null);
        /// <summary>
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>Task of Portfolio</returns>
        System.Threading.Tasks.Task<Portfolio> UpdatePortfolioAsync (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null);
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        System.Threading.Tasks.Task<ApiResponse<Portfolio>> UpdatePortfolioAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null);
        /// <summary>
        /// Upsert portfolio properties
        /// </summary>
        /// <remarks>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>Portfolio</returns>
        public Portfolio UpdatePortfolio (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null)
        {
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>ApiResponse of Portfolio</returns>
        public ApiResponse< Portfolio > UpdatePortfolioWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>Task of Portfolio</returns>
        public async System.Threading.Tasks.Task<Portfolio> UpdatePortfolioAsync (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null)
        {
        ...
        /// <param name="request">The updated portfolio definition (optional)</param>
        /// <returns>Task of ApiResponse (Portfolio)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Portfolio>> UpdatePortfolioAsyncWithHttpInfo (string scope, string code, DateTimeOffset? effectiveAt = null, UpdatePortfolioRequest request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling PortfoliosApi->UpdatePortfolio");
