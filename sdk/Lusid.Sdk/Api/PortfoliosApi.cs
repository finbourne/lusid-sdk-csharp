...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="portfolioPropertyKeys">The keys of the properties to be deleted. (optional)</param>
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        ApiResponse<DeletedEntityResponse> DeletePortfolioPropertiesWithHttpInfo (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null);
        /// <summary>
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        System.Threading.Tasks.Task<DeletedEntityResponse> DeletePortfolioPropertiesAsync (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null);
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeletePortfolioPropertiesAsyncWithHttpInfo (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null);
        /// <summary>
        /// [EARLY ACCESS] Get portfolio definition
        /// </summary>
        /// <remarks>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Delete portfolio The deletion of the portfolio will be valid from portfolio&#39;s creation time. This implies the portfolio would no longer exist from the AsAt time of deletion.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">The code of the portfolio</param>
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        public DeletedEntityResponse DeletePortfolioProperties (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null)
        {
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>ApiResponse of DeletedEntityResponse</returns>
        public ApiResponse< DeletedEntityResponse > DeletePortfolioPropertiesWithHttpInfo (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>Task of DeletedEntityResponse</returns>
        public async System.Threading.Tasks.Task<DeletedEntityResponse> DeletePortfolioPropertiesAsync (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null)
        {
        ...
        /// <param name="effectiveAt">Optional. The effective date of the deletion (optional)</param>
        /// <returns>Task of ApiResponse (DeletedEntityResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DeletedEntityResponse>> DeletePortfolioPropertiesAsyncWithHttpInfo (string scope, string code, List<string> portfolioPropertyKeys = null, string effectiveAt = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling PortfoliosApi->DeletePortfolioProperties");
