...
namespace Lusid.Sdk.Api
{
    ...
    public interface IPortfoliosApi : IApiAccessor
    {
        ...
        /// <param name="effectiveAt">The effective datetime at which to delete the properties. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        /// <returns>DeletedEntityResponse</returns>
        ...
        /// <param name="effectiveAt">The effective datetime at which to retrieve the portfolio definition. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        ...
        /// <param name="effectiveAt">The effective datetime at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional)</param>
        ...
        /// </remarks>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="effectiveAt">The effective datetime at which to list the portfolios. Defaults to the current LUSID              system datetime if not specified. (optional)</param>
        ...
        /// <param name="effectiveAt">The effective datetime at which to update the definition. Defaults to the current              LUSID system datetime if not specified. (optional)</param>
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <summary>
        /// [EARLY ACCESS] Delete portfolio properties Delete one or more properties from a single portfolio.
        /// </summary>
        /// <exception cref="Lusid.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio to delete properties from.</param>
        /// <param name="code">The code of the portfolio to delete properties from. Together with the scope this uniquely              identifies the portfolio.</param>
