...
namespace Lusid.Sdk.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("http://local-unit-test-server.lusid.com:55335");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://local-unit-test-server.lusid.com:55335).
        /// </summary>
        ...
        public ApiClient(String basePath = "http://local-unit-test-server.lusid.com:55335")
        {
