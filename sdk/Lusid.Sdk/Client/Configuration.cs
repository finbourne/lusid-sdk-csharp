...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.4314";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.4314/csharp";
            BasePath = "http://local-unit-test-server.lusid.com:59269";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://local-unit-test-server.lusid.com:59269"},
        ...
        public Configuration(
            ...
            string basePath = "http://local-unit-test-server.lusid.com:59269") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.4314\n";
            report += "    SDK Package Version: 0.11.4314\n";
