...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.4063";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.4063/csharp";
            BasePath = "http://local-unit-test-server.lusid.com:46280";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://local-unit-test-server.lusid.com:46280"},
        ...
        public Configuration(
            ...
            string basePath = "http://local-unit-test-server.lusid.com:46280") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.4063\n";
            report += "    SDK Package Version: 0.11.4063\n";
