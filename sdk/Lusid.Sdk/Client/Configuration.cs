...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.10.689";
        ...
        {
            UserAgent = "OpenAPI-Generator/0.10.689/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/0.10.689/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.10.689\n";
            report += "    SDK Package Version: 0.10.689\n";
