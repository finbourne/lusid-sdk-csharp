...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.10.290";
        ...
        {
            UserAgent = "OpenAPI-Generator/0.10.290/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "OpenAPI-Generator/0.10.290/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.10.290\n";
            report += "    SDK Package Version: 0.10.290\n";
