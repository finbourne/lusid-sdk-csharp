...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.4087";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.4087/csharp";
            BasePath = "http://local-unit-test-server.lusid.com:62490";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://local-unit-test-server.lusid.com:62490"},
        ...
        public Configuration(
            ...
            string basePath = "http://local-unit-test-server.lusid.com:62490") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.4087\n";
            report += "    SDK Package Version: 0.11.4087\n";
