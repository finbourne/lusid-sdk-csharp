...
namespace Lusid.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "0.11.4259";
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/0.11.4259/csharp";
            BasePath = "http://local-unit-test-server.lusid.com:35172";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "http://local-unit-test-server.lusid.com:35172"},
        ...
        public Configuration(
            ...
            string basePath = "http://local-unit-test-server.lusid.com:35172") : this()
        {
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 0.11.4259\n";
            report += "    SDK Package Version: 0.11.4259\n";
