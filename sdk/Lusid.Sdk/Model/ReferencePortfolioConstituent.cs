...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferencePortfolioConstituent :  IEquatable<ReferencePortfolioConstituent>
    {
        ...
        public ReferencePortfolioConstituent(string InstrumentUid = default(string), string Currency = default(string), List<Property> Properties = default(List<Property>), double? Weight = default(double?), double? FloatingWeight = default(double?))
        {
