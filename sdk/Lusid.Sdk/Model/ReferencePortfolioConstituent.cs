...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferencePortfolioConstituent :  IEquatable<ReferencePortfolioConstituent>
    {
        ...
        /// <param name="InstrumentUid">InstrumentUid (required).</param>
        ...
        public ReferencePortfolioConstituent(Dictionary<string, string> InstrumentIdentifiers = default(Dictionary<string, string>), string InstrumentUid = default(string), string Currency = default(string), List<Property> Properties = default(List<Property>), double? Weight = default(double?), double? FloatingWeight = default(double?))
        {
