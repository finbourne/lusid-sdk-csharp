...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AbstainElection")]
    public partial class AbstainElection : IEquatable<AbstainElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstainElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AbstainElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstainElection" /> class.
        /// </summary>
        ...
        public AbstainElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for AbstainElection and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbstainElection {\n");
        ...
        {
            return this.Equals(input as AbstainElection);
        }

        /// <summary>
        /// Returns true if AbstainElection instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstainElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstainElection input)
        {
            if (input == null)
            {
                return false;
