...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SimpleCashFlowLoanAllOf : IEquatable<SimpleCashFlowLoanAllOf>
    {
        /// <summary>
        ...
        public SimpleCashFlowLoanAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), List<LoanPeriod> periods = default(List<LoanPeriod>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for SimpleCashFlowLoanAllOf and cannot be null");
            // to ensure "periods" is required (not null)
            this.Periods = periods ?? throw new ArgumentNullException("periods is a required property for SimpleCashFlowLoanAllOf and cannot be null");
