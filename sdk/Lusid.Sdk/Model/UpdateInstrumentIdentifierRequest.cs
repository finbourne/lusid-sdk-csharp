...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateInstrumentIdentifierRequest :  IEquatable<UpdateInstrumentIdentifierRequest>
    {
        ...
        /// <param name="EffectiveFrom">The date at which the identifier modification is to be effective from. If unset, will  default to &#x60;now&#x60;..</param>
        public UpdateInstrumentIdentifierRequest(TypeEnum? Type = default(TypeEnum?), string Value = default(string), DateTimeOffset? EffectiveFrom = default(DateTimeOffset?))
        {
            this.Type = Type;
            this.Value = Value;
