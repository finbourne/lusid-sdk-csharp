...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorDetailBase :  IEquatable<ErrorDetailBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorDetailBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ErrorDetailBase);
        }

        /// <summary>
        /// Returns true if ErrorDetailBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorDetailBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorDetailBase input)
        {
            if (input == null)
                return false;
