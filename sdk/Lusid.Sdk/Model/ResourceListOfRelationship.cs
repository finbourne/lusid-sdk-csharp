...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfRelationship : IEquatable<ResourceListOfRelationship>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfRelationship(List<Relationship> values = default(List<Relationship>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfRelationship and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
