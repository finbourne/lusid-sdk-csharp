...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EntityIdentifier : IEquatable<EntityIdentifier>
    {
        ...
        public EntityIdentifier(string identifierScope = default(string), string identifierType = default(string), string identifierValue = default(string))
        {
            ...
            this.IdentifierType = identifierType ?? throw new ArgumentNullException("identifierType is a required property for EntityIdentifier and cannot be null");
            // to ensure "identifierValue" is required (not null)
            this.IdentifierValue = identifierValue ?? throw new ArgumentNullException("identifierValue is a required property for EntityIdentifier and cannot be null");
