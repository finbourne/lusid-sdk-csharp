...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityId : IEquatable<CustomEntityId>
    {
        /// <summary>
        ...
        public CustomEntityId(string identifierScope = default(string), string identifierType = default(string), string identifierValue = default(string), DateTimeOffset? effectiveFrom = default(DateTimeOffset?), DateTimeOffset? effectiveUntil = default(DateTimeOffset?))
        {
            ...
            this.IdentifierScope = identifierScope ?? throw new ArgumentNullException("identifierScope is a required property for CustomEntityId and cannot be null");
            // to ensure "identifierType" is required (not null)
            this.IdentifierType = identifierType ?? throw new ArgumentNullException("identifierType is a required property for CustomEntityId and cannot be null");
            // to ensure "identifierValue" is required (not null)
            this.IdentifierValue = identifierValue ?? throw new ArgumentNullException("identifierValue is a required property for CustomEntityId and cannot be null");
