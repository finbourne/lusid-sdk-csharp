...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPlacement : IEquatable<PagedResourceListOfPlacement>
    {
        /// <summary>
        ...
        public PagedResourceListOfPlacement(string nextPage = default(string), string previousPage = default(string), List<Placement> values = default(List<Placement>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfPlacement and cannot be null");
