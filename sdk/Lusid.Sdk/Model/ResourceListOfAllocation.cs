...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAllocation : IEquatable<ResourceListOfAllocation>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfAllocation(List<Allocation> values = default(List<Allocation>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfAllocation and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
