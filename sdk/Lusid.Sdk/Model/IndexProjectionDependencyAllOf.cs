...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndexProjectionDependencyAllOf : IEquatable<IndexProjectionDependencyAllOf>
    {
        /// <summary>
        ...
        public IndexProjectionDependencyAllOf(string currency = default(string), string tenor = default(string), string indexName = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for IndexProjectionDependencyAllOf and cannot be null");
            // to ensure "tenor" is required (not null)
            this.Tenor = tenor ?? throw new ArgumentNullException("tenor is a required property for IndexProjectionDependencyAllOf and cannot be null");
            // to ensure "indexName" is required (not null)
            this.IndexName = indexName ?? throw new ArgumentNullException("indexName is a required property for IndexProjectionDependencyAllOf and cannot be null");
            this.Date = date;
