...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfReconciliationBreak :  IEquatable<ResourceListOfReconciliationBreak>
    {
        ...
        public ResourceListOfReconciliationBreak(List<ReconciliationBreak> values = default(List<ReconciliationBreak>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
