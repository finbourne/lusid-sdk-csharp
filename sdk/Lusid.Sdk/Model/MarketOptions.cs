...
namespace Lusid.Sdk.Model
{
    ...
    public partial class MarketOptions : IEquatable<MarketOptions>
    {
        ...
        /// <param name="conventionScope">The scope in which holiday calendars stored.</param>
        public MarketOptions(string defaultSupplier = default(string), string defaultInstrumentCodeType = default(string), string defaultScope = default(string), bool attemptToInferMissingFx = default(bool), string calendarScope = default(string), string conventionScope = default(string))
        {
            ...
            this.DefaultScope = defaultScope ?? throw new ArgumentNullException("defaultScope is a required property for MarketOptions and cannot be null");
        ...
        [DataMember(Name = "defaultScope", IsRequired = true, EmitDefaultValue = false)]
