...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Execution : IEquatable<Execution>
    {
        ...
        public Execution(ResourceId id = default(ResourceId), ResourceId placementId = default(ResourceId), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string lusidInstrumentId = default(string), decimal quantity = default(decimal), string state = default(string), string side = default(string), string type = default(string), DateTimeOffset createdDate = default(DateTimeOffset), DateTimeOffset? settlementDate = default(DateTimeOffset?), CurrencyAndAmount price = default(CurrencyAndAmount), string settlementCurrency = default(string), decimal settlementCurrencyFxRate = default(decimal), string counterparty = default(string), decimal? averagePrice = default(decimal?), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Execution and cannot be null");
            // to ensure "placementId" is required (not null)
            this.PlacementId = placementId ?? throw new ArgumentNullException("placementId is a required property for Execution and cannot be null");
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for Execution and cannot be null");
            // to ensure "lusidInstrumentId" is required (not null)
            this.LusidInstrumentId = lusidInstrumentId ?? throw new ArgumentNullException("lusidInstrumentId is a required property for Execution and cannot be null");
            this.Quantity = quantity;
            // to ensure "state" is required (not null)
            this.State = state ?? throw new ArgumentNullException("state is a required property for Execution and cannot be null");
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for Execution and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Execution and cannot be null");
            this.CreatedDate = createdDate;
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price is a required property for Execution and cannot be null");
            // to ensure "settlementCurrency" is required (not null)
            this.SettlementCurrency = settlementCurrency ?? throw new ArgumentNullException("settlementCurrency is a required property for Execution and cannot be null");
            this.SettlementCurrencyFxRate = settlementCurrencyFxRate;
            // to ensure "counterparty" is required (not null)
            this.Counterparty = counterparty ?? throw new ArgumentNullException("counterparty is a required property for Execution and cannot be null");
