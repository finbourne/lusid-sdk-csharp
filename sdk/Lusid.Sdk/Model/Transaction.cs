...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        /// Initializes a new instance of the <see cref="Transaction" /> class.
        /// </summary>
        /// <param name="TransactionId">Unique transaction identifier (required).</param>
        /// <param name="Type">LUSID transaction type code - Buy, Sell, StockIn, StockOut, etc (required).</param>
        /// <param name="InstrumentUid">Unique instrument identifier (required).</param>
        /// <param name="TransactionDate">Transaction date (required).</param>
        /// <param name="SettlementDate">Settlement date (required).</param>
        /// <param name="Units">Quantity of transaction in units of the instrument (required).</param>
        /// <param name="TransactionPrice">Execution price for the transaction (required).</param>
        /// <param name="TotalConsideration">Total value of the transaction (required).</param>
        /// <param name="ExchangeRate">Rate between transaction and settle currency.</param>
        /// <param name="TransactionCurrency">Transaction currency.</param>
        /// <param name="Properties">Properties.</param>
        /// <param name="CounterpartyId">Counterparty identifier.</param>
        /// <param name="Source">Where this transaction came from (required).</param>
        /// <param name="NettingSet">NettingSet.</param>
        public Transaction(string TransactionId = default(string), string Type = default(string), string InstrumentUid = default(string), DateTimeOffset? TransactionDate = default(DateTimeOffset?), DateTimeOffset? SettlementDate = default(DateTimeOffset?), double? Units = default(double?), TransactionPrice TransactionPrice = default(TransactionPrice), CurrencyAndAmount TotalConsideration = default(CurrencyAndAmount), double? ExchangeRate = default(double?), string TransactionCurrency = default(string), List<PerpetualProperty> Properties = default(List<PerpetualProperty>), string CounterpartyId = default(string), SourceEnum Source = default(SourceEnum), string NettingSet = default(string))
        {
            ...
            {
                throw new InvalidDataException("TransactionPrice is a required property for Transaction and cannot be null");
            }
            else
            {
            ...
            if (Source == null)
            {
                throw new InvalidDataException("Source is a required property for Transaction and cannot be null");
            }
            else
            {
                this.Source = Source;
        ...
        /// </summary>
        /// <value>Quantity of transaction in units of the instrument</value>
        ...
        /// </summary>
        /// <value>Total value of the transaction</value>
        ...
        /// </summary>
        /// <value>Rate between transaction and settle currency</value>
