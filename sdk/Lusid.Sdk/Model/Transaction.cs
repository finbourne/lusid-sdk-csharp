...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        /// <param name="Units">Quantity of trade in units of the instrument (required).</param>
        ...
        /// <param name="ExchangeRate">Rate between transaction and settlement currency.</param>
