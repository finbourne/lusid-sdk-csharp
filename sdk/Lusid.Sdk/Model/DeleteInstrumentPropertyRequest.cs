...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteInstrumentPropertyRequest :  IEquatable<DeleteInstrumentPropertyRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteInstrumentPropertyRequest" /> class.
        /// </summary>
        /// <param name="InstrumentPropertyKey">The property key of the property to be removed from the instrument, e.g &#39;Instrument/default/Cusip&#x60;.</param>
        /// <param name="EffectiveFrom">The date at which the property removal should be effective from. If no value is set, then &#39;now&#39; is used..</param>
        public DeleteInstrumentPropertyRequest(string InstrumentPropertyKey = default(string), DateTimeOffset? EffectiveFrom = default(DateTimeOffset?))
        {
        ...
        /// <summary>
        /// The property key of the property to be removed from the instrument, e.g &#39;Instrument/default/Cusip&#x60;
        /// </summary>
        /// <value>The property key of the property to be removed from the instrument, e.g &#39;Instrument/default/Cusip&#x60;</value>
        [DataMember(Name="instrumentPropertyKey", EmitDefaultValue=false)]
        public string InstrumentPropertyKey { get; set; }

        /// <summary>
        /// The date at which the property removal should be effective from. If no value is set, then &#39;now&#39; is used.
        /// </summary>
        /// <value>The date at which the property removal should be effective from. If no value is set, then &#39;now&#39; is used.</value>
        ...
        {
            return this.Equals(input as DeleteInstrumentPropertyRequest);
        }

        /// <summary>
        /// Returns true if DeleteInstrumentPropertyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteInstrumentPropertyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteInstrumentPropertyRequest input)
        {
            if (input == null)
                return false;
