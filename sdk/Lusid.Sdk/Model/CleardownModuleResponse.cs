...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CleardownModuleResponse : IEquatable<CleardownModuleResponse>, IValidatableObject
    {
        ...
        public CleardownModuleResponse(string href = default(string), string cleardownModuleCode = default(string), ResourceId chartOfAccountsId = default(ResourceId), string displayName = default(string), string description = default(string), List<CleardownModuleRule> rules = default(List<CleardownModuleRule>), string status = default(string), ModelVersion version = default(ModelVersion), List<Link> links = default(List<Link>))
        {
