...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InformationalErrorEventAllOf : IEquatable<InformationalErrorEventAllOf>
    {
        /// <summary>
        ...
        public InformationalErrorEventAllOf(string errorDetail = default(string), string errorReason = default(string), DateTimeOffset effectiveAt = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.ErrorDetail = errorDetail ?? throw new ArgumentNullException("errorDetail is a required property for InformationalErrorEventAllOf and cannot be null");
            // to ensure "errorReason" is required (not null)
            this.ErrorReason = errorReason ?? throw new ArgumentNullException("errorReason is a required property for InformationalErrorEventAllOf and cannot be null");
