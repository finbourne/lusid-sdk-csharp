...
namespace Lusid.Sdk.Model
{
    ...
    public partial class LusidEntityDataset : IEquatable<LusidEntityDataset>, IValidatableObject
    {
        ...
        /// <param name="scope">The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestorRecord, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity)..</param>
        ...
        /// <summary>
        /// The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestorRecord, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity).
        /// </summary>
        /// <value>The scope of the entities to check. Required for scoped entity types (Instrument, Portfolio, InvestorRecord, InvestmentAccount).  Must not be provided for unscoped entity types (LegalEntity).</value>
