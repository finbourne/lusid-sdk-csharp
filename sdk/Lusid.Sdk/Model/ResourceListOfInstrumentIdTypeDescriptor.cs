...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfInstrumentIdTypeDescriptor :  IEquatable<ResourceListOfInstrumentIdTypeDescriptor>
    {
        ...
        public ResourceListOfInstrumentIdTypeDescriptor(List<InstrumentIdTypeDescriptor> values = default(List<InstrumentIdTypeDescriptor>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
