...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionConfigurationData : IEquatable<TransactionConfigurationData>, IValidatableObject
    {
        ...
        public TransactionConfigurationData(List<TransactionConfigurationTypeAlias> aliases = default(List<TransactionConfigurationTypeAlias>), List<TransactionConfigurationMovementData> movements = default(List<TransactionConfigurationMovementData>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
            ...
            if (aliases == null)
            {
                throw new ArgumentNullException("aliases is a required property for TransactionConfigurationData and cannot be null");
            }
            this.Aliases = aliases;
            // to ensure "movements" is required (not null)
            if (movements == null)
            {
                throw new ArgumentNullException("movements is a required property for TransactionConfigurationData and cannot be null");
            }
