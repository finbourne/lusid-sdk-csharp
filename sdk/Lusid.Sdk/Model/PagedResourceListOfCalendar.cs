...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCalendar : IEquatable<PagedResourceListOfCalendar>
    {
        /// <summary>
        ...
        public PagedResourceListOfCalendar(string nextPage = default(string), string previousPage = default(string), List<Calendar> values = default(List<Calendar>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfCalendar and cannot be null");
