...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QuoteSeriesId : IEquatable<QuoteSeriesId>
    {
        ...
        /// </summary>
        /// <value>The type of the quote. This allows for quotes other than prices e.g. rates or spreads to be used. The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// Initializes a new instance of the <see cref="QuoteSeriesId" /> class.
        /// </summary>
        /// <param name="provider">The platform or vendor that provided the quote. The available values are: Client, DataScope, Lusid, Edi, TraderMade, FactSet, SIX, Bloomberg, Rimes (required).</param>
