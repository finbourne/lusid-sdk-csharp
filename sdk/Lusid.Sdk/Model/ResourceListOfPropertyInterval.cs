...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPropertyInterval : IEquatable<ResourceListOfPropertyInterval>
    {
        /// <summary>
        ...
        public ResourceListOfPropertyInterval(List<PropertyInterval> values = default(List<PropertyInterval>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPropertyInterval and cannot be null");
            this.Href = href;
            this.Links = links;
