...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionConfigurationTypeAlias : IEquatable<TransactionConfigurationTypeAlias>
    {
        ...
        /// <param name="isDefault">IsDefault is a flag that denotes the default alias for a group.</param>
        public TransactionConfigurationTypeAlias(string type = default(string), string description = default(string), string transactionClass = default(string), string transactionGroup = default(string), TransactionRolesEnum transactionRoles = default(TransactionRolesEnum), bool isDefault = default(bool))
        {
        ...
        /// <summary>
        /// IsDefault is a flag that denotes the default alias for a group
        /// </summary>
        /// <value>IsDefault is a flag that denotes the default alias for a group</value>
