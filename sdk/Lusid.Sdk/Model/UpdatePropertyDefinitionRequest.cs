...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdatePropertyDefinitionRequest :  IEquatable<UpdatePropertyDefinitionRequest>
    {
        ...
        public UpdatePropertyDefinitionRequest(bool? ValueRequired = default(bool?), string DisplayName = default(string), ResourceId DataTypeId = default(ResourceId), LifeTimeEnum? LifeTime = default(LifeTimeEnum?), TypeEnum? Type = default(TypeEnum?))
        {
