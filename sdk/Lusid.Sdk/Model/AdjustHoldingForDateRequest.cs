...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AdjustHoldingForDateRequest : IEquatable<AdjustHoldingForDateRequest>
    {
        /// <summary>
        ...
        public AdjustHoldingForDateRequest(DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), List<TargetTaxLotRequest> taxLots = default(List<TargetTaxLotRequest>), string currency = default(string))
        {
            ...
            this.EffectiveAt = effectiveAt ?? throw new ArgumentNullException("effectiveAt is a required property for AdjustHoldingForDateRequest and cannot be null");
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for AdjustHoldingForDateRequest and cannot be null");
            // to ensure "taxLots" is required (not null)
            this.TaxLots = taxLots ?? throw new ArgumentNullException("taxLots is a required property for AdjustHoldingForDateRequest and cannot be null");
