...
namespace Lusid.Sdk.Model
{
    ...
    /// CheckStepRequest
    /// </summary>
    [DataContract(Name = "CheckStepRequest")]
    [JsonConverter(typeof(JsonSubtypes), "ComplianceStepTypeRequest")]
    public partial class CheckStepRequest : ComplianceStepRequest, IEquatable<CheckStepRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckStepRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CheckStepRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckStepRequest" /> class.
        /// </summary>
        ...
        public CheckStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base(complianceStepTypeRequest)
        {
            ...
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for CheckStepRequest and cannot be null");
            }
            this.Label = label;
        }
        ...
        {
            return this.Equals(input as CheckStepRequest);
        }

        /// <summary>
        /// Returns true if CheckStepRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckStepRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckStepRequest input)
        {
            if (input == null)
            {
                return false;
