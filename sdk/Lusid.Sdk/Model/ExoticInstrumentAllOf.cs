...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExoticInstrumentAllOf : IEquatable<ExoticInstrumentAllOf>
    {
        /// <summary>
        ...
        public ExoticInstrumentAllOf(InstrumentDefinitionFormat instrumentFormat = default(InstrumentDefinitionFormat), string content = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.InstrumentFormat = instrumentFormat ?? throw new ArgumentNullException("instrumentFormat is a required property for ExoticInstrumentAllOf and cannot be null");
            // to ensure "content" is required (not null)
            this.Content = content ?? throw new ArgumentNullException("content is a required property for ExoticInstrumentAllOf and cannot be null");
