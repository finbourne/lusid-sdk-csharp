...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertReferencePortfolioConstituentPropertiesResponse")]
    public partial class UpsertReferencePortfolioConstituentPropertiesResponse : IEquatable<UpsertReferencePortfolioConstituentPropertiesResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpsertReferencePortfolioConstituentPropertiesResponse);
        }

        /// <summary>
        /// Returns true if UpsertReferencePortfolioConstituentPropertiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertReferencePortfolioConstituentPropertiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertReferencePortfolioConstituentPropertiesResponse input)
        {
            if (input == null)
            {
                return false;
