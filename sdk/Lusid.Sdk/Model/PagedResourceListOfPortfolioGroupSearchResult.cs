...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPortfolioGroupSearchResult : IEquatable<PagedResourceListOfPortfolioGroupSearchResult>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceListOfPortfolioGroupSearchResult(string nextPage = default(string), string previousPage = default(string), List<PortfolioGroupSearchResult> values = default(List<PortfolioGroupSearchResult>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for PagedResourceListOfPortfolioGroupSearchResult and cannot be null");
            }
            this.Values = values;
