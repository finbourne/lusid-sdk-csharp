...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashDependency : EconomicDependency, IEquatable<CashDependency>
    {
        /// <summary>
        ...
        public CashDependency(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for CashDependency and cannot be null");
            this.Date = date;
        }
