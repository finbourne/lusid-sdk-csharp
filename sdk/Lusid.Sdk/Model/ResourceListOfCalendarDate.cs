...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfCalendarDate")]
    public partial class ResourceListOfCalendarDate : IEquatable<ResourceListOfCalendarDate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCalendarDate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfCalendarDate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCalendarDate" /> class.
        /// </summary>
        ...
        public ResourceListOfCalendarDate(List<CalendarDate> values = default(List<CalendarDate>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfCalendarDate and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<CalendarDate> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfCalendarDate {\n");
        ...
        {
            return this.Equals(input as ResourceListOfCalendarDate);
        }

        /// <summary>
        /// Returns true if ResourceListOfCalendarDate instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCalendarDate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCalendarDate input)
        {
            if (input == null)
                return false;
