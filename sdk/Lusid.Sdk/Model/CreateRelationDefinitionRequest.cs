...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateRelationDefinitionRequest :  IEquatable<CreateRelationDefinitionRequest>
    {
        /// <summary>
        ...
        public CreateRelationDefinitionRequest(string scope = default(string), string code = default(string), string sourceEntityDomain = default(string), string targetEntityDomain = default(string), string displayName = default(string), string outwardDescription = default(string), string inwardDescription = default(string), string lifeTime = default(string), string constraintStyle = default(string))
        {
            ...
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
                this.Scope = scope;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            {
                throw new InvalidDataException("sourceEntityDomain is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetEntityDomain is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("outwardDescription is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inwardDescription is a required property for CreateRelationDefinitionRequest and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="sourceEntityDomain", EmitDefaultValue=false)]
        ...
        [DataMember(Name="targetEntityDomain", EmitDefaultValue=false)]
