...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfProcessedCommand :  IEquatable<ResourceListOfProcessedCommand>
    {
        ...
        public ResourceListOfProcessedCommand(List<ProcessedCommand> values = default(List<ProcessedCommand>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
