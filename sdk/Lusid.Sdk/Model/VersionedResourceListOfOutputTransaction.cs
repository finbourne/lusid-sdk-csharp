...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfOutputTransaction : IEquatable<VersionedResourceListOfOutputTransaction>, IValidatableObject
    {
        ...
        public VersionedResourceListOfOutputTransaction(ModelVersion varVersion = default(ModelVersion), List<OutputTransaction> values = default(List<OutputTransaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "varVersion" is required (not null)
            if (varVersion == null)
            {
                throw new ArgumentNullException("varVersion is a required property for VersionedResourceListOfOutputTransaction and cannot be null");
            }
            this.VarVersion = varVersion;
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for VersionedResourceListOfOutputTransaction and cannot be null");
            }
            this.Values = values;
            this.Href = href;
