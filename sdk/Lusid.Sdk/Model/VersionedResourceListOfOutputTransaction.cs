...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfOutputTransaction : IEquatable<VersionedResourceListOfOutputTransaction>, IValidatableObject
    {
        ...
        public VersionedResourceListOfOutputTransaction(ModelVersion version = default(ModelVersion), List<OutputTransaction> values = default(List<OutputTransaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for VersionedResourceListOfOutputTransaction and cannot be null");
            }
