...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfQuote :  IEquatable<ResourceListOfQuote>
    {
        ...
        public ResourceListOfQuote(List<Quote> values = default(List<Quote>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
