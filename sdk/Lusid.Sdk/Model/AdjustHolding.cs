...
namespace Lusid.Sdk.Model
{
    ...
    /// AdjustHolding
    /// </summary>
    [DataContract(Name = "AdjustHolding")]
    public partial class AdjustHolding : IEquatable<AdjustHolding>
    {
        ...
        /// <param name="metadata">Contains warnings related to unresolved instruments.</param>
        /// <param name="links">Collection of links..</param>
        public AdjustHolding(string href = default(string), Version version = default(Version), Dictionary<string, List<ResponseMetaData>> metadata = default(Dictionary<string, List<ResponseMetaData>>), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for AdjustHolding and cannot be null");
            this.Href = href;
        ...
        /// </summary>
        /// <value>Contains warnings related to unresolved instruments</value>
