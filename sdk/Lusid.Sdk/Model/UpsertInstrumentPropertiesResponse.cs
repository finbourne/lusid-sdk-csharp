...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentPropertiesResponse :  IEquatable<UpsertInstrumentPropertiesResponse>
    {
        ...
        /// <param name="Failed">A list of any values that failed to be upserted..</param>
        /// <param name="Links">Links.</param>
        public UpsertInstrumentPropertiesResponse(string Href = default(string), List<ErrorDetail> Failed = default(List<ErrorDetail>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Failed = Failed;
            this.Links = Links;
        ...
        /// </summary>
        /// <value>A list of any values that failed to be upserted.</value>
        [DataMember(Name="failed", EmitDefaultValue=false)]
        public List<ErrorDetail> Failed { get; set; }
