...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfTransactionConfigurationData :  IEquatable<ResourceListOfTransactionConfigurationData>
    {
        ...
        public ResourceListOfTransactionConfigurationData(List<TransactionConfigurationData> values = default(List<TransactionConfigurationData>), string href = default(string), List<Link> links = default(List<Link>))
        {
