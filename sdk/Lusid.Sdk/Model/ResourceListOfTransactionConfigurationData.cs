...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfTransactionConfigurationData :  IEquatable<ResourceListOfTransactionConfigurationData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfTransactionConfigurationData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfTransactionConfigurationData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfTransactionConfigurationData" /> class.
        /// </summary>
        ...
        public ResourceListOfTransactionConfigurationData(List<TransactionConfigurationData> values = default(List<TransactionConfigurationData>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfTransactionConfigurationData and cannot be null");
            }
            else
            {
                this.Values = values;
        ...
        {
            return this.Equals(input as ResourceListOfTransactionConfigurationData);
        }

        /// <summary>
        /// Returns true if ResourceListOfTransactionConfigurationData instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfTransactionConfigurationData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfTransactionConfigurationData input)
        {
            if (input == null)
                return false;
