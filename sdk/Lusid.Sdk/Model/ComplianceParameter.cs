...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceParameter : IEquatable<ComplianceParameter>
    {
        ...
        /// Initializes a new instance of the <see cref="ComplianceParameter" /> class.
        /// </summary>
        /// <param name="parameterType">The parameter type. (required).</param>
        /// <param name="value">The parameter value. (required).</param>
        public ComplianceParameter(string parameterType = default(string), Object value = default(Object))
        {
            // to ensure "parameterType" is required (not null)
            this.ParameterType = parameterType ?? throw new ArgumentNullException("parameterType is a required property for ComplianceParameter and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ComplianceParameter and cannot be null");
        }
