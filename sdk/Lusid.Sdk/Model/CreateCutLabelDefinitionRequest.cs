...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateCutLabelDefinitionRequest :  IEquatable<CreateCutLabelDefinitionRequest>
    {
        ...
        public CreateCutLabelDefinitionRequest(string Code = default(string), string DisplayName = default(string), string Description = default(string), CutLocalTime CutLocalTime = default(CutLocalTime), string TimeZone = default(string), DateTimeOffset? EffectiveAt = default(DateTimeOffset?))
        {
            ...
            if (EffectiveAt == null)
            {
                throw new InvalidDataException("EffectiveAt is a required property for CreateCutLabelDefinitionRequest and cannot be null");
            }
            else
            {
