...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateCutLabelDefinitionRequest : IEquatable<CreateCutLabelDefinitionRequest>
    {
        ...
        public CreateCutLabelDefinitionRequest(string code = default(string), string displayName = default(string), string description = default(string), CutLocalTime cutLocalTime = default(CutLocalTime), string timeZone = default(string))
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for CreateCutLabelDefinitionRequest and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CreateCutLabelDefinitionRequest and cannot be null");
            // to ensure "cutLocalTime" is required (not null)
            this.CutLocalTime = cutLocalTime ?? throw new ArgumentNullException("cutLocalTime is a required property for CreateCutLabelDefinitionRequest and cannot be null");
            // to ensure "timeZone" is required (not null)
            this.TimeZone = timeZone ?? throw new ArgumentNullException("timeZone is a required property for CreateCutLabelDefinitionRequest and cannot be null");
