...
namespace Lusid.Sdk.Model
{
    ...
    public partial class HoldingAdjustment :  IEquatable<HoldingAdjustment>
    {
        ...
        /// <param name="subHoldingKeys">The set of unique transaction properties and associated values stored with the holding adjustment transactions automatically created by LUSID. Each property will be from the &#39;Trade&#39; domain..</param>
        ...
        public HoldingAdjustment(Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string instrumentUid = default(string), List<PerpetualProperty> subHoldingKeys = default(List<PerpetualProperty>), List<PerpetualProperty> properties = default(List<PerpetualProperty>), List<TargetTaxLot> taxLots = default(List<TargetTaxLot>))
        {
        ...
        /// </summary>
        /// <value>The set of unique transaction properties and associated values stored with the holding adjustment transactions automatically created by LUSID. Each property will be from the &#39;Trade&#39; domain.</value>
