...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfString")]
    public partial class ResourceListOfString : IEquatable<ResourceListOfString>
    {
        ...
        protected ResourceListOfString() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfString" /> class.
        /// </summary>
        ...
        public ResourceListOfString(List<string> values = default(List<string>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfString and cannot be null");
            this.Href = href;
            this.Links = links;
