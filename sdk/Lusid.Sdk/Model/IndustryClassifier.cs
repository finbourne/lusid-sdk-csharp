...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IndustryClassifier :  IEquatable<IndustryClassifier>
    {
        ...
        public IndustryClassifier(string classificationSystemName = default(string), string classificationCode = default(string))
        {
            ...
            {
                throw new InvalidDataException("classificationSystemName is a required property for IndustryClassifier and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("classificationCode is a required property for IndustryClassifier and cannot be null");
            }
            else
            {
        ...
        [DataMember(Name="classificationSystemName", EmitDefaultValue=false)]
        ...
        [DataMember(Name="classificationCode", EmitDefaultValue=false)]
