...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateResults :  IEquatable<CreateResults>
    {
        ...
        /// <param name="Key">The key is a unique point in &#39;run&#39; space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart..</param>
        /// <param name="Date">The date for which the results should be stored..</param>
        /// <param name="Format">The format in which the results are stored/structured..</param>
        public CreateResults(string Data = default(string), string Scope = default(string), string Key = default(string), DateTimeOffset? Date = default(DateTimeOffset?), FormatEnum? Format = default(FormatEnum?))
        {
            this.Data = Data;
            this.Scope = Scope;
            this.Key = Key;
        ...
        /// </summary>
        /// <value>The scope of the data to be stored.</value>
        ...
        /// </summary>
        /// <value>The key is a unique point in &#39;run&#39; space. For a given scope and time point, one would wish to  identify a unique result set for a given recipe. In essence, this key is the unique identifier for the tuple (recipe,portfolios)  However, that only matters when one is trying to use it automatically to retrieve them.  A question becomes whether we would wish to store groups of protfolio results together, or only single ones.  Also, whether we would accept uploading of groups and then split them apart.</value>
        ...
        /// </summary>
        /// <value>The date for which the results should be stored.</value>
