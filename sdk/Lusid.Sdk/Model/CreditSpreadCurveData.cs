...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSpreadCurveData : ComplexMarketData, IEquatable<CreditSpreadCurveData>
    {
        /// <summary>
        ...
        public CreditSpreadCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), List<string> tenors = default(List<string>), List<decimal> spreads = default(List<decimal>), decimal recoveryRate = default(decimal), DateTimeOffset? referenceDate = default(DateTimeOffset?), List<DateTimeOffset> maturities = default(List<DateTimeOffset>), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for CreditSpreadCurveData and cannot be null");
            // to ensure "tenors" is required (not null)
            this.Tenors = tenors ?? throw new ArgumentNullException("tenors is a required property for CreditSpreadCurveData and cannot be null");
            // to ensure "spreads" is required (not null)
            this.Spreads = spreads ?? throw new ArgumentNullException("spreads is a required property for CreditSpreadCurveData and cannot be null");
