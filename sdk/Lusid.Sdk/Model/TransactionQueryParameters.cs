...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// The method for date selection. Trade date or Settlement date
        /// </summary>
        /// <value>The method for date selection. Trade date or Settlement date</value>
        ...
        /// </summary>
        /// <param name="startDate">The required set of transactions should begin from this date.</param>
        /// <param name="endDate">The required set of transactions should end at this date.</param>
        /// <param name="queryMode">The method for date selection. Trade date or Settlement date.</param>
        /// <param name="showCancelledTransactions">Option to include cancelled transactions in the results.</param>
        public TransactionQueryParameters(DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? endDate = default(DateTimeOffset?), QueryModeEnum? queryMode = default(QueryModeEnum?), bool? showCancelledTransactions = default(bool?))
        {
        ...
        /// </summary>
        /// <value>The required set of transactions should begin from this date</value>
        ...
        /// </summary>
        /// <value>The required set of transactions should end at this date</value>
        ...
        /// </summary>
        /// <value>Option to include cancelled transactions in the results</value>
