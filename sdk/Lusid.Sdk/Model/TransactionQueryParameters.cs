...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// The date to compare against the upper and lower bounds for the effectiveAt datetime. Defaults to &#39;TradeDate&#39; if not specified.
        /// </summary>
        /// <value>The date to compare against the upper and lower bounds for the effectiveAt datetime. Defaults to &#39;TradeDate&#39; if not specified.</value>
        ...
        /// Initializes a new instance of the <see cref="TransactionQueryParameters" /> class.
        /// </summary>
        /// <param name="startDate">The lower bound effectiveAt datetime (inclusive) from which to build the transactions. (required).</param>
        /// <param name="endDate">The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions. (required).</param>
        /// <param name="queryMode">The date to compare against the upper and lower bounds for the effectiveAt datetime. Defaults to &#39;TradeDate&#39; if not specified..</param>
        ...
        /// <summary>
        /// The lower bound effectiveAt datetime (inclusive) from which to build the transactions.
        /// </summary>
        /// <value>The lower bound effectiveAt datetime (inclusive) from which to build the transactions.</value>
        [DataMember(Name="startDate", EmitDefaultValue=false)]
        public string StartDate { get; set; }

        /// <summary>
        /// The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions.
        /// </summary>
        /// <value>The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions.</value>
