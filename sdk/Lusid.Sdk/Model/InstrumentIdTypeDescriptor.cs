...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentIdTypeDescriptor :  IEquatable<InstrumentIdTypeDescriptor>
    {
        ...
        /// Initializes a new instance of the <see cref="InstrumentIdTypeDescriptor" /> class.
        /// </summary>
        /// <param name="idName">The name of the identifier. (required).</param>
        /// <param name="propertyKeyValue">The property key that corresponds to the identifier. (required).</param>
        /// <param name="isUniqueIdentifier">Whether or not the identifier is enforced to be unique. (required).</param>
        public InstrumentIdTypeDescriptor(string idName = default(string), string propertyKeyValue = default(string), bool? isUniqueIdentifier = default(bool?))
        {
            ...
            // to ensure "isUniqueIdentifier" is required (not null)
            if (isUniqueIdentifier == null)
            {
                throw new InvalidDataException("isUniqueIdentifier is a required property for InstrumentIdTypeDescriptor and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The property key that corresponds to the identifier.
        /// </summary>
        /// <value>The property key that corresponds to the identifier.</value>
        [DataMember(Name="propertyKeyValue", EmitDefaultValue=false)]
        public string PropertyKeyValue { get; set; }

        /// <summary>
        /// Whether or not the identifier is enforced to be unique.
        /// </summary>
        /// <value>Whether or not the identifier is enforced to be unique.</value>
        [DataMember(Name="isUniqueIdentifier", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsUniqueIdentifier: ").Append(IsUniqueIdentifier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InstrumentIdTypeDescriptor input)
        {
            ...
            return 
                ...
                (
                    this.IsUniqueIdentifier == input.IsUniqueIdentifier ||
                    (this.IsUniqueIdentifier != null &&
                    this.IsUniqueIdentifier.Equals(input.IsUniqueIdentifier))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsUniqueIdentifier != null)
                    hashCode = hashCode * 59 + this.IsUniqueIdentifier.GetHashCode();
                return hashCode;
            }
        }
    }
