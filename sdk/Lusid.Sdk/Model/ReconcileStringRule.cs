...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconcileStringRule : ReconciliationRule, IEquatable<ReconcileStringRule>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The available values are: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf</value>
        [DataMember(Name = "comparisonType", IsRequired = true, EmitDefaultValue = false)]
        ...
        public ReconcileStringRule(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), Dictionary<string, List<string>> oneOfCandidates = default(Dictionary<string, List<string>>), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum)) : base(ruleType)
        {
            ...
            this.AppliesTo = appliesTo ?? throw new ArgumentNullException("appliesTo is a required property for ReconcileStringRule and cannot be null");
