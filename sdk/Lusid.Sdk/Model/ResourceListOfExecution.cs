...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfExecution")]
    public partial class ResourceListOfExecution : IEquatable<ResourceListOfExecution>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfExecution" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfExecution() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfExecution" /> class.
        /// </summary>
        ...
        public ResourceListOfExecution(List<Execution> values = default(List<Execution>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfExecution and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<Execution> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfExecution {\n");
        ...
        {
            return this.Equals(input as ResourceListOfExecution);
        }

        /// <summary>
        /// Returns true if ResourceListOfExecution instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfExecution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfExecution input)
        {
            if (input == null)
                return false;
