...
namespace Lusid.Sdk.Model
{
    ...
    /// TenderEventAllOf
    /// </summary>
    [DataContract(Name = "TenderEvent_allOf")]
    public partial class TenderEventAllOf : IEquatable<TenderEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TenderEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TenderEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TenderEventAllOf" /> class.
        /// </summary>
        ...
        public TenderEventAllOf(DateTimeOffset? announcementDate = default(DateTimeOffset?), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset? recordDate = default(DateTimeOffset?), DateTimeOffset paymentDate = default(DateTimeOffset), NewInstrument newInstrument = default(NewInstrument), decimal? fractionalUnitsCashPrice = default(decimal?), string fractionalUnitsCashCurrency = default(string), List<SecurityOfferElection> securityOfferElections = default(List<SecurityOfferElection>), List<CashAndSecurityOfferElection> cashAndSecurityOfferElections = default(List<CashAndSecurityOfferElection>), List<CashOfferElection> cashOfferElections = default(List<CashOfferElection>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            ...
            {
                throw new ArgumentNullException("newInstrument is a required property for TenderEventAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenderEventAllOf {\n");
        ...
        {
            return this.Equals(input as TenderEventAllOf);
        }

        /// <summary>
        /// Returns true if TenderEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TenderEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenderEventAllOf input)
        {
            if (input == null)
            {
                return false;
