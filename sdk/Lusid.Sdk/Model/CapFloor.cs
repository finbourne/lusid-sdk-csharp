...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CapFloor : LusidInstrument, IEquatable<CapFloor>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap (required) (default to &quot;CapFloor&quot;).</param>
        public CapFloor(string capFloorType = default(string), decimal capStrike = default(decimal), decimal floorStrike = default(decimal), bool includeFirstCaplet = default(bool), FloatingLeg underlyingFloatingLeg = default(FloatingLeg), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.CapFloorType = capFloorType ?? throw new ArgumentNullException("capFloorType is a required property for CapFloor and cannot be null");
            ...
            this.UnderlyingFloatingLeg = underlyingFloatingLeg ?? throw new ArgumentNullException("underlyingFloatingLeg is a required property for CapFloor and cannot be null");
        }
        ...
        [DataMember(Name = "capFloorType", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "underlyingFloatingLeg", IsRequired = true, EmitDefaultValue = false)]
