...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPlacement")]
    public partial class ResourceListOfPlacement : IEquatable<ResourceListOfPlacement>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPlacement" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfPlacement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPlacement" /> class.
        /// </summary>
        ...
        public ResourceListOfPlacement(List<Placement> values = default(List<Placement>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPlacement and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<Placement> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfPlacement {\n");
        ...
        {
            return this.Equals(input as ResourceListOfPlacement);
        }

        /// <summary>
        /// Returns true if ResourceListOfPlacement instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPlacement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPlacement input)
        {
            if (input == null)
                return false;
