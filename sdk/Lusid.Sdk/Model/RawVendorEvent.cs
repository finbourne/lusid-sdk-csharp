...
namespace Lusid.Sdk.Model
{
    ...
    public partial class RawVendorEvent : InstrumentEvent, IEquatable<RawVendorEvent>
    {
        /// <summary>
        ...
        public RawVendorEvent(DateTimeOffset effectiveAt = default(DateTimeOffset), LifeCycleEventValue eventValue = default(LifeCycleEventValue), string eventType = default(string), string eventStatus = default(string), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.EventValue = eventValue ?? throw new ArgumentNullException("eventValue is a required property for RawVendorEvent and cannot be null");
            // to ensure "eventType" is required (not null)
            this.EventType = eventType ?? throw new ArgumentNullException("eventType is a required property for RawVendorEvent and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for RawVendorEvent and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "eventValue", IsRequired = true, EmitDefaultValue = false)]
