...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QuoteDependencyAllOf : IEquatable<QuoteDependencyAllOf>
    {
        /// <summary>
        ...
        public QuoteDependencyAllOf(string marketIdentifier = default(string), string code = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.MarketIdentifier = marketIdentifier ?? throw new ArgumentNullException("marketIdentifier is a required property for QuoteDependencyAllOf and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for QuoteDependencyAllOf and cannot be null");
            this.Date = date;
