...
namespace Lusid.Sdk.Model
{
    ...
    /// IDataRecord
    /// </summary>
    [DataContract(Name = "IDataRecord")]
    public partial class IDataRecord : IEquatable<IDataRecord>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IDataRecord" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns false as FieldCount should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeFieldCount()
        {
            return false;
        }
        ...
        {
            return this.Equals(input as IDataRecord);
        }

        /// <summary>
        /// Returns true if IDataRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of IDataRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IDataRecord input)
        {
            if (input == null)
                return false;
