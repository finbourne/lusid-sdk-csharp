...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AddBusinessDaysToDateRequest : IEquatable<AddBusinessDaysToDateRequest>
    {
        /// <summary>
        ...
        public AddBusinessDaysToDateRequest(int businessDayOffset = default(int), List<string> holidayCodes = default(List<string>), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset? asAt = default(DateTimeOffset?))
        {
            ...
            this.HolidayCodes = holidayCodes ?? throw new ArgumentNullException("holidayCodes is a required property for AddBusinessDaysToDateRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "holidayCodes", IsRequired = true, EmitDefaultValue = false)]
