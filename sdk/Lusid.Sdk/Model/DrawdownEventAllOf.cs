...
namespace Lusid.Sdk.Model
{
    ...
    /// DrawdownEventAllOf
    /// </summary>
    [DataContract(Name = "DrawdownEvent_allOf")]
    public partial class DrawdownEventAllOf : IEquatable<DrawdownEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawdownEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DrawdownEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DrawdownEventAllOf" /> class.
        /// </summary>
        ...
        public DrawdownEventAllOf(decimal amount = default(decimal), DateTimeOffset date = default(DateTimeOffset), ContractDetails contractDetails = default(ContractDetails), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.Amount = amount;
            this.Date = date;
            ...
            {
                throw new ArgumentNullException("contractDetails is a required property for DrawdownEventAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DrawdownEventAllOf {\n");
        ...
        {
            return this.Equals(input as DrawdownEventAllOf);
        }

        /// <summary>
        /// Returns true if DrawdownEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DrawdownEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DrawdownEventAllOf input)
        {
            if (input == null)
            {
                return false;
