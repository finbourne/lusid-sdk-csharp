...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioGroupProperties : IEquatable<PortfolioGroupProperties>, IValidatableObject
    {
        ...
        public PortfolioGroupProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), ModelVersion version = default(ModelVersion), List<Link> links = default(List<Link>))
        {
            this.Href = href;
