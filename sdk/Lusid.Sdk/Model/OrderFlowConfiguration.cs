...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OrderFlowConfiguration : IEquatable<OrderFlowConfiguration>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Controls whether Orders and Allocations orders are included in the Portfolio valuation.  Valid values are  None (to account for Transactions only), Allocations (to include Allocations and Transactions) and  OrdersAndAllocations (to include Orders, Allocations and Transactions). Available values: None, Allocations, OrdersAndAllocations.</value>
