...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IUnitDefinition :  IEquatable<IUnitDefinition>
    {
        /// <summary>
        /// Defines Schema
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IUnitDefinition" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as IUnitDefinition);
        }

        /// <summary>
        /// Returns true if IUnitDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of IUnitDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IUnitDefinition input)
        {
            if (input == null)
                return false;
