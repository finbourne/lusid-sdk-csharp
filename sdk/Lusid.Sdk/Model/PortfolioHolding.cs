...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioHolding : IEquatable<PortfolioHolding>
    {
        ...
        /// <param name="holdingTypeName">The decoded type of the holding e.g. Position, Balance, CashCommitment, Receivable, ForwardFX etc. (required).</param>
        ...
        public PortfolioHolding(string instrumentScope = default(string), string instrumentUid = default(string), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), string holdingType = default(string), string holdingTypeName = default(string), decimal units = default(decimal), decimal settledUnits = default(decimal), CurrencyAndAmount cost = default(CurrencyAndAmount), CurrencyAndAmount costPortfolioCcy = default(CurrencyAndAmount), Transaction transaction = default(Transaction), string currency = default(string))
        {
            ...
            // to ensure "holdingTypeName" is required (not null)
            this.HoldingTypeName = holdingTypeName ?? throw new ArgumentNullException("holdingTypeName is a required property for PortfolioHolding and cannot be null");
            this.Units = units;
        ...
        [DataMember(Name = "holdingTypeName", IsRequired = true, EmitDefaultValue = false)]
