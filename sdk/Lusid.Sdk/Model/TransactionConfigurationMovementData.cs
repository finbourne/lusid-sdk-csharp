...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionConfigurationMovementData :  IEquatable<TransactionConfigurationMovementData>
    {
        ...
        public TransactionConfigurationMovementData(MovementTypesEnum movementTypes = default(MovementTypesEnum), SideEnum side = default(SideEnum), int? direction = default(int?), List<PerpetualProperty> properties = default(List<PerpetualProperty>), List<TransactionPropertyMapping> mappings = default(List<TransactionPropertyMapping>))
        {
