...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateCustomDataModelRequest")]
    public partial class UpdateCustomDataModelRequest : IEquatable<UpdateCustomDataModelRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomDataModelRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateCustomDataModelRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCustomDataModelRequest" /> class.
        /// </summary>
        ...
        public UpdateCustomDataModelRequest(string displayName = default(string), string description = default(string), ResourceId parentDataModel = default(ResourceId), string conditions = default(string), List<CustomDataModelPropertySpecification> properties = default(List<CustomDataModelPropertySpecification>), List<CustomDataModelIdentifierTypeSpecification> identifierTypes = default(List<CustomDataModelIdentifierTypeSpecification>), List<Alias> attributeAliases = default(List<Alias>), List<RecommendedSortBy> recommendedSortBy = default(List<RecommendedSortBy>))
        {
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdateCustomDataModelRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for UpdateCustomDataModelRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateCustomDataModelRequest);
        }

        /// <summary>
        /// Returns true if UpdateCustomDataModelRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCustomDataModelRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCustomDataModelRequest input)
        {
            if (input == null)
            {
                return false;
