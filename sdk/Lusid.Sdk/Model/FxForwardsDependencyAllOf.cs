...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FxForwardsDependency_allOf")]
    public partial class FxForwardsDependencyAllOf : IEquatable<FxForwardsDependencyAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardsDependencyAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FxForwardsDependencyAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardsDependencyAllOf" /> class.
        /// </summary>
        ...
        public FxForwardsDependencyAllOf(string domesticCurrency = default(string), string foreignCurrency = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            // to ensure "domesticCurrency" is required (not null)
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for FxForwardsDependencyAllOf and cannot be null");
            // to ensure "foreignCurrency" is required (not null)
            this.ForeignCurrency = foreignCurrency ?? throw new ArgumentNullException("foreignCurrency is a required property for FxForwardsDependencyAllOf and cannot be null");
            // to ensure "curveType" is required (not null)
            this.CurveType = curveType ?? throw new ArgumentNullException("curveType is a required property for FxForwardsDependencyAllOf and cannot be null");
            this.Date = date;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FxForwardsDependencyAllOf {\n");
        ...
        {
            return this.Equals(input as FxForwardsDependencyAllOf);
        }

        /// <summary>
        /// Returns true if FxForwardsDependencyAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FxForwardsDependencyAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FxForwardsDependencyAllOf input)
        {
            if (input == null)
                return false;
