...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentMatch :  IEquatable<InstrumentMatch>
    {
        ...
        public InstrumentMatch(InstrumentMatchAliases Aliases = default(InstrumentMatchAliases))
        {
        ...
        public InstrumentMatchAliases Aliases { get; set; }

        /// <summary>
        /// Gets or Sets BloombergExchangeCode
        /// </summary>
        [DataMember(Name="bloombergExchangeCode", EmitDefaultValue=false)]
        public string BloombergExchangeCode { get; private set; }

        /// <summary>
        /// Gets or Sets MarketIdentifierCode
        /// </summary>
        [DataMember(Name="marketIdentifierCode", EmitDefaultValue=false)]
        public string MarketIdentifierCode { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  BloombergExchangeCode: ").Append(BloombergExchangeCode).Append("\n");
        ...
        public bool Equals(InstrumentMatch input)
        {
            ...
            return 
                ...
                (
                    this.BloombergExchangeCode == input.BloombergExchangeCode ||
                    (this.BloombergExchangeCode != null &&
                    this.BloombergExchangeCode.Equals(input.BloombergExchangeCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BloombergExchangeCode != null)
                    hashCode = hashCode * 59 + this.BloombergExchangeCode.GetHashCode();
