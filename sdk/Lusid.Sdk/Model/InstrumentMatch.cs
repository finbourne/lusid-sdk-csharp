...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentMatch :  IEquatable<InstrumentMatch>
    {
        ...
        /// <param name="Identifiers">The set of identifiers that uniquely identify this instrument.</param>
        /// <param name="Properties">Any requested properties are decorated on the instrument, and will have a value of  &#39;Unknown&#39;, if no value was found for this instrument..</param>
        public InstrumentMatch(string Name = default(string), Dictionary<string, string> Identifiers = default(Dictionary<string, string>), List<Property> Properties = default(List<Property>))
        {
            this.Name = Name;
        ...
        /// </summary>
        /// <value>The set of identifiers that uniquely identify this instrument</value>
        ...
        /// </summary>
        /// <value>Any requested properties are decorated on the instrument, and will have a value of  &#39;Unknown&#39;, if no value was found for this instrument.</value>
