...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityCurveByPricesDataAllOf : IEquatable<EquityCurveByPricesDataAllOf>
    {
        /// <summary>
        ...
        public EquityCurveByPricesDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), List<DateTimeOffset> dates = default(List<DateTimeOffset>), string lineage = default(string), List<decimal> prices = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            this.BaseDate = baseDate;
            // to ensure "dates" is required (not null)
            this.Dates = dates ?? throw new ArgumentNullException("dates is a required property for EquityCurveByPricesDataAllOf and cannot be null");
            // to ensure "prices" is required (not null)
            this.Prices = prices ?? throw new ArgumentNullException("prices is a required property for EquityCurveByPricesDataAllOf and cannot be null");
