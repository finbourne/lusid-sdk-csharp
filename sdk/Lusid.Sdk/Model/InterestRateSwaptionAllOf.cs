...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InterestRateSwaptionAllOf : IEquatable<InterestRateSwaptionAllOf>
    {
        ...
        public InterestRateSwaptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), string payOrReceiveFixed = default(string), Premium premium = default(Premium), string deliveryMethod = default(string), InterestRateSwap swap = default(InterestRateSwap), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.PayOrReceiveFixed = payOrReceiveFixed ?? throw new ArgumentNullException("payOrReceiveFixed is a required property for InterestRateSwaptionAllOf and cannot be null");
            // to ensure "deliveryMethod" is required (not null)
            this.DeliveryMethod = deliveryMethod ?? throw new ArgumentNullException("deliveryMethod is a required property for InterestRateSwaptionAllOf and cannot be null");
