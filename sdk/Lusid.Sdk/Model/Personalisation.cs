...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Personalisation :  IEquatable<Personalisation>
    {
        /// <summary>
        /// Defines Scope
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Personalisation" /> class.
        /// </summary>
        /// <param name="Scope">Scope.</param>
        /// <param name="ScopeValue">ScopeValue.</param>
        /// <param name="SettingKey">SettingKey.</param>
        /// <param name="SettingValue">SettingValue.</param>
        /// <param name="DataType">DataType.</param>
        /// <param name="Href">Href.</param>
        public Personalisation(ScopeEnum? Scope = default(ScopeEnum?), string ScopeValue = default(string), string SettingKey = default(string), string SettingValue = default(string), string DataType = default(string), string Href = default(string))
        {
            this.Scope = Scope;
        ...
        /// <summary>
        /// Gets or Sets ScopeValue
        /// </summary>
        [DataMember(Name="scopeValue", EmitDefaultValue=false)]
        public string ScopeValue { get; set; }

        /// <summary>
        /// Gets or Sets SettingKey
        /// </summary>
        [DataMember(Name="settingKey", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as Personalisation);
        }

        /// <summary>
        /// Returns true if Personalisation instances are equal
        /// </summary>
        /// <param name="input">Instance of Personalisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Personalisation input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.SettingKey.Equals(input.SettingKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SettingKey != null)
                    hashCode = hashCode * 59 + this.SettingKey.GetHashCode();
