...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfTransaction : IEquatable<VersionedResourceListOfTransaction>
    {
        ...
        public VersionedResourceListOfTransaction(Version version = default(Version), List<Transaction> values = default(List<Transaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for VersionedResourceListOfTransaction and cannot be null");
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for VersionedResourceListOfTransaction and cannot be null");
            this.Href = href;
