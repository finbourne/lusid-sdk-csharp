...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfTransaction :  IEquatable<VersionedResourceListOfTransaction>
    {
        ...
        public VersionedResourceListOfTransaction(Version version = default(Version), List<Transaction> values = default(List<Transaction>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
