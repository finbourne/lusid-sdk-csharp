...
namespace Lusid.Sdk.Model
{
    ...
    public partial class VersionedResourceListOfTransaction : IEquatable<VersionedResourceListOfTransaction>, IValidatableObject
    {
        ...
        public VersionedResourceListOfTransaction(ModelVersion version = default(ModelVersion), List<Transaction> values = default(List<Transaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for VersionedResourceListOfTransaction and cannot be null");
            }
