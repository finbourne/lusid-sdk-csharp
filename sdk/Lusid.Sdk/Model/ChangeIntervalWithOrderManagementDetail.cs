...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChangeIntervalWithOrderManagementDetail")]
    public partial class ChangeIntervalWithOrderManagementDetail : IEquatable<ChangeIntervalWithOrderManagementDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeIntervalWithOrderManagementDetail" /> class.
        /// </summary>
        /// <param name="detail">Information about the particular instance of the ChangeInterval (supplied information depends on the type of Action). Contains extra detail for order management actions such as related entity ids and compliance run details..</param>
        /// <param name="actionDescription">Description of the action performed on the entity..</param>
        ...
        /// </summary>
        /// <value>Information about the particular instance of the ChangeInterval (supplied information depends on the type of Action). Contains extra detail for order management actions such as related entity ids and compliance run details.</value>
        ...
        {
            return this.Equals(input as ChangeIntervalWithOrderManagementDetail);
        }

        /// <summary>
        /// Returns true if ChangeIntervalWithOrderManagementDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeIntervalWithOrderManagementDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeIntervalWithOrderManagementDetail input)
        {
            if (input == null)
            {
                return false;
