...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Instrument :  IEquatable<Instrument>
    {
        ...
        /// <param name="LusidInstrumentId">The lusid instrument id (LUID) of the instrument.</param>
        /// <param name="Version">The version of the instrument.</param>
        /// <param name="Name">The name of the instrument.</param>
        /// <param name="Identifiers">The set of identifiers that can be used to uniquely identify the instrument.</param>
        /// <param name="Properties">Any requested instrument properties. If no property can be found for the instrument, then  a value of &#39;Unknown&#39; will be returned.</param>
        /// <param name="MarketIdentifierCode">The market identifier of the instrument (if any)..</param>
        /// <param name="LookthroughPortfolio">The lookthrough portfolio of the instrument (if any)..</param>
        /// <param name="Links">Links.</param>
        public Instrument(string Href = default(string), string LusidInstrumentId = default(string), Version Version = default(Version), string Name = default(string), Dictionary<string, string> Identifiers = default(Dictionary<string, string>), List<Property> Properties = default(List<Property>), string MarketIdentifierCode = default(string), ResourceId LookthroughPortfolio = default(ResourceId), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
        ...
        /// </summary>
        /// <value>The lusid instrument id (LUID) of the instrument</value>
        ...
        /// </summary>
        /// <value>The version of the instrument</value>
        ...
        /// </summary>
        /// <value>The set of identifiers that can be used to uniquely identify the instrument</value>
        ...
        /// </summary>
        /// <value>Any requested instrument properties. If no property can be found for the instrument, then  a value of &#39;Unknown&#39; will be returned</value>
        ...
        /// </summary>
        /// <value>The market identifier of the instrument (if any).</value>
        [DataMember(Name="marketIdentifierCode", EmitDefaultValue=false)]
        public string MarketIdentifierCode { get; set; }

        /// <summary>
        /// The lookthrough portfolio of the instrument (if any).
        /// </summary>
        /// <value>The lookthrough portfolio of the instrument (if any).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  MarketIdentifierCode: ").Append(MarketIdentifierCode).Append("\n");
        ...
        public bool Equals(Instrument input)
        {
            ...
            return 
                ...
                (
                    this.MarketIdentifierCode == input.MarketIdentifierCode ||
                    (this.MarketIdentifierCode != null &&
                    this.MarketIdentifierCode.Equals(input.MarketIdentifierCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MarketIdentifierCode != null)
                    hashCode = hashCode * 59 + this.MarketIdentifierCode.GetHashCode();
