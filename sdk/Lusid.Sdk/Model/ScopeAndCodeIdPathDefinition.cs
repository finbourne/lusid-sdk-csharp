...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScopeAndCodeIdPathDefinition :  IEquatable<ScopeAndCodeIdPathDefinition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScopeAndCodeIdPathDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        public ScopeAndCodeIdPathDefinition()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScopeAndCodeIdPathDefinition {\n");
        ...
        {
            return this.Equals(input as ScopeAndCodeIdPathDefinition);
        }

        /// <summary>
        /// Returns true if ScopeAndCodeIdPathDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of ScopeAndCodeIdPathDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScopeAndCodeIdPathDefinition input)
        {
            if (input == null)
                return false;
