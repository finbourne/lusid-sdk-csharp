...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfInstrumentEventHolder")]
    public partial class PagedResourceListOfInstrumentEventHolder : IEquatable<PagedResourceListOfInstrumentEventHolder>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfInstrumentEventHolder" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfInstrumentEventHolder() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfInstrumentEventHolder" /> class.
        /// </summary>
        ...
        public PagedResourceListOfInstrumentEventHolder(string nextPage = default(string), string previousPage = default(string), List<InstrumentEventHolder> values = default(List<InstrumentEventHolder>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfInstrumentEventHolder and cannot be null");
        ...
        public List<InstrumentEventHolder> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfInstrumentEventHolder);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfInstrumentEventHolder instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfInstrumentEventHolder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfInstrumentEventHolder input)
        {
            if (input == null)
                return false;
