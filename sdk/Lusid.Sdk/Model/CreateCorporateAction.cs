...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCorporateAction :  IEquatable<CreateCorporateAction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCorporateAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCorporateAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCorporateAction" /> class.
        /// </summary>
        ...
        public CreateCorporateAction(string CorporateActionCode = default(string), DateTimeOffset? AnnouncementDate = default(DateTimeOffset?), DateTimeOffset? ExDate = default(DateTimeOffset?), DateTimeOffset? RecordDate = default(DateTimeOffset?), DateTimeOffset? PaymentDate = default(DateTimeOffset?), List<CorporateActionTransitionRequest> Transitions = default(List<CorporateActionTransitionRequest>))
        {
            ...
            {
                throw new InvalidDataException("AnnouncementDate is a required property for CreateCorporateAction and cannot be null");
            }
            else
            {
            ...
            if (ExDate == null)
            {
                throw new InvalidDataException("ExDate is a required property for CreateCorporateAction and cannot be null");
            }
            else
            {
                this.ExDate = ExDate;
            ...
            if (RecordDate == null)
            {
                throw new InvalidDataException("RecordDate is a required property for CreateCorporateAction and cannot be null");
            }
            else
            {
            ...
            if (PaymentDate == null)
            {
                throw new InvalidDataException("PaymentDate is a required property for CreateCorporateAction and cannot be null");
            }
            else
            {
            ...
            if (Transitions == null)
            {
                throw new InvalidDataException("Transitions is a required property for CreateCorporateAction and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCorporateAction {\n");
        ...
        {
            return this.Equals(input as CreateCorporateAction);
        }

        /// <summary>
        /// Returns true if CreateCorporateAction instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCorporateAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCorporateAction input)
        {
            if (input == null)
                return false;
