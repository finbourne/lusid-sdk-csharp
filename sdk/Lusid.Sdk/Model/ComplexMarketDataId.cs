...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplexMarketDataId : IEquatable<ComplexMarketDataId>
    {
        ...
        public ComplexMarketDataId(string provider = default(string), string priceSource = default(string), string lineage = default(string), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string marketAsset = default(string))
        {
            ...
            this.MarketAsset = marketAsset ?? throw new ArgumentNullException("marketAsset is a required property for ComplexMarketDataId and cannot be null");
        ...
        /// </summary>
        /// <value>The platform or vendor that provided the complex market data, e.g. &#39;DataScope&#39;, &#39;LUSID&#39;, &#39;ISDA&#39; etc.</value>
        ...
        [DataMember(Name = "marketAsset", IsRequired = true, EmitDefaultValue = false)]
