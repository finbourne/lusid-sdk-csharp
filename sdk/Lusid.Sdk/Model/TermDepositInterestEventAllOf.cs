...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TermDepositInterestEvent_allOf")]
    public partial class TermDepositInterestEventAllOf : IEquatable<TermDepositInterestEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TermDepositInterestEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermDepositInterestEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermDepositInterestEventAllOf" /> class.
        /// </summary>
        ...
        public TermDepositInterestEventAllOf(string currency = default(string), decimal? interestPerUnit = default(decimal?), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for TermDepositInterestEventAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermDepositInterestEventAllOf {\n");
        ...
        {
            return this.Equals(input as TermDepositInterestEventAllOf);
        }

        /// <summary>
        /// Returns true if TermDepositInterestEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of TermDepositInterestEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermDepositInterestEventAllOf input)
        {
            if (input == null)
            {
                return false;
