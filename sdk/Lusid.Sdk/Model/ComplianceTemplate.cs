...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceTemplate : IEquatable<ComplianceTemplate>
    {
        /// <summary>
        ...
        public ComplianceTemplate(ResourceId id = default(ResourceId), string description = default(string), List<string> tags = default(List<string>), List<ComplianceTemplateVariation> variations = default(List<ComplianceTemplateVariation>), List<Link> links = default(List<Link>))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ComplianceTemplate and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for ComplianceTemplate and cannot be null");
            // to ensure "variations" is required (not null)
            this.Variations = variations ?? throw new ArgumentNullException("variations is a required property for ComplianceTemplate and cannot be null");
            this.Tags = tags;
            this.Links = links;
        }
