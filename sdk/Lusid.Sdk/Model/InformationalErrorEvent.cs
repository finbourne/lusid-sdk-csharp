...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InformationalErrorEvent : InstrumentEvent, IEquatable<InformationalErrorEvent>
    {
        /// <summary>
        ...
        public InformationalErrorEvent(string errorDetail = default(string), string errorReason = default(string), DateTimeOffset effectiveAt = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.ErrorDetail = errorDetail ?? throw new ArgumentNullException("errorDetail is a required property for InformationalErrorEvent and cannot be null");
            // to ensure "errorReason" is required (not null)
            this.ErrorReason = errorReason ?? throw new ArgumentNullException("errorReason is a required property for InformationalErrorEvent and cannot be null");
        ...
        [DataMember(Name = "errorDetail", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "errorReason", IsRequired = true, EmitDefaultValue = false)]
