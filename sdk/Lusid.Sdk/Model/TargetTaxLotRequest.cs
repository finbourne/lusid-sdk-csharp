...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TargetTaxLotRequest :  IEquatable<TargetTaxLotRequest>
    {
        ...
        /// <param name="Cost">Book cost of holding in transaction currency.</param>
        /// <param name="PortfolioCost">Book cost of holding in portfolio currency.</param>
        /// <param name="Price">Purchase price. Part of the unique key required for multiple taxlots.</param>
        /// <param name="PurchaseDate">Purchase Date. Part of the unique key required for multiple taxlots.</param>
        /// <param name="SettlementDate">Original settlement date of the tax-lot&#39;s opening transaction..</param>
        public TargetTaxLotRequest(double? Units = default(double?), CurrencyAndAmount Cost = default(CurrencyAndAmount), double? PortfolioCost = default(double?), double? Price = default(double?), DateTimeOffset? PurchaseDate = default(DateTimeOffset?), DateTimeOffset? SettlementDate = default(DateTimeOffset?))
        {
            // to ensure "Units" is required (not null)
            if (Units == null)
            {
                throw new InvalidDataException("Units is a required property for TargetTaxLotRequest and cannot be null");
            }
            else
            {
                this.Units = Units;
        ...
        /// </summary>
        /// <value>Purchase price. Part of the unique key required for multiple taxlots</value>
        ...
        /// </summary>
        /// <value>Purchase Date. Part of the unique key required for multiple taxlots</value>
        ...
        /// </summary>
        /// <value>Original settlement date of the tax-lot&#39;s opening transaction.</value>
