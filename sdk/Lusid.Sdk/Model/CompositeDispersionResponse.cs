...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompositeDispersionResponse")]
    public partial class CompositeDispersionResponse : IEquatable<CompositeDispersionResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompositeDispersionResponse" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="results">Dispersion returns calculation grouped by ReturnId.</param>
        /// <param name="links">links.</param>
        public CompositeDispersionResponse(string href = default(string), Dictionary<string, List<CompositeDispersion>> results = default(Dictionary<string, List<CompositeDispersion>>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
        ...
        /// </summary>
        /// <value>Dispersion returns calculation grouped by ReturnId</value>
        [DataMember(Name = "results", EmitDefaultValue = true)]
        public Dictionary<string, List<CompositeDispersion>> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompositeDispersionResponse {\n");
        ...
        {
            return this.Equals(input as CompositeDispersionResponse);
        }

        /// <summary>
        /// Returns true if CompositeDispersionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CompositeDispersionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompositeDispersionResponse input)
        {
            if (input == null)
                return false;
