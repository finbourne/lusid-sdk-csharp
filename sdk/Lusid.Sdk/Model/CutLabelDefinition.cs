...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CutLabelDefinition :  IEquatable<CutLabelDefinition>
    {
        ...
        public CutLabelDefinition(string Code = default(string), string DisplayName = default(string), string Description = default(string), CutLocalTime CutLocalTime = default(CutLocalTime), string TimeZone = default(string), DateTimeOffset? EffectiveAt = default(DateTimeOffset?), List<Link> Links = default(List<Link>))
        {
            this.Code = Code;
