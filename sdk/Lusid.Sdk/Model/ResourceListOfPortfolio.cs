...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolio :  IEquatable<ResourceListOfPortfolio>
    {
        ...
        public ResourceListOfPortfolio(List<Portfolio> values = default(List<Portfolio>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
