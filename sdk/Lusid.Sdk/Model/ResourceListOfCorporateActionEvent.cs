...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCorporateActionEvent :  IEquatable<ResourceListOfCorporateActionEvent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCorporateActionEvent" /> class.
        /// </summary>
        ...
        /// <param name="Count">The total number of records returned in the set.</param>
        /// <param name="Links">Links.</param>
        public ResourceListOfCorporateActionEvent(List<CorporateAction> Values = default(List<CorporateAction>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<CorporateAction> Values { get; set; }
        ...
        /// </summary>
        /// <value>The total number of records returned in the set</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfCorporateActionEvent {\n");
        ...
        {
            return this.Equals(input as ResourceListOfCorporateActionEvent);
        }

        /// <summary>
        /// Returns true if ResourceListOfCorporateActionEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCorporateActionEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCorporateActionEvent input)
        {
            if (input == null)
                return false;
