...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ValuationRequest : IEquatable<ValuationRequest>
    {
        ...
        /// <param name="returnResultAsExpandedTypes">For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure.</param>
        ...
        /// </summary>
        /// <value>For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure</value>
        ...
        /// </summary>
        [DataMember(Name = "valuationSchedule", IsRequired = true, EmitDefaultValue = false)]
