...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentIdDto :  IEquatable<InstrumentIdDto>
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentIdDto" /> class.
        /// </summary>
        /// <param name="Type">Type.</param>
        /// <param name="Id">Id.</param>
        public InstrumentIdDto(TypeEnum? Type = default(TypeEnum?), string Id = default(string))
        {
            this.Type = Type;
            this.Id = Id;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstrumentIdDto {\n");
        ...
        {
            return this.Equals(input as InstrumentIdDto);
        }

        /// <summary>
        /// Returns true if InstrumentIdDto instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentIdDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentIdDto input)
        {
            if (input == null)
                return false;
