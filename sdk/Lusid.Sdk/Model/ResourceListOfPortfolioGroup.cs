...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfPortfolioGroup :  IEquatable<ResourceListOfPortfolioGroup>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), List<Link> links = default(List<Link>))
        {
