...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPortfolioGroup")]
    public partial class ResourceListOfPortfolioGroup : IEquatable<ResourceListOfPortfolioGroup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPortfolioGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfPortfolioGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPortfolioGroup" /> class.
        /// </summary>
        ...
        public ResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfPortfolioGroup and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        {
            return this.Equals(input as ResourceListOfPortfolioGroup);
        }

        /// <summary>
        /// Returns true if ResourceListOfPortfolioGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPortfolioGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPortfolioGroup input)
        {
            if (input == null)
                return false;
