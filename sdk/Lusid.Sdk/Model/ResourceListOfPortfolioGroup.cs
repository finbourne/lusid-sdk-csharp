...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioGroup :  IEquatable<ResourceListOfPortfolioGroup>
    {
        ...
        public ResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
