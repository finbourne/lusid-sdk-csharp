...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioGroup :  IEquatable<ResourceListOfPortfolioGroup>
    {
        ...
        public ResourceListOfPortfolioGroup(List<PortfolioGroup> values = default(List<PortfolioGroup>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
