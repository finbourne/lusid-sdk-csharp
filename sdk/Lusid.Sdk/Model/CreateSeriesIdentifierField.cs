...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSeriesIdentifierField")]
    public partial class CreateSeriesIdentifierField : IEquatable<CreateSeriesIdentifierField>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSeriesIdentifierField" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSeriesIdentifierField() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSeriesIdentifierField" /> class.
        /// </summary>
        ...
        public CreateSeriesIdentifierField(string fieldName = default(string), string displayName = default(string), string description = default(string), ResourceId dataTypeId = default(ResourceId))
        {
            // to ensure "fieldName" is required (not null)
            if (fieldName == null)
            {
                throw new ArgumentNullException("fieldName is a required property for CreateSeriesIdentifierField and cannot be null");
            }
            this.FieldName = fieldName;
            // to ensure "dataTypeId" is required (not null)
            if (dataTypeId == null)
            {
                throw new ArgumentNullException("dataTypeId is a required property for CreateSeriesIdentifierField and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateSeriesIdentifierField);
        }

        /// <summary>
        /// Returns true if CreateSeriesIdentifierField instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSeriesIdentifierField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSeriesIdentifierField input)
        {
            if (input == null)
            {
                return false;
