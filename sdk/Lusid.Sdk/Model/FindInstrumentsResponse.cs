...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FindInstrumentsResponse :  IEquatable<FindInstrumentsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FindInstrumentsResponse" /> class.
        /// </summary>
        ...
        public FindInstrumentsResponse(string Href = default(string), Dictionary<string, List<InstrumentMatch>> Values = default(Dictionary<string, List<InstrumentMatch>>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Values = Values;
            this.Links = Links;
        ...
        public Dictionary<string, List<InstrumentMatch>> Values { get; set; }
        ...
        {
            return this.Equals(input as FindInstrumentsResponse);
        }

        /// <summary>
        /// Returns true if FindInstrumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FindInstrumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FindInstrumentsResponse input)
        {
            if (input == null)
                return false;
