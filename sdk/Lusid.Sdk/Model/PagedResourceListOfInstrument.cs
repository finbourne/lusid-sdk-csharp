...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfInstrument :  IEquatable<PagedResourceListOfInstrument>
    {
        ...
        public PagedResourceListOfInstrument(List<Instrument> values = default(List<Instrument>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
