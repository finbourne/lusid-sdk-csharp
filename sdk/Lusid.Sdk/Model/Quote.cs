...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Quote :  IEquatable<Quote>
    {
        ...
        public Quote(string Id = default(string), MetricValue MetricValue = default(MetricValue), Version Version = default(Version))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for Quote and cannot be null");
            }
            else
            {
                this.Id = Id;
