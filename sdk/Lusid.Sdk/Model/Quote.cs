...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Quote :  IEquatable<Quote>
    {
        ...
        /// <param name="uploadedBy">uploadedBy (required).</param>
        /// <param name="lineage">lineage.</param>
        public Quote(QuoteId quoteId = default(QuoteId), MetricValue metricValue = default(MetricValue), DateTimeOffset? effectiveAt = default(DateTimeOffset?), DateTimeOffset? asAt = default(DateTimeOffset?), string uploadedBy = default(string), string lineage = default(string))
        {
