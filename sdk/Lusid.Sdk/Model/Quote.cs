...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Quote :  IEquatable<Quote>
    {
        ...
        /// <param name="QuoteLineage">QuoteLineage (required).</param>
        /// <param name="EffectiveAtDate">EffectiveAtDate.</param>
        /// <param name="AsAtDate">AsAtDate.</param>
        public Quote(QuoteId QuoteId = default(QuoteId), MetricValue MetricValue = default(MetricValue), QuoteLineage QuoteLineage = default(QuoteLineage), DateTimeOffset? EffectiveAtDate = default(DateTimeOffset?), DateTimeOffset? AsAtDate = default(DateTimeOffset?))
        {
            ...
            if (MetricValue == null)
            {
                throw new InvalidDataException("MetricValue is a required property for Quote and cannot be null");
            }
            else
            {
                this.MetricValue = MetricValue;
            }
            // to ensure "QuoteLineage" is required (not null)
            if (QuoteLineage == null)
            {
                throw new InvalidDataException("QuoteLineage is a required property for Quote and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets QuoteLineage
        /// </summary>
        [DataMember(Name="quoteLineage", EmitDefaultValue=false)]
        public QuoteLineage QuoteLineage { get; set; }

        /// <summary>
        /// Gets or Sets EffectiveAtDate
        /// </summary>
        [DataMember(Name="effectiveAtDate", EmitDefaultValue=false)]
        public DateTimeOffset? EffectiveAtDate { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  QuoteLineage: ").Append(QuoteLineage).Append("\n");
            sb.Append("  EffectiveAtDate: ").Append(EffectiveAtDate).Append("\n");
        ...
        public bool Equals(Quote input)
        {
            ...
            return 
                ...
                (
                    this.QuoteLineage == input.QuoteLineage ||
                    (this.QuoteLineage != null &&
                    this.QuoteLineage.Equals(input.QuoteLineage))
                ) && 
                (
                    this.EffectiveAtDate == input.EffectiveAtDate ||
                    (this.EffectiveAtDate != null &&
                    this.EffectiveAtDate.Equals(input.EffectiveAtDate))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.QuoteLineage != null)
                    hashCode = hashCode * 59 + this.QuoteLineage.GetHashCode();
                if (this.EffectiveAtDate != null)
                    hashCode = hashCode * 59 + this.EffectiveAtDate.GetHashCode();
