...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ValuationReconciliationRequest :  IEquatable<ValuationReconciliationRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="ValuationReconciliationRequest" /> class.
        /// </summary>
        /// <param name="PortfolioId">The id of the portfolio on which to run the aggregation request (required).</param>
        /// <param name="Aggregation">The specification of the aggregation request to be used to obtain the risk (required).</param>
        ...
        /// </summary>
        /// <value>The specification of the aggregation request to be used to obtain the risk</value>
