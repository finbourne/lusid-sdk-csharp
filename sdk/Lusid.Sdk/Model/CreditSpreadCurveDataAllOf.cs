...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditSpreadCurveDataAllOf : IEquatable<CreditSpreadCurveDataAllOf>
    {
        /// <summary>
        ...
        public CreditSpreadCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), List<string> tenors = default(List<string>), List<decimal> spreads = default(List<decimal>), decimal recoveryRate = default(decimal), DateTimeOffset? referenceDate = default(DateTimeOffset?), List<DateTimeOffset> maturities = default(List<DateTimeOffset>), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for CreditSpreadCurveDataAllOf and cannot be null");
            // to ensure "tenors" is required (not null)
            this.Tenors = tenors ?? throw new ArgumentNullException("tenors is a required property for CreditSpreadCurveDataAllOf and cannot be null");
            // to ensure "spreads" is required (not null)
            this.Spreads = spreads ?? throw new ArgumentNullException("spreads is a required property for CreditSpreadCurveDataAllOf and cannot be null");
        ...
        [DataMember(Name = "spreads", IsRequired = true, EmitDefaultValue = false)]
