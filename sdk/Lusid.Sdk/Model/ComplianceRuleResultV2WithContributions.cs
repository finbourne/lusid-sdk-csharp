...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComplianceRuleResultV2WithContributions")]
    public partial class ComplianceRuleResultV2WithContributions : IEquatable<ComplianceRuleResultV2WithContributions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleResultV2WithContributions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComplianceRuleResultV2WithContributions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleResultV2WithContributions" /> class.
        /// </summary>
        ...
        public ComplianceRuleResultV2WithContributions(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), ComplianceSummaryRuleResultWithContributions ruleResult = default(ComplianceSummaryRuleResultWithContributions))
        {
            // to ensure "runId" is required (not null)
            if (runId == null)
            {
                throw new ArgumentNullException("runId is a required property for ComplianceRuleResultV2WithContributions and cannot be null");
            }
            this.RunId = runId;
            ...
            if (schedule == null)
            {
                throw new ArgumentNullException("schedule is a required property for ComplianceRuleResultV2WithContributions and cannot be null");
            }
            this.Schedule = schedule;
            // to ensure "ruleResult" is required (not null)
            if (ruleResult == null)
            {
                throw new ArgumentNullException("ruleResult is a required property for ComplianceRuleResultV2WithContributions and cannot be null");
            }
        ...
        public ComplianceSummaryRuleResultWithContributions RuleResult { get; set; }
        ...
        {
            return this.Equals(input as ComplianceRuleResultV2WithContributions);
        }

        /// <summary>
        /// Returns true if ComplianceRuleResultV2WithContributions instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplianceRuleResultV2WithContributions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplianceRuleResultV2WithContributions input)
        {
            if (input == null)
            {
                return false;
