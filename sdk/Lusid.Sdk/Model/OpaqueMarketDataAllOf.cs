...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OpaqueMarketDataAllOf : IEquatable<OpaqueMarketDataAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public OpaqueMarketDataAllOf(string document = default(string), string format = default(string), string name = default(string), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            if (document == null)
            {
                throw new ArgumentNullException("document is a required property for OpaqueMarketDataAllOf and cannot be null");
            }
            this.Document = document;
            // to ensure "format" is required (not null)
            if (format == null)
            {
                throw new ArgumentNullException("format is a required property for OpaqueMarketDataAllOf and cannot be null");
            }
            this.Format = format;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for OpaqueMarketDataAllOf and cannot be null");
            }
            this.Name = name;
