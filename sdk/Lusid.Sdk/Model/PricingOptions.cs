...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PricingOptions : IEquatable<PricingOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Scale holding-level fixed-income results by the holding&#39;s current face over the instrument&#39;s  face per unit, rather than by the holding&#39;s traded units. Applies to Bond, ComplexBond and  InflationLinkedBond. Defaults to false.                Governs scaling basis only, and only for bonds outside the asset-backed family. An asset-backed  bond keeps its own machinery and its own option, MbsValuationUsingHoldingCurrentFace: because a  current face is defined as poolFactor x contractSize x units, the two are the same arithmetic at  the contract size of 1 that convention recommends, so there is nothing for this option to add  there. Neither option implies the other.                Turning this on without supplying current-face data changes no published number: a holding with  no current face scales by a quantity equal to its unit count. Numbers move only where a current  face has been supplied, whether on a transaction or by a face-moving instrument event.</value>
        [DataMember(Name = "fixedIncomeValuationsUsingCurrentFace", EmitDefaultValue = true)]
        public bool FixedIncomeValuationsUsingCurrentFace { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FixedIncomeValuationsUsingCurrentFace: ").Append(FixedIncomeValuationsUsingCurrentFace).Append("\n");
        ...
        public bool Equals(PricingOptions input)
        {
            ...
            return 
                ...
                (
                    this.FixedIncomeValuationsUsingCurrentFace == input.FixedIncomeValuationsUsingCurrentFace ||
                    this.FixedIncomeValuationsUsingCurrentFace.Equals(input.FixedIncomeValuationsUsingCurrentFace)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.FixedIncomeValuationsUsingCurrentFace.GetHashCode();
