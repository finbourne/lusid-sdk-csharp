...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeyValuePairOfPropertyKeyToFieldSchema :  IEquatable<KeyValuePairOfPropertyKeyToFieldSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValuePairOfPropertyKeyToFieldSchema" /> class.
        /// </summary>
        /// <param name="Value">Value.</param>
        public KeyValuePairOfPropertyKeyToFieldSchema(FieldSchema Value = default(FieldSchema))
        {
            this.Value = Value;
        }
        ...
        public FieldSchema Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KeyValuePairOfPropertyKeyToFieldSchema {\n");
        ...
        {
            return this.Equals(input as KeyValuePairOfPropertyKeyToFieldSchema);
        }

        /// <summary>
        /// Returns true if KeyValuePairOfPropertyKeyToFieldSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyValuePairOfPropertyKeyToFieldSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyValuePairOfPropertyKeyToFieldSchema input)
        {
            if (input == null)
                return false;
