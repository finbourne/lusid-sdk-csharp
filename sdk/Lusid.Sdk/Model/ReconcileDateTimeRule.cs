...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReconcileDateTimeRule : ReconciliationRule, IEquatable<ReconcileDateTimeRule>
    {
        /// <summary>
        ...
        public ReconcileDateTimeRule(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), decimal tolerance = default(decimal), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum)) : base(ruleType)
        {
            ...
            this.AppliesTo = appliesTo ?? throw new ArgumentNullException("appliesTo is a required property for ReconcileDateTimeRule and cannot be null");
