...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentAnalytic :  IEquatable<InstrumentAnalytic>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentAnalytic" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstrumentAnalytic() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentAnalytic" /> class.
        /// </summary>
        /// <param name="instrumentUid">Unique instrument identifier (required).</param>
        /// <param name="value">Value of the analytic, eg price (required).</param>
        /// <param name="denomination">Underlying unit of the analytic, eg currency, EPS etc..</param>
        public InstrumentAnalytic(string instrumentUid = default(string), double? value = default(double?), string denomination = default(string))
        {
            ...
            {
                throw new InvalidDataException("instrumentUid is a required property for InstrumentAnalytic and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for InstrumentAnalytic and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <value>Value of the analytic, eg price</value>
        ...
        /// </summary>
        /// <value>Underlying unit of the analytic, eg currency, EPS etc.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstrumentAnalytic {\n");
        ...
        {
            return this.Equals(input as InstrumentAnalytic);
        }

        /// <summary>
        /// Returns true if InstrumentAnalytic instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentAnalytic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentAnalytic input)
        {
            if (input == null)
                return false;
