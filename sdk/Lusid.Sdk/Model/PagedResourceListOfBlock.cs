...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfBlock")]
    public partial class PagedResourceListOfBlock : IEquatable<PagedResourceListOfBlock>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfBlock" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfBlock() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfBlock" /> class.
        /// </summary>
        ...
        public PagedResourceListOfBlock(string nextPage = default(string), string previousPage = default(string), List<Block> values = default(List<Block>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfBlock and cannot be null");
        ...
        public List<Block> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResourceListOfBlock {\n");
        ...
        {
            return this.Equals(input as PagedResourceListOfBlock);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfBlock instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfBlock to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfBlock input)
        {
            if (input == null)
                return false;
