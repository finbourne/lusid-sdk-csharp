...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EconomicDependencyWithQuote : IEquatable<EconomicDependencyWithQuote>
    {
        /// <summary>
        ...
        public EconomicDependencyWithQuote(EconomicDependency economicDependency = default(EconomicDependency), MetricValue metricValue = default(MetricValue), decimal? scaleFactor = default(decimal?))
        {
            ...
            this.EconomicDependency = economicDependency ?? throw new ArgumentNullException("economicDependency is a required property for EconomicDependencyWithQuote and cannot be null");
            // to ensure "metricValue" is required (not null)
            this.MetricValue = metricValue ?? throw new ArgumentNullException("metricValue is a required property for EconomicDependencyWithQuote and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "metricValue", IsRequired = true, EmitDefaultValue = false)]
