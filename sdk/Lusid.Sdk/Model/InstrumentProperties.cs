...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentProperties : IEquatable<InstrumentProperties>, IValidatableObject
    {
        ...
        public InstrumentProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), ModelVersion version = default(ModelVersion), List<Link> links = default(List<Link>))
        {
            this.Href = href;
