...
namespace Lusid.Sdk.Model
{
    ...
    public partial class HoldingsAdjustment : IEquatable<HoldingsAdjustment>, IValidatableObject
    {
        ...
        public HoldingsAdjustment(DateTimeOffset effectiveAt = default(DateTimeOffset), ModelVersion version = default(ModelVersion), UnmatchedHoldingMethodEnum unmatchedHoldingMethod = default(UnmatchedHoldingMethodEnum), List<HoldingAdjustment> adjustments = default(List<HoldingAdjustment>), List<Link> links = default(List<Link>))
        {
            this.EffectiveAt = effectiveAt;
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new ArgumentNullException("version is a required property for HoldingsAdjustment and cannot be null");
            }
