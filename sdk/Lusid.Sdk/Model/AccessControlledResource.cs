...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AccessControlledResource :  IEquatable<AccessControlledResource>
    {
        ...
        public AccessControlledResource(string name = default(string), string description = default(string), List<AccessControlledAction> actions = default(List<AccessControlledAction>), List<IdentifierPartSchema> identifierParts = default(List<IdentifierPartSchema>), List<Link> links = default(List<Link>))
        {
