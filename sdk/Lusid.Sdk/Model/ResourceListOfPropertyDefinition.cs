...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPropertyDefinition :  IEquatable<ResourceListOfPropertyDefinition>
    {
        ...
        public ResourceListOfPropertyDefinition(List<PropertyDefinition> values = default(List<PropertyDefinition>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
