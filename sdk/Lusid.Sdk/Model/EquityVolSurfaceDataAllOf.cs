...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityVolSurfaceDataAllOf : IEquatable<EquityVolSurfaceDataAllOf>
    {
        /// <summary>
        ...
        public EquityVolSurfaceDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), List<LusidInstrument> instruments = default(List<LusidInstrument>), List<MarketQuote> quotes = default(List<MarketQuote>), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            this.Instruments = instruments ?? throw new ArgumentNullException("instruments is a required property for EquityVolSurfaceDataAllOf and cannot be null");
            // to ensure "quotes" is required (not null)
            this.Quotes = quotes ?? throw new ArgumentNullException("quotes is a required property for EquityVolSurfaceDataAllOf and cannot be null");
