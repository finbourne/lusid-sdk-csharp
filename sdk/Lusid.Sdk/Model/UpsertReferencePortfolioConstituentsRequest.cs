...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertReferencePortfolioConstituentsRequest : IEquatable<UpsertReferencePortfolioConstituentsRequest>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.EffectiveFrom != null && this.EffectiveFrom.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for EffectiveFrom, length must be greater than 1.", new [] { "EffectiveFrom" });
            }
