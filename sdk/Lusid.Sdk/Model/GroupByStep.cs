...
namespace Lusid.Sdk.Model
{
    ...
    public partial class GroupByStep : IEquatable<GroupByStep>, IValidatableObject
    {
        /// <summary>
        ...
        public GroupByStep(string label = default(string), Dictionary<string, List<ComplianceTemplateParameter>> groupedParameters = default(Dictionary<string, List<ComplianceTemplateParameter>>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            {
                throw new ArgumentNullException("groupedParameters is a required property for GroupByStep and cannot be null");
            }
