...
namespace Lusid.Sdk.Model
{
    ...
    public partial class QuoteId :  IEquatable<QuoteId>
    {
        ...
        public QuoteId(string InstrumentId = default(string), InstrumentIdTypeEnum InstrumentIdType = default(InstrumentIdTypeEnum), QuoteTypeEnum QuoteType = default(QuoteTypeEnum), PriceSideEnum PriceSide = default(PriceSideEnum))
        {
