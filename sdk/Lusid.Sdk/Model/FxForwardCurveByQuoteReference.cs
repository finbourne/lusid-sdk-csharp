...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveByQuoteReference : ComplexMarketData, IEquatable<FxForwardCurveByQuoteReference>
    {
        /// <summary>
        ...
        /// <param name="spotDaysCalculationType">Configures how to calculate the spot date from the build date using the Calendars provided..</param>
        /// <param name="marketDataType">The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData, EquityCurveByPricesData (required) (default to &quot;FxForwardCurveByQuoteReference&quot;).</param>
        public FxForwardCurveByQuoteReference(string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<Dictionary<string, string>> quoteReferences = default(List<Dictionary<string, string>>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), List<FxTenorConvention> calendars = default(List<FxTenorConvention>), string spotDaysCalculationType = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FxForwardCurveByQuoteReference and cannot be null");
            // to ensure "fgnCcy" is required (not null)
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxForwardCurveByQuoteReference and cannot be null");
            // to ensure "tenors" is required (not null)
            this.Tenors = tenors ?? throw new ArgumentNullException("tenors is a required property for FxForwardCurveByQuoteReference and cannot be null");
            // to ensure "quoteReferences" is required (not null)
            this.QuoteReferences = quoteReferences ?? throw new ArgumentNullException("quoteReferences is a required property for FxForwardCurveByQuoteReference and cannot be null");
        ...
        /// </summary>
        /// <value>For each tenor, a list of identifiers. These will be looked up in the quotes store to resolve the actual rates.</value>
        [DataMember(Name = "quoteReferences", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Configures how to calculate the spot date from the build date using the Calendars provided.</value>
