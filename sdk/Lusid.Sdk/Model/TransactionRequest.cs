...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionRequest :  IEquatable<TransactionRequest>
    {
        ...
        public TransactionRequest(string TransactionId = default(string), string Type = default(string), string InstrumentUid = default(string), DateTimeOffset? TransactionDate = default(DateTimeOffset?), DateTimeOffset? SettlementDate = default(DateTimeOffset?), double? Units = default(double?), TransactionPrice TransactionPrice = default(TransactionPrice), CurrencyAndAmount TotalConsideration = default(CurrencyAndAmount), double? ExchangeRate = default(double?), string TransactionCurrency = default(string), Dictionary<string, PerpetualPropertyValue> Properties = default(Dictionary<string, PerpetualPropertyValue>), string CounterpartyId = default(string), SourceEnum Source = default(SourceEnum), string NettingSet = default(string))
        {
            ...
            {
                throw new InvalidDataException("InstrumentUid is a required property for TransactionRequest and cannot be null");
            }
            else
            {
            ...
            if (Source == null)
            {
                throw new InvalidDataException("Source is a required property for TransactionRequest and cannot be null");
            }
            else
            {
                this.Source = Source;
