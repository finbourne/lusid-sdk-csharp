...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionRequest :  IEquatable<TransactionRequest>
    {
        ...
        /// <param name="type">The type of the transaction e.g. &#39;Buy&#39;, &#39;Sell&#39;. The transaction type should have been pre-configured via the System Configuration API endpoint. If it hasn&#39;t been pre-configured the transaction will still be upserted however you will be unable to generate the resultant holdings for the portfolio that contains this transaction as LUSID does not know how to process it. (required).</param>
        ...
        /// <param name="counterpartyId">The source of the transaction. This is used to look up the appropriate transaction group set in the transaction type configuration..</param>
        ...
        public TransactionRequest(string transactionId = default(string), string type = default(string), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string transactionDate = default(string), string settlementDate = default(string), double? units = default(double?), TransactionPrice transactionPrice = default(TransactionPrice), CurrencyAndAmount totalConsideration = default(CurrencyAndAmount), double? exchangeRate = default(double?), string transactionCurrency = default(string), Dictionary<string, PerpetualPropertyValue> properties = default(Dictionary<string, PerpetualPropertyValue>), string counterpartyId = default(string), string source = default(string), string nettingSet = default(string))
        {
            ...
            {
                throw new InvalidDataException("transactionPrice is a required property for TransactionRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The type of the transaction e.g. &#39;Buy&#39;, &#39;Sell&#39;. The transaction type should have been pre-configured via the System Configuration API endpoint. If it hasn&#39;t been pre-configured the transaction will still be upserted however you will be unable to generate the resultant holdings for the portfolio that contains this transaction as LUSID does not know how to process it.</value>
