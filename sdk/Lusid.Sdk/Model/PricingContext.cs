...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PricingContext :  IEquatable<PricingContext>
    {
        /// <summary>
        ...
        /// <param name="Options">Miscellaneous options for controlling pricing..</param>
        public PricingContext(List<VendorModelRule> ModelRules = default(List<VendorModelRule>), Dictionary<string, ModelSelection> ModelChoice = default(Dictionary<string, ModelSelection>), PricingOptions Options = default(PricingOptions))
        {
        ...
        [DataMember(Name="modelChoice", EmitDefaultValue=false)]
        public Dictionary<string, ModelSelection> ModelChoice { get; set; }

        /// <summary>
        /// Miscellaneous options for controlling pricing.
        /// </summary>
        /// <value>Miscellaneous options for controlling pricing.</value>
