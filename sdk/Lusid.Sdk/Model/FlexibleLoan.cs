...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FlexibleLoan")]
    [JsonConverter(typeof(JsonSubtypes), "InstrumentType")]
    public partial class FlexibleLoan : LusidInstrument, IEquatable<FlexibleLoan>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlexibleLoan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlexibleLoan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlexibleLoan" /> class.
        /// </summary>
        ...
        public FlexibleLoan(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), List<Schedule> schedules = default(List<Schedule>), TimeZoneConventions timeZoneConventions = default(TimeZoneConventions), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            if (domCcy == null)
            {
                throw new ArgumentNullException("domCcy is a required property for FlexibleLoan and cannot be null");
            }
            this.DomCcy = domCcy;
            // to ensure "schedules" is required (not null)
            if (schedules == null)
            {
                throw new ArgumentNullException("schedules is a required property for FlexibleLoan and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The parent loan facility of this loan if this loan is a contract on a facility.  This resolves to the facility&#39;s LusidInstrumentId, falling back to its ClientInternal identifier,  and is null when the loan is not a contract on a facility.</value>
        [DataMember(Name = "parentFacility", EmitDefaultValue = true)]
        public string ParentFacility { get; private set; }

        /// <summary>
        /// Returns false as ParentFacility should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeParentFacility()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ParentFacility: ").Append(ParentFacility).Append("\n");
        ...
        {
            return this.Equals(input as FlexibleLoan);
        }

        /// <summary>
        /// Returns true if FlexibleLoan instances are equal
        /// </summary>
        /// <param name="input">Instance of FlexibleLoan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlexibleLoan input)
        {
            if (input == null)
            {
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.ParentFacility == input.ParentFacility ||
                    (this.ParentFacility != null &&
                    this.ParentFacility.Equals(input.ParentFacility))
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.ParentFacility.GetHashCode();
                }
