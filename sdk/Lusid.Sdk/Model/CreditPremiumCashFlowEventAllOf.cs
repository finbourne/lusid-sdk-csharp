...
{
    /// <summary>
    /// CreditPremiumCashFlowEventAllOf
    /// </summary>
    [DataContract(Name = "CreditPremiumCashFlowEvent_allOf")]
    public partial class CreditPremiumCashFlowEventAllOf : IEquatable<CreditPremiumCashFlowEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditPremiumCashFlowEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreditPremiumCashFlowEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditPremiumCashFlowEventAllOf" /> class.
        /// </summary>
        ...
        public CreditPremiumCashFlowEventAllOf(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? cashFlowPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            this.ExDate = exDate;
            ...
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for CreditPremiumCashFlowEventAllOf and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreditPremiumCashFlowEventAllOf {\n");
        ...
        {
            return this.Equals(input as CreditPremiumCashFlowEventAllOf);
        }

        /// <summary>
        /// Returns true if CreditPremiumCashFlowEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditPremiumCashFlowEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditPremiumCashFlowEventAllOf input)
        {
            if (input == null)
            {
                return false;
