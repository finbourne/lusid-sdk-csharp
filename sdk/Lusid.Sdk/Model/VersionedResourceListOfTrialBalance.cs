...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VersionedResourceListOfTrialBalance")]
    public partial class VersionedResourceListOfTrialBalance : IEquatable<VersionedResourceListOfTrialBalance>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionedResourceListOfTrialBalance" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VersionedResourceListOfTrialBalance() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionedResourceListOfTrialBalance" /> class.
        /// </summary>
        ...
        public VersionedResourceListOfTrialBalance(ModelVersion varVersion = default(ModelVersion), List<TrialBalance> values = default(List<TrialBalance>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for VersionedResourceListOfTrialBalance and cannot be null");
            }
            this.Values = values;
            this.Href = href;
        ...
        public List<TrialBalance> Values { get; set; }
        ...
        {
            return this.Equals(input as VersionedResourceListOfTrialBalance);
        }

        /// <summary>
        /// Returns true if VersionedResourceListOfTrialBalance instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionedResourceListOfTrialBalance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionedResourceListOfTrialBalance input)
        {
            if (input == null)
            {
                return false;
