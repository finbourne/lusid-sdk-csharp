...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioResultDataKeyRuleAllOf : IEquatable<PortfolioResultDataKeyRuleAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public PortfolioResultDataKeyRuleAllOf(string supplier = default(string), string dataScope = default(string), string documentCode = default(string), string quoteInterval = default(string), DateTimeOffset? asAt = default(DateTimeOffset?), string portfolioCode = default(string), string portfolioScope = default(string), ResultKeyRuleTypeEnum resultKeyRuleType = default(ResultKeyRuleTypeEnum))
        {
            ...
            if (supplier == null)
            {
                throw new ArgumentNullException("supplier is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
            }
            this.Supplier = supplier;
            // to ensure "dataScope" is required (not null)
            if (dataScope == null)
            {
                throw new ArgumentNullException("dataScope is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
            }
            this.DataScope = dataScope;
            // to ensure "documentCode" is required (not null)
            if (documentCode == null)
            {
                throw new ArgumentNullException("documentCode is a required property for PortfolioResultDataKeyRuleAllOf and cannot be null");
            }
