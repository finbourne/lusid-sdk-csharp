...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchAdjustHoldingsResponse")]
    public partial class BatchAdjustHoldingsResponse : IEquatable<BatchAdjustHoldingsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchAdjustHoldingsResponse" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The holdings which have been successfully adjusted.</value>
        [DataMember(Name = "values", EmitDefaultValue = true)]
        public Dictionary<string, HoldingAdjustmentWithDate> Values { get; set; }

        /// <summary>
        /// The holdings that could not be adjusted along with a reason for their failure.
        /// </summary>
        /// <value>The holdings that could not be adjusted along with a reason for their failure.</value>
        ...
        /// </summary>
        /// <value>Contains warnings related to adjusted holdings</value>
        ...
        {
            return this.Equals(input as BatchAdjustHoldingsResponse);
        }

        /// <summary>
        /// Returns true if BatchAdjustHoldingsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchAdjustHoldingsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchAdjustHoldingsResponse input)
        {
            if (input == null)
                return false;
