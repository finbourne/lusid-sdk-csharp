...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Compounding : IEquatable<Compounding>, IValidatableObject
    {
        ...
        /// <param name="resetFrequency">The interest payment frequency.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid) (required).</param>
        ...
        /// <summary>
        /// The interest payment frequency.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid)
        /// </summary>
        /// <value>The interest payment frequency.    For more information on tenors, see [Specifying tenors in LUSID](https://support.lusid.com/docs/specifying-tenors-in-lusid)</value>
        ...
        /// </summary>
        /// <value>Defines the number of days to lockout or shift observation period by - should be a non-negative integer.  Defaults to 0 if not set.</value>
