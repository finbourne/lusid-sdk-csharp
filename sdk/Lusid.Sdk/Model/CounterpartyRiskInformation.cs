...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CounterpartyRiskInformation :  IEquatable<CounterpartyRiskInformation>
    {
        ...
        public CounterpartyRiskInformation(string countryOfRisk = default(string), List<CreditRating> creditRatings = default(List<CreditRating>), List<IndustryClassifier> industryClassifiers = default(List<IndustryClassifier>))
        {
            ...
            {
                throw new InvalidDataException("countryOfRisk is a required property for CounterpartyRiskInformation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("creditRatings is a required property for CounterpartyRiskInformation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("industryClassifiers is a required property for CounterpartyRiskInformation and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="creditRatings", EmitDefaultValue=false)]
        public List<CreditRating> CreditRatings { get; set; }

        /// <summary>
        /// Gets or Sets IndustryClassifiers
        /// </summary>
        [DataMember(Name="industryClassifiers", EmitDefaultValue=false)]
