...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationSwap : LusidInstrument, IEquatable<InflationSwap>
    {
        /// <summary>
        ...
        /// <param name="inflationIndexName">Name (required).</param>
        /// <param name="inflationInterpolation">silly flag for old swaps    Supported string (enumeration) values are: [Linear, Flat]..</param>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan (required) (default to &quot;InflationSwap&quot;).</param>
        public InflationSwap(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), decimal fixedRate = default(decimal), decimal? inflationCap = default(decimal?), decimal? inflationFloor = default(decimal?), string inflationFrequency = default(string), string inflationIndexName = default(string), string inflationInterpolation = default(string), int inflationRollDay = default(int), decimal notional = default(decimal), string observationLag = default(string), string payReceive = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.FlowConventions = flowConventions ?? throw new ArgumentNullException("flowConventions is a required property for InflationSwap and cannot be null");
            this.FixedRate = fixedRate;
            // to ensure "inflationIndexName" is required (not null)
            this.InflationIndexName = inflationIndexName ?? throw new ArgumentNullException("inflationIndexName is a required property for InflationSwap and cannot be null");
            this.Notional = notional;
            // to ensure "observationLag" is required (not null)
            this.ObservationLag = observationLag ?? throw new ArgumentNullException("observationLag is a required property for InflationSwap and cannot be null");
        ...
        /// </summary>
        /// <value>silly flag for old swaps    Supported string (enumeration) values are: [Linear, Flat].</value>
        ...
        [DataMember(Name = "observationLag", IsRequired = true, EmitDefaultValue = false)]
