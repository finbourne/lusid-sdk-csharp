...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AdjustHoldingRequest :  IEquatable<AdjustHoldingRequest>
    {
        ...
        /// <param name="SubHoldingKeys">Key fields to uniquely index the sub holdings of a instrument.</param>
        /// <param name="Properties">Arbitrary properties to store with the holding.</param>
        /// <param name="TaxLots">1 or more quantity amounts (required).</param>
        public AdjustHoldingRequest(string InstrumentUid = default(string), Dictionary<string, PerpetualPropertyValue> SubHoldingKeys = default(Dictionary<string, PerpetualPropertyValue>), Dictionary<string, PerpetualPropertyValue> Properties = default(Dictionary<string, PerpetualPropertyValue>), List<TargetTaxLotRequest> TaxLots = default(List<TargetTaxLotRequest>))
        {
            // to ensure "InstrumentUid" is required (not null)
            if (InstrumentUid == null)
            {
                throw new InvalidDataException("InstrumentUid is a required property for AdjustHoldingRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Key fields to uniquely index the sub holdings of a instrument</value>
        ...
        /// </summary>
        /// <value>Arbitrary properties to store with the holding</value>
        ...
        /// </summary>
        /// <value>1 or more quantity amounts</value>
