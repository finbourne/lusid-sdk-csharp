...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpFrontPayment")]
    public partial class UpFrontPayment : IEquatable<UpFrontPayment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpFrontPayment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpFrontPayment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpFrontPayment" /> class.
        /// </summary>
        ...
        public UpFrontPayment(decimal amount = default(decimal), string currency = default(string), DateTimeOffset payDate = default(DateTimeOffset), string payReceive = default(string))
        {
            this.Amount = amount;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for UpFrontPayment and cannot be null");
            }
            ...
            if (payReceive == null)
            {
                throw new ArgumentNullException("payReceive is a required property for UpFrontPayment and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpFrontPayment);
        }

        /// <summary>
        /// Returns true if UpFrontPayment instances are equal
        /// </summary>
        /// <param name="input">Instance of UpFrontPayment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpFrontPayment input)
        {
            if (input == null)
            {
                return false;
