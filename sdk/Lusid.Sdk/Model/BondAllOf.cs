...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondAllOf : IEquatable<BondAllOf>
    {
        ...
        /// Initializes a new instance of the <see cref="BondAllOf" /> class.
        /// </summary>
        /// <param name="startDate">The start date of the bond&#39;s first coupon start date or accrual state date (if settle days &#x3D; 0) (required).</param>
        ...
        /// </summary>
        /// <value>The start date of the bond&#39;s first coupon start date or accrual state date (if settle days &#x3D; 0)</value>
        ...
        /// </summary>
        /// <value>Number of Good Business Days before the next coupon payment, in which the bond goes ex-dividend. This means that if the settlement date falls in the ex-dividend period  then the coupon paid is zero and the accrued interest is negative. The ex-dividend  period is (Next Coupon Payment Date - ExDividendDays, Next Coupon Payment Date).</value>
        ...
        /// </summary>
        /// <value>The initial coupon date applies to ex-dividends bonds with effectiveAt date before the initial accrual start date. In this case, the initial coupon date is used as an anchor to  generate a bond schedule that allows the computation of the ex-dividend date and hence the right coupon amount and accrued interest.</value>
