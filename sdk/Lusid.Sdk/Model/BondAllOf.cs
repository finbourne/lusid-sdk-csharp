...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondAllOf : IEquatable<BondAllOf>
    {
        ...
        /// <param name="exDividendDays">Optional. Number of calendar days in the ex-dividend period,  if the settlement date falls in the ex-dividend period then the coupon paid is zero and the accrued interest is negative.  If set, this must be a non-negative number.  If not set, or set to 0, than there is no ex-dividend period..</param>
        ...
        /// </summary>
        /// <value>Optional. Number of calendar days in the ex-dividend period,  if the settlement date falls in the ex-dividend period then the coupon paid is zero and the accrued interest is negative.  If set, this must be a non-negative number.  If not set, or set to 0, than there is no ex-dividend period.</value>
