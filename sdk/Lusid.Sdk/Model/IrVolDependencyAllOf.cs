...
namespace Lusid.Sdk.Model
{
    ...
    public partial class IrVolDependencyAllOf : IEquatable<IrVolDependencyAllOf>
    {
        /// <summary>
        ...
        public IrVolDependencyAllOf(string currency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for IrVolDependencyAllOf and cannot be null");
            // to ensure "volType" is required (not null)
            this.VolType = volType ?? throw new ArgumentNullException("volType is a required property for IrVolDependencyAllOf and cannot be null");
            this.Date = date;
