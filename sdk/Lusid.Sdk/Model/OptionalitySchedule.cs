...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OptionalitySchedule : Schedule, IEquatable<OptionalitySchedule>, IValidatableObject
    {
        ...
        /// <param name="optionType">Type of optionality for the schedule.    Supported string (enumeration) values are: [Call, Put].  Defaults to \&quot;Call\&quot; if not set..</param>
        /// <param name="scheduleType">Available values: FixedSchedule, FloatSchedule, OptionalitySchedule, StepSchedule, Exercise, FxRateSchedule, FxLinkedNotionalSchedule, BondConversionSchedule, PikSchedule, CommodityCalendarSchedule, Invalid, CancelSchedule. (required) (default to &quot;OptionalitySchedule&quot;).</param>
        ...
        /// </summary>
        /// <value>Type of optionality for the schedule.    Supported string (enumeration) values are: [Call, Put].  Defaults to \&quot;Call\&quot; if not set.</value>
