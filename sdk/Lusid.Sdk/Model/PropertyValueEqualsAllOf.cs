...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PropertyValueEqualsAllOf : IEquatable<PropertyValueEqualsAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public PropertyValueEqualsAllOf(string propertyKey = default(string), string value = default(string), CriterionTypeEnum criterionType = default(CriterionTypeEnum))
        {
            ...
            if (propertyKey == null)
            {
                throw new ArgumentNullException("propertyKey is a required property for PropertyValueEqualsAllOf and cannot be null");
            }
            this.PropertyKey = propertyKey;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PropertyValueEqualsAllOf and cannot be null");
            }
            this.Value = value;
