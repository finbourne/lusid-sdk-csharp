...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeyValuePairOfStringToFieldSchema :  IEquatable<KeyValuePairOfStringToFieldSchema>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValuePairOfStringToFieldSchema" /> class.
        /// </summary>
        /// <param name="Value">Value.</param>
        public KeyValuePairOfStringToFieldSchema(FieldSchema Value = default(FieldSchema))
        {
            this.Value = Value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KeyValuePairOfStringToFieldSchema {\n");
        ...
        {
            return this.Equals(input as KeyValuePairOfStringToFieldSchema);
        }

        /// <summary>
        /// Returns true if KeyValuePairOfStringToFieldSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyValuePairOfStringToFieldSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyValuePairOfStringToFieldSchema input)
        {
            if (input == null)
                return false;
