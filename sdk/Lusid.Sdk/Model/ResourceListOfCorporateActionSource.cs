...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCorporateActionSource :  IEquatable<ResourceListOfCorporateActionSource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCorporateActionSource" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfCorporateActionSource() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCorporateActionSource" /> class.
        /// </summary>
        ...
        public ResourceListOfCorporateActionSource(List<CorporateActionSource> values = default(List<CorporateActionSource>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfCorporateActionSource and cannot be null");
            }
            else
            {
                this.Values = values;
        ...
        public List<CorporateActionSource> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfCorporateActionSource);
        }

        /// <summary>
        /// Returns true if ResourceListOfCorporateActionSource instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCorporateActionSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCorporateActionSource input)
        {
            if (input == null)
                return false;
