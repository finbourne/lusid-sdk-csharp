...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentMatchAliases :  IEquatable<InstrumentMatchAliases>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentMatchAliases" /> class.
        /// </summary>
        /// <param name="Undefined">Undefined.</param>
        /// <param name="LusidInstrumentId">LusidInstrumentId.</param>
        /// <param name="ReutersAssetId">ReutersAssetId.</param>
        /// <param name="CINS">CINS.</param>
        ...
        /// <param name="CompositeFigi">CompositeFigi.</param>
        /// <param name="ShareClassFigi">ShareClassFigi.</param>
        /// <param name="Wertpapier">Wertpapier.</param>
        public InstrumentMatchAliases(string Undefined = default(string), string LusidInstrumentId = default(string), string ReutersAssetId = default(string), string CINS = default(string), string Isin = default(string), string Sedol = default(string), string Cusip = default(string), string Ticker = default(string), string ClientInternal = default(string), string Figi = default(string), string CompositeFigi = default(string), string ShareClassFigi = default(string), string Wertpapier = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ReutersAssetId
        /// </summary>
        [DataMember(Name="ReutersAssetId", EmitDefaultValue=false)]
        public string ReutersAssetId { get; set; }

        /// <summary>
        /// Gets or Sets CINS
        /// </summary>
        [DataMember(Name="CINS", EmitDefaultValue=false)]
        ...
        /// <summary>
        /// Gets or Sets CompositeFigi
        /// </summary>
        [DataMember(Name="CompositeFigi", EmitDefaultValue=false)]
        public string CompositeFigi { get; set; }

        /// <summary>
        /// Gets or Sets ShareClassFigi
        /// </summary>
        [DataMember(Name="ShareClassFigi", EmitDefaultValue=false)]
        public string ShareClassFigi { get; set; }

        /// <summary>
        /// Gets or Sets Wertpapier
        /// </summary>
        [DataMember(Name="Wertpapier", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Wertpapier: ").Append(Wertpapier).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as InstrumentMatchAliases);
        }

        /// <summary>
        /// Returns true if InstrumentMatchAliases instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentMatchAliases to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentMatchAliases input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReutersAssetId == input.ReutersAssetId ||
                    (this.ReutersAssetId != null &&
                    this.ReutersAssetId.Equals(input.ReutersAssetId))
                ) && 
                (
                    this.CINS == input.CINS ||
                    (this.CINS != null &&
                    this.CINS.Equals(input.CINS))
                ) && 
                (
                ...
                (
                    this.Wertpapier == input.Wertpapier ||
                    (this.Wertpapier != null &&
                    this.Wertpapier.Equals(input.Wertpapier))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReutersAssetId != null)
                    hashCode = hashCode * 59 + this.ReutersAssetId.GetHashCode();
                if (this.CINS != null)
                    hashCode = hashCode * 59 + this.CINS.GetHashCode();
                if (this.Isin != null)
                ...
                if (this.Wertpapier != null)
                    hashCode = hashCode * 59 + this.Wertpapier.GetHashCode();
                return hashCode;
            }
        }
    }
