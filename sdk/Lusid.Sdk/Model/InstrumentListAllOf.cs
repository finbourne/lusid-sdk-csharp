...
namespace Lusid.Sdk.Model
{
    ...
    /// InstrumentListAllOf
    /// </summary>
    [DataContract(Name = "InstrumentList_allOf")]
    public partial class InstrumentListAllOf : IEquatable<InstrumentListAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentListAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InstrumentListAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentListAllOf" /> class.
        /// </summary>
        ...
        public InstrumentListAllOf(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for InstrumentListAllOf and cannot be null");
        ...
        {
            return this.Equals(input as InstrumentListAllOf);
        }

        /// <summary>
        /// Returns true if InstrumentListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentListAllOf input)
        {
            if (input == null)
                return false;
