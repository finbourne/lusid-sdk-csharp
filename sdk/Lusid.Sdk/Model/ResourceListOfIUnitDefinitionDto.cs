...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfIUnitDefinitionDto :  IEquatable<ResourceListOfIUnitDefinitionDto>
    {
        ...
        public ResourceListOfIUnitDefinitionDto(List<IUnitDefinitionDto> values = default(List<IUnitDefinitionDto>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
