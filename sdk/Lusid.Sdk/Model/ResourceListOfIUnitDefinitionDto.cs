...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfIUnitDefinitionDto :  IEquatable<ResourceListOfIUnitDefinitionDto>
    {
        ...
        public ResourceListOfIUnitDefinitionDto(List<IUnitDefinitionDto> values = default(List<IUnitDefinitionDto>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfIUnitDefinitionDto and cannot be null");
            }
            else
            {
                this.Values = values;
