...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateCutLabelDefinitionRequest :  IEquatable<UpdateCutLabelDefinitionRequest>
    {
        ...
        public UpdateCutLabelDefinitionRequest(string DisplayName = default(string), string Description = default(string), CutLocalTime CutLocalTime = default(CutLocalTime), string TimeZone = default(string), DateTimeOffset? EffectiveAt = default(DateTimeOffset?))
        {
            ...
            if (EffectiveAt == null)
            {
                throw new InvalidDataException("EffectiveAt is a required property for UpdateCutLabelDefinitionRequest and cannot be null");
            }
            else
            {
