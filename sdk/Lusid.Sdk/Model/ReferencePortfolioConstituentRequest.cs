...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferencePortfolioConstituentRequest :  IEquatable<ReferencePortfolioConstituentRequest>
    {
        ...
        /// </summary>
        /// <param name="InstrumentUid">InstrumentUid.</param>
        /// <param name="Properties">Properties.</param>
        /// <param name="Weight">Weight.</param>
        /// <param name="Currency">Currency.</param>
        public ReferencePortfolioConstituentRequest(string InstrumentUid = default(string), Dictionary<string, PerpetualPropertyValue> Properties = default(Dictionary<string, PerpetualPropertyValue>), double? Weight = default(double?), string Currency = default(string))
        {
