 ...
 *
 * The version of the OpenAPI document: 0.10.174
...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferencePortfolioConstituentRequest :  IEquatable<ReferencePortfolioConstituentRequest>
    {
        ...
        public ReferencePortfolioConstituentRequest(Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), Dictionary<string, PerpetualPropertyValue> properties = default(Dictionary<string, PerpetualPropertyValue>), double? weight = default(double?), string currency = default(string))
        {
