...
namespace Lusid.Sdk.Model
{
    ...
    public partial class OutputTransition : IEquatable<OutputTransition>
    {
        /// <summary>
        ...
        public OutputTransition(Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), decimal unitsFactor = default(decimal), decimal costFactor = default(decimal))
        {
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for OutputTransition and cannot be null");
