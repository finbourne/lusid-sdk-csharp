...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// The domain that the property will be created in.
        /// </summary>
        /// <value>The domain that the property will be created in.</value>
        ...
        /// <summary>
        /// Controls how the property&#39;s values can change over time. Defaults to \&quot;Perpetual\&quot; if not specified.
        /// </summary>
        /// <value>Controls how the property&#39;s values can change over time. Defaults to \&quot;Perpetual\&quot; if not specified.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// Initializes a new instance of the <see cref="CreatePropertyDefinitionRequest" /> class.
        /// </summary>
        /// <param name="domain">The domain that the property will be created in. (required).</param>
        /// <param name="scope">The scope that the property will be created in. (required).</param>
        /// <param name="code">The code that the property will be created with. Together with the domain and  scope this uniquely identifies the property. (required).</param>
        /// <param name="valueRequired">Whether or not a value is always required for this property. Defaults to false if not specified..</param>
        /// <param name="displayName">The display name of the property. (required).</param>
        /// <param name="dataTypeId">dataTypeId (required).</param>
        /// <param name="lifeTime">Controls how the property&#39;s values can change over time. Defaults to \&quot;Perpetual\&quot; if not specified..</param>
        public CreatePropertyDefinitionRequest(DomainEnum domain = default(DomainEnum), string scope = default(string), string code = default(string), bool? valueRequired = default(bool?), string displayName = default(string), ResourceId dataTypeId = default(ResourceId), LifeTimeEnum? lifeTime = default(LifeTimeEnum?))
        {
        ...
        /// <summary>
        /// The scope that the property will be created in.
        /// </summary>
        /// <value>The scope that the property will be created in.</value>
        [DataMember(Name="scope", EmitDefaultValue=false)]
        public string Scope { get; set; }

        /// <summary>
        /// The code that the property will be created with. Together with the domain and  scope this uniquely identifies the property.
        /// </summary>
        /// <value>The code that the property will be created with. Together with the domain and  scope this uniquely identifies the property.</value>
        [DataMember(Name="code", EmitDefaultValue=false)]
        public string Code { get; set; }

        /// <summary>
        /// Whether or not a value is always required for this property. Defaults to false if not specified.
        /// </summary>
        /// <value>Whether or not a value is always required for this property. Defaults to false if not specified.</value>
