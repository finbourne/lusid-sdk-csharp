...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioCashFlow : IEquatable<PortfolioCashFlow>
    {
        ...
        /// </summary>
        [DataMember(Name = "unrealisedGainLossReportingCurrency", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  UnrealisedGainLossReportingCurrency: ").Append(UnrealisedGainLossReportingCurrency).Append("\n");
        ...
        public bool Equals(PortfolioCashFlow input)
        {
            ...
            return 
                ...
                (
                    this.UnrealisedGainLossReportingCurrency == input.UnrealisedGainLossReportingCurrency ||
                    (this.UnrealisedGainLossReportingCurrency != null &&
                    this.UnrealisedGainLossReportingCurrency.Equals(input.UnrealisedGainLossReportingCurrency))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UnrealisedGainLossReportingCurrency != null)
                    hashCode = hashCode * 59 + this.UnrealisedGainLossReportingCurrency.GetHashCode();
                if (this.Links != null)
