...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TermDepositPrincipalEventAllOf : IEquatable<TermDepositPrincipalEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public TermDepositPrincipalEventAllOf(string currency = default(string), DateTimeOffset paymentDate = default(DateTimeOffset), decimal? principalPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for TermDepositPrincipalEventAllOf and cannot be null");
            }
