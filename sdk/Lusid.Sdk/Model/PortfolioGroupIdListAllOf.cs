...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioGroupIdListAllOf : IEquatable<PortfolioGroupIdListAllOf>
    {
        /// <summary>
        ...
        public PortfolioGroupIdListAllOf(List<ResourceId> values = default(List<ResourceId>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PortfolioGroupIdListAllOf and cannot be null");
