...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MatchInstrumentsResponse :  IEquatable<MatchInstrumentsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatchInstrumentsResponse" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Values">A dictionary of instruments that are keyed by the search criteria supplied in the  matching request. If no match was found, then there will be no values in the collection  for that key..</param>
        /// <param name="Links">Links.</param>
        public MatchInstrumentsResponse(string Href = default(string), Dictionary<string, List<InstrumentDefinition>> Values = default(Dictionary<string, List<InstrumentDefinition>>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Values = Values;
            this.Links = Links;
        ...
        /// </summary>
        /// <value>A dictionary of instruments that are keyed by the search criteria supplied in the  matching request. If no match was found, then there will be no values in the collection  for that key.</value>
        [DataMember(Name="values", EmitDefaultValue=false)]
        public Dictionary<string, List<InstrumentDefinition>> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatchInstrumentsResponse {\n");
        ...
        {
            return this.Equals(input as MatchInstrumentsResponse);
        }

        /// <summary>
        /// Returns true if MatchInstrumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MatchInstrumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatchInstrumentsResponse input)
        {
            if (input == null)
                return false;
