...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregatedReturnsRequest : IEquatable<AggregatedReturnsRequest>
    {
        ...
        public AggregatedReturnsRequest(List<PerformanceReturnsMetric> metrics = default(List<PerformanceReturnsMetric>), ResourceId returnId = default(ResourceId), ResourceId recipeId = default(ResourceId), string compositeMethod = default(string), string period = default(string), string outputFrequency = default(string), string alternativeInceptionDate = default(string))
        {
        ...
        public ResourceId ReturnId { get; set; }
