...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfChangeHistory : IEquatable<ResourceListOfChangeHistory>
    {
        /// <summary>
        ...
        public ResourceListOfChangeHistory(List<ChangeHistory> values = default(List<ChangeHistory>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfChangeHistory and cannot be null");
            this.Href = href;
            this.Links = links;
