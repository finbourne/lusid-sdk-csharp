...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CustomEntityDefinition : IEquatable<CustomEntityDefinition>
    {
        ...
        public CustomEntityDefinition(string href = default(string), string entityTypeName = default(string), string displayName = default(string), string description = default(string), string entityType = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            ...
            this.EntityTypeName = entityTypeName ?? throw new ArgumentNullException("entityTypeName is a required property for CustomEntityDefinition and cannot be null");
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CustomEntityDefinition and cannot be null");
            // to ensure "entityType" is required (not null)
            this.EntityType = entityType ?? throw new ArgumentNullException("entityType is a required property for CustomEntityDefinition and cannot be null");
            // to ensure "fieldSchema" is required (not null)
            this.FieldSchema = fieldSchema ?? throw new ArgumentNullException("fieldSchema is a required property for CustomEntityDefinition and cannot be null");
            this.Href = href;
