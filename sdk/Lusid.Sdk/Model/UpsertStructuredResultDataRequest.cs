...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertStructuredResultDataRequest : IEquatable<UpsertStructuredResultDataRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpsertStructuredResultDataRequest(StructuredResultDataId id = default(StructuredResultDataId), StructuredResultData data = default(StructuredResultData))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for UpsertStructuredResultDataRequest and cannot be null");
            }
            this.Id = id;
            this.Data = data;
        }
