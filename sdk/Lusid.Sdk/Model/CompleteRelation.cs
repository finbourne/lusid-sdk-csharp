...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CompleteRelation :  IEquatable<CompleteRelation>
    {
        ...
        public CompleteRelation(string href = default(string), Version version = default(Version), ResourceId relationDefinitionId = default(ResourceId), Dictionary<string, string> sourceEntityId = default(Dictionary<string, string>), Dictionary<string, string> targetEntityId = default(Dictionary<string, string>), string outwardDescription = default(string), string inwardDescription = default(string), DateTimeOffset? effectiveFrom = default(DateTimeOffset?))
        {
            ...
            {
                throw new InvalidDataException("relationDefinitionId is a required property for CompleteRelation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("sourceEntityId is a required property for CompleteRelation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("targetEntityId is a required property for CompleteRelation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("outwardDescription is a required property for CompleteRelation and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("inwardDescription is a required property for CompleteRelation and cannot be null");
            }
            else
            {
