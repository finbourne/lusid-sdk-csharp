...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfInstrumentMatch :  IEquatable<ResourceListOfInstrumentMatch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfInstrumentMatch" /> class.
        /// </summary>
        ...
        public ResourceListOfInstrumentMatch(List<InstrumentMatch> Values = default(List<InstrumentMatch>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<InstrumentMatch> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfInstrumentMatch {\n");
        ...
        {
            return this.Equals(input as ResourceListOfInstrumentMatch);
        }

        /// <summary>
        /// Returns true if ResourceListOfInstrumentMatch instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfInstrumentMatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfInstrumentMatch input)
        {
            if (input == null)
                return false;
