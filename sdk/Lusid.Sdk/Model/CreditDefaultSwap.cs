...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreditDefaultSwap : LusidInstrument, IEquatable<CreditDefaultSwap>
    {
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan (required) (default to &quot;CreditDefaultSwap&quot;).</param>
        public CreditDefaultSwap(string ticker = default(string), DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), CdsFlowConventions flowConventions = default(CdsFlowConventions), decimal couponRate = default(decimal), FlowConventionName conventionName = default(FlowConventionName), decimal? notional = default(decimal?), CdsProtectionDetailSpecification protectionDetailSpecification = default(CdsProtectionDetailSpecification), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.Ticker = ticker ?? throw new ArgumentNullException("ticker is a required property for CreditDefaultSwap and cannot be null");
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            this.CouponRate = couponRate;
            // to ensure "protectionDetailSpecification" is required (not null)
            this.ProtectionDetailSpecification = protectionDetailSpecification ?? throw new ArgumentNullException("protectionDetailSpecification is a required property for CreditDefaultSwap and cannot be null");
