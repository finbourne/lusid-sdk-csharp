...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfConstituentsAdjustmentHeader")]
    public partial class ResourceListOfConstituentsAdjustmentHeader : IEquatable<ResourceListOfConstituentsAdjustmentHeader>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfConstituentsAdjustmentHeader" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfConstituentsAdjustmentHeader() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfConstituentsAdjustmentHeader" /> class.
        /// </summary>
        ...
        public ResourceListOfConstituentsAdjustmentHeader(List<ConstituentsAdjustmentHeader> values = default(List<ConstituentsAdjustmentHeader>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfConstituentsAdjustmentHeader and cannot be null");
            this.Href = href;
            this.Links = links;
        ...
        public List<ConstituentsAdjustmentHeader> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfConstituentsAdjustmentHeader);
        }

        /// <summary>
        /// Returns true if ResourceListOfConstituentsAdjustmentHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfConstituentsAdjustmentHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfConstituentsAdjustmentHeader input)
        {
            if (input == null)
                return false;
