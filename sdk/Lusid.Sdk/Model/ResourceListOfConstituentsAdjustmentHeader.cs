...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfConstituentsAdjustmentHeader :  IEquatable<ResourceListOfConstituentsAdjustmentHeader>
    {
        ...
        public ResourceListOfConstituentsAdjustmentHeader(List<ConstituentsAdjustmentHeader> values = default(List<ConstituentsAdjustmentHeader>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
