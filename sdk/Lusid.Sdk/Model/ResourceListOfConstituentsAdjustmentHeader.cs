...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfConstituentsAdjustmentHeader :  IEquatable<ResourceListOfConstituentsAdjustmentHeader>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfConstituentsAdjustmentHeader(List<ConstituentsAdjustmentHeader> values = default(List<ConstituentsAdjustmentHeader>), string href = default(string), List<Link> links = default(List<Link>))
        {
