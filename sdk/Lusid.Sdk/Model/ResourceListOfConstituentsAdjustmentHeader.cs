...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfConstituentsAdjustmentHeader :  IEquatable<ResourceListOfConstituentsAdjustmentHeader>
    {
        ...
        public ResourceListOfConstituentsAdjustmentHeader(List<ConstituentsAdjustmentHeader> values = default(List<ConstituentsAdjustmentHeader>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
