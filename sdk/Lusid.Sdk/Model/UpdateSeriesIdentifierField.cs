...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateSeriesIdentifierField")]
    public partial class UpdateSeriesIdentifierField : IEquatable<UpdateSeriesIdentifierField>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSeriesIdentifierField" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateSeriesIdentifierField() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSeriesIdentifierField" /> class.
        /// </summary>
        ...
        /// <param name="required">Whether this field is mandatory in the dataset. (required).</param>
        public UpdateSeriesIdentifierField(string fieldName = default(string), string displayName = default(string), string description = default(string), ResourceId dataTypeId = default(ResourceId), bool required = default(bool))
        {
            // to ensure "fieldName" is required (not null)
            if (fieldName == null)
            {
                throw new ArgumentNullException("fieldName is a required property for UpdateSeriesIdentifierField and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateSeriesIdentifierField);
        }

        /// <summary>
        /// Returns true if UpdateSeriesIdentifierField instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSeriesIdentifierField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSeriesIdentifierField input)
        {
            if (input == null)
            {
                return false;
