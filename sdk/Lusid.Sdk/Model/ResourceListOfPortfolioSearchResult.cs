...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioSearchResult :  IEquatable<ResourceListOfPortfolioSearchResult>
    {
        ...
        public ResourceListOfPortfolioSearchResult(List<PortfolioSearchResult> values = default(List<PortfolioSearchResult>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
