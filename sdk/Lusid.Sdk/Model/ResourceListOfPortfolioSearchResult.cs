...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioSearchResult :  IEquatable<ResourceListOfPortfolioSearchResult>
    {
        ...
        public ResourceListOfPortfolioSearchResult(List<PortfolioSearchResult> values = default(List<PortfolioSearchResult>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
