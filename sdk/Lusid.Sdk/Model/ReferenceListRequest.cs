...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferenceListRequest : IEquatable<ReferenceListRequest>
    {
        /// <summary>
        ...
        public ReferenceListRequest(ResourceId id = default(ResourceId), string name = default(string), string description = default(string), List<string> tags = default(List<string>), ReferenceList referenceList = default(ReferenceList))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ReferenceListRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ReferenceListRequest and cannot be null");
            // to ensure "referenceList" is required (not null)
            this.ReferenceList = referenceList ?? throw new ArgumentNullException("referenceList is a required property for ReferenceListRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "referenceList", IsRequired = true, EmitDefaultValue = false)]
