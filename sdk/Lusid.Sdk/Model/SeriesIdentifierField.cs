...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SeriesIdentifierField")]
    public partial class SeriesIdentifierField : IEquatable<SeriesIdentifierField>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesIdentifierField" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SeriesIdentifierField() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SeriesIdentifierField" /> class.
        /// </summary>
        ...
        public SeriesIdentifierField(string fieldName = default(string), string displayName = default(string), string description = default(string), ResourceId dataTypeId = default(ResourceId))
        {
            // to ensure "fieldName" is required (not null)
            if (fieldName == null)
            {
                throw new ArgumentNullException("fieldName is a required property for SeriesIdentifierField and cannot be null");
            }
            this.FieldName = fieldName;
            // to ensure "dataTypeId" is required (not null)
            if (dataTypeId == null)
            {
                throw new ArgumentNullException("dataTypeId is a required property for SeriesIdentifierField and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeriesIdentifierField {\n");
        ...
        {
            return this.Equals(input as SeriesIdentifierField);
        }

        /// <summary>
        /// Returns true if SeriesIdentifierField instances are equal
        /// </summary>
        /// <param name="input">Instance of SeriesIdentifierField to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeriesIdentifierField input)
        {
            if (input == null)
            {
                return false;
