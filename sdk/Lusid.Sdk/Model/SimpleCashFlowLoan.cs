...
namespace Lusid.Sdk.Model
{
    ...
    public partial class SimpleCashFlowLoan : LusidInstrument, IEquatable<SimpleCashFlowLoan>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan (required) (default to &quot;SimpleCashFlowLoan&quot;).</param>
        public SimpleCashFlowLoan(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string domCcy = default(string), List<LoanPeriod> periods = default(List<LoanPeriod>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for SimpleCashFlowLoan and cannot be null");
            // to ensure "periods" is required (not null)
            this.Periods = periods ?? throw new ArgumentNullException("periods is a required property for SimpleCashFlowLoan and cannot be null");
        }
