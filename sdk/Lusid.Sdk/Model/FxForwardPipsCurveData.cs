...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardPipsCurveData : ComplexMarketData, IEquatable<FxForwardPipsCurveData>, IValidatableObject
    {
        /// <summary>
        ...
        public FxForwardPipsCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> pipRates = default(List<decimal>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), ModelVersion varVersion = default(ModelVersion), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            ...
            if (domCcy == null)
            {
                throw new ArgumentNullException("domCcy is a required property for FxForwardPipsCurveData and cannot be null");
            }
            this.DomCcy = domCcy;
            // to ensure "fgnCcy" is required (not null)
            if (fgnCcy == null)
            {
                throw new ArgumentNullException("fgnCcy is a required property for FxForwardPipsCurveData and cannot be null");
            }
            this.FgnCcy = fgnCcy;
            // to ensure "dates" is required (not null)
            if (dates == null)
            {
                throw new ArgumentNullException("dates is a required property for FxForwardPipsCurveData and cannot be null");
            }
            this.Dates = dates;
