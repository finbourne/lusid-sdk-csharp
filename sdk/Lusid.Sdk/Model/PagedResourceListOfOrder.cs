...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfOrder : IEquatable<PagedResourceListOfOrder>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceListOfOrder(string nextPage = default(string), string previousPage = default(string), List<Order> values = default(List<Order>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for PagedResourceListOfOrder and cannot be null");
            }
            this.Values = values;
