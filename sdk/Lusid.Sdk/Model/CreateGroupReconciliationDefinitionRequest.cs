...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateGroupReconciliationDefinitionRequest")]
    public partial class CreateGroupReconciliationDefinitionRequest : IEquatable<CreateGroupReconciliationDefinitionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGroupReconciliationDefinitionRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateGroupReconciliationDefinitionRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGroupReconciliationDefinitionRequest" /> class.
        /// </summary>
        ...
        public CreateGroupReconciliationDefinitionRequest(ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), GroupReconciliationDefinitionPortfolioEntityIds portfolioEntityIds = default(GroupReconciliationDefinitionPortfolioEntityIds), GroupReconciliationDefinitionRecipeIds recipeIds = default(GroupReconciliationDefinitionRecipeIds), GroupReconciliationDefinitionCurrencies currencies = default(GroupReconciliationDefinitionCurrencies), TransactionDateWindows transactionDateWindows = default(TransactionDateWindows), GroupReconciliationDefinitionComparisonRulesetIds comparisonRulesetIds = default(GroupReconciliationDefinitionComparisonRulesetIds), BreakCodeSource breakCodeSource = default(BreakCodeSource))
        {
            ...
            {
                throw new ArgumentNullException("portfolioEntityIds is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            }
            this.PortfolioEntityIds = portfolioEntityIds;
            // to ensure "breakCodeSource" is required (not null)
            if (breakCodeSource == null)
            {
                throw new ArgumentNullException("breakCodeSource is a required property for CreateGroupReconciliationDefinitionRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateGroupReconciliationDefinitionRequest);
        }

        /// <summary>
        /// Returns true if CreateGroupReconciliationDefinitionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateGroupReconciliationDefinitionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateGroupReconciliationDefinitionRequest input)
        {
            if (input == null)
            {
                return false;
