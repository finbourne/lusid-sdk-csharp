...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxDependencyAllOf : IEquatable<FxDependencyAllOf>
    {
        /// <summary>
        ...
        public FxDependencyAllOf(string domesticCurrency = default(string), string foreignCurrency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for FxDependencyAllOf and cannot be null");
            // to ensure "foreignCurrency" is required (not null)
            this.ForeignCurrency = foreignCurrency ?? throw new ArgumentNullException("foreignCurrency is a required property for FxDependencyAllOf and cannot be null");
            this.Date = date;
