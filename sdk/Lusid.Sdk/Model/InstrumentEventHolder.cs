...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentEventHolder : IEquatable<InstrumentEventHolder>
    {
        /// <summary>
        ...
        public InstrumentEventHolder(string instrumentEventId = default(string), ResourceId corporateActionSourceId = default(ResourceId), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string lusidInstrumentId = default(string), string instrumentScope = default(string), string description = default(string), InstrumentEvent instrumentEvent = default(InstrumentEvent), List<PerpetualProperty> properties = default(List<PerpetualProperty>))
        {
            ...
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for InstrumentEventHolder and cannot be null");
            // to ensure "lusidInstrumentId" is required (not null)
            this.LusidInstrumentId = lusidInstrumentId ?? throw new ArgumentNullException("lusidInstrumentId is a required property for InstrumentEventHolder and cannot be null");
            // to ensure "instrumentScope" is required (not null)
            this.InstrumentScope = instrumentScope ?? throw new ArgumentNullException("instrumentScope is a required property for InstrumentEventHolder and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for InstrumentEventHolder and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "instrumentEvent", IsRequired = true, EmitDefaultValue = false)]
