...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertQuotesResponse :  IEquatable<UpsertQuotesResponse>
    {
        ...
        public UpsertQuotesResponse(DateTimeOffset? AsAtDate = default(DateTimeOffset?), List<Link> Links = default(List<Link>))
        {
            // to ensure "AsAtDate" is required (not null)
            if (AsAtDate == null)
            {
                throw new InvalidDataException("AsAtDate is a required property for UpsertQuotesResponse and cannot be null");
            }
            else
            {
