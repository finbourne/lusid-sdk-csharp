...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfCutLabelDefinition :  IEquatable<PagedResourceListOfCutLabelDefinition>
    {
        ...
        public PagedResourceListOfCutLabelDefinition(List<CutLabelDefinition> values = default(List<CutLabelDefinition>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
