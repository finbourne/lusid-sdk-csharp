...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ContractForDifference : LusidInstrument, IEquatable<ContractForDifference>
    {
        /// <summary>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan (required) (default to &quot;ContractForDifference&quot;).</param>
        public ContractForDifference(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), string code = default(string), decimal contractSize = default(decimal), string payCcy = default(string), decimal referenceRate = default(decimal), string type = default(string), string underlyingCcy = default(string), string underlyingIdentifier = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.Code = code ?? throw new ArgumentNullException("code is a required property for ContractForDifference and cannot be null");
            this.ContractSize = contractSize;
            // to ensure "payCcy" is required (not null)
            this.PayCcy = payCcy ?? throw new ArgumentNullException("payCcy is a required property for ContractForDifference and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ContractForDifference and cannot be null");
            // to ensure "underlyingCcy" is required (not null)
            this.UnderlyingCcy = underlyingCcy ?? throw new ArgumentNullException("underlyingCcy is a required property for ContractForDifference and cannot be null");
            // to ensure "underlyingIdentifier" is required (not null)
            this.UnderlyingIdentifier = underlyingIdentifier ?? throw new ArgumentNullException("underlyingIdentifier is a required property for ContractForDifference and cannot be null");
