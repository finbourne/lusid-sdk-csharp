...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentsResponse : IEquatable<UpsertInstrumentsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertInstrumentsResponse" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="values">The instruments which have been successfully updated or inserted..</param>
        /// <param name="failed">The instruments that could not be updated or inserted along with a reason for their failure..</param>
        /// <param name="links">Collection of links..</param>
        public UpsertInstrumentsResponse(string href = default(string), Dictionary<string, Instrument> values = default(Dictionary<string, Instrument>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        /// </summary>
        /// <value>The instruments which have been successfully updated or inserted.</value>
        ...
        /// </summary>
        /// <value>The instruments that could not be updated or inserted along with a reason for their failure.</value>
