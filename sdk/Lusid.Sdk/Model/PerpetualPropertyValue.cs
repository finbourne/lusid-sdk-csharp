...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PerpetualPropertyValue :  IEquatable<PerpetualPropertyValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PerpetualPropertyValue" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PerpetualPropertyValue);
        }

        /// <summary>
        /// Returns true if PerpetualPropertyValue instances are equal
        /// </summary>
        /// <param name="input">Instance of PerpetualPropertyValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PerpetualPropertyValue input)
        {
            if (input == null)
                return false;
