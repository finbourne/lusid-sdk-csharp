...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LookupInstrumentsFromCodesResponse :  IEquatable<LookupInstrumentsFromCodesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LookupInstrumentsFromCodesResponse" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Values">Values.</param>
        /// <param name="Failed">Failed.</param>
        /// <param name="Links">Links.</param>
        public LookupInstrumentsFromCodesResponse(string Href = default(string), Dictionary<string, List<Instrument>> Values = default(Dictionary<string, List<Instrument>>), Dictionary<string, ErrorDetail> Failed = default(Dictionary<string, ErrorDetail>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Values = Values;
            this.Failed = Failed;
        ...
        public Dictionary<string, List<Instrument>> Values { get; set; }
        ...
        {
            return this.Equals(input as LookupInstrumentsFromCodesResponse);
        }

        /// <summary>
        /// Returns true if LookupInstrumentsFromCodesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LookupInstrumentsFromCodesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LookupInstrumentsFromCodesResponse input)
        {
            if (input == null)
                return false;
