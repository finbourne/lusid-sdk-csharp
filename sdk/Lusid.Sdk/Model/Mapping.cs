...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Mapping : IEquatable<Mapping>
    {
        ...
        public Mapping(string scope = default(string), string code = default(string), string name = default(string), string reconciliationType = default(string), List<MappingRule> rules = default(List<MappingRule>))
        {
            ...
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for Mapping and cannot be null");
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for Mapping and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Mapping and cannot be null");
            // to ensure "reconciliationType" is required (not null)
            this.ReconciliationType = reconciliationType ?? throw new ArgumentNullException("reconciliationType is a required property for Mapping and cannot be null");
            this.Rules = rules;
        }
