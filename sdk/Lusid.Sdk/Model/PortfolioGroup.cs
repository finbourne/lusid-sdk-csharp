...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioGroup :  IEquatable<PortfolioGroup>
    {
        ...
        public PortfolioGroup(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), List<ResourceId> portfolios = default(List<ResourceId>), List<ResourceId> subGroups = default(List<ResourceId>), Version version = default(Version), List<Link> links = default(List<Link>))
        {
