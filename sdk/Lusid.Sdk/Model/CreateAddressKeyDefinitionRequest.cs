...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreateAddressKeyDefinitionRequest : IEquatable<CreateAddressKeyDefinitionRequest>
    {
        /// <summary>
        ...
        public CreateAddressKeyDefinitionRequest(string addressKey = default(string), string type = default(string))
        {
            ...
            this.AddressKey = addressKey ?? throw new ArgumentNullException("addressKey is a required property for CreateAddressKeyDefinitionRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for CreateAddressKeyDefinitionRequest and cannot be null");
        }
