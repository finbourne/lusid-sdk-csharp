...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfPersonalisation :  IEquatable<ResourceListOfPersonalisation>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPersonalisation" /> class.
        /// </summary>
        ...
        public ResourceListOfPersonalisation(List<Personalisation> Values = default(List<Personalisation>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<Personalisation> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfPersonalisation);
        }

        /// <summary>
        /// Returns true if ResourceListOfPersonalisation instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPersonalisation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPersonalisation input)
        {
            if (input == null)
                return false;
