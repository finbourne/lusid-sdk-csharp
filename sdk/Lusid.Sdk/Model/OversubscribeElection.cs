...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OversubscribeElection")]
    public partial class OversubscribeElection : IEquatable<OversubscribeElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OversubscribeElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OversubscribeElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OversubscribeElection" /> class.
        /// </summary>
        ...
        public OversubscribeElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for OversubscribeElection and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OversubscribeElection {\n");
        ...
        {
            return this.Equals(input as OversubscribeElection);
        }

        /// <summary>
        /// Returns true if OversubscribeElection instances are equal
        /// </summary>
        /// <param name="input">Instance of OversubscribeElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OversubscribeElection input)
        {
            if (input == null)
            {
                return false;
