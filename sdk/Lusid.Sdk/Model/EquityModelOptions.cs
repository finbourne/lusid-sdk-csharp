...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityModelOptions : ModelOptions, IEquatable<EquityModelOptions>
    {
        /// <summary>
        ...
        public EquityModelOptions(string equityForwardProjectionType = default(string), ModelOptionsTypeEnum modelOptionsType = default(ModelOptionsTypeEnum)) : base(modelOptionsType)
        {
            ...
            this.EquityForwardProjectionType = equityForwardProjectionType ?? throw new ArgumentNullException("equityForwardProjectionType is a required property for EquityModelOptions and cannot be null");
        }
