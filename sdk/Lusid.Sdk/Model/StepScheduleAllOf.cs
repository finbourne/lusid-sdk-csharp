...
namespace Lusid.Sdk.Model
{
    ...
    public partial class StepScheduleAllOf : IEquatable<StepScheduleAllOf>
    {
        /// <summary>
        /// The available values are: Fixed, Float, Optionality, Step, Exercise, FxRate, Invalid
        /// </summary>
        /// <value>The available values are: Fixed, Float, Optionality, Step, Exercise, FxRate, Invalid</value>
        ...
        public enum ScheduleTypeEnum
        {
            ...
            /// <summary>
            /// Enum Optionality for value: Optionality
            /// </summary>
            [EnumMember(Value = "Optionality")]
            Optionality = 3,
            ...
            /// <summary>
            /// Enum FxRate for value: FxRate
            /// </summary>
            [EnumMember(Value = "FxRate")]
            FxRate = 6,
        ...
        /// <param name="scheduleType">The available values are: Fixed, Float, Optionality, Step, Exercise, FxRate, Invalid (required).</param>
        public StepScheduleAllOf(string levelType = default(string), string stepScheduleType = default(string), List<LevelStep> steps = default(List<LevelStep>), ScheduleTypeEnum scheduleType = default(ScheduleTypeEnum))
        {
            ...
            this.LevelType = levelType ?? throw new ArgumentNullException("levelType is a required property for StepScheduleAllOf and cannot be null");
            // to ensure "stepScheduleType" is required (not null)
            this.StepScheduleType = stepScheduleType ?? throw new ArgumentNullException("stepScheduleType is a required property for StepScheduleAllOf and cannot be null");
            // to ensure "steps" is required (not null)
            this.Steps = steps ?? throw new ArgumentNullException("steps is a required property for StepScheduleAllOf and cannot be null");
        ...
        [DataMember(Name = "levelType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "stepScheduleType", IsRequired = true, EmitDefaultValue = false)]
