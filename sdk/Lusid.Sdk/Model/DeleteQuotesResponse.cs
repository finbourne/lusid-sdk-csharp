...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DeleteQuotesResponse :  IEquatable<DeleteQuotesResponse>
    {
        ...
        /// Initializes a new instance of the <see cref="DeleteQuotesResponse" /> class.
        /// </summary>
        /// <param name="AsAtDate">AsAtDate (required).</param>
        /// <param name="Links">Links.</param>
        public DeleteQuotesResponse(DateTimeOffset? AsAtDate = default(DateTimeOffset?), List<Link> Links = default(List<Link>))
        {
            // to ensure "AsAtDate" is required (not null)
            if (AsAtDate == null)
            {
                throw new InvalidDataException("AsAtDate is a required property for DeleteQuotesResponse and cannot be null");
            }
            else
            {
