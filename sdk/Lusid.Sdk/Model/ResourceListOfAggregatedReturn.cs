...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAggregatedReturn : IEquatable<ResourceListOfAggregatedReturn>
    {
        /// <summary>
        ...
        public ResourceListOfAggregatedReturn(List<AggregatedReturn> values = default(List<AggregatedReturn>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfAggregatedReturn and cannot be null");
            this.Href = href;
            this.Links = links;
