...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentDefinition :  IEquatable<InstrumentDefinition>
    {
        ...
        public InstrumentDefinition(string Name = default(string), Dictionary<string, string> Identifiers = default(Dictionary<string, string>), List<InstrumentProperty> Properties = default(List<InstrumentProperty>), ResourceId LookThroughPortfolioId = default(ResourceId), InstrumentEconomicDefinition Definition = default(InstrumentEconomicDefinition))
        {
