...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExecutionRequest : IEquatable<ExecutionRequest>
    {
        ...
        /// <param name="instrumentIdentifiers">A set of instrument identifiers that can resolve the execution to a unique instrument. (required).</param>
        ...
        public ExecutionRequest(string executionId = default(string), string side = default(string), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), DateTimeOffset transactionTime = default(DateTimeOffset), decimal lastShares = default(decimal), decimal lastPx = default(decimal), string currency = default(string))
        {
            ...
            this.ExecutionId = executionId ?? throw new ArgumentNullException("executionId is a required property for ExecutionRequest and cannot be null");
            ...
            this.Currency = currency ?? throw new ArgumentNullException("currency is a required property for ExecutionRequest and cannot be null");
        }
        ...
        [DataMember(Name = "executionId", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>A set of instrument identifiers that can resolve the execution to a unique instrument.</value>
        ...
        [DataMember(Name = "transactionTime", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "lastShares", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "lastPx", IsRequired = true, EmitDefaultValue = true)]
