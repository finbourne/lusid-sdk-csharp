...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExecutionRequest :  IEquatable<ExecutionRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="ExecutionRequest" /> class.
        /// </summary>
        /// <param name="ExecutionId">FIX Field 17.  Unique execution identifier. (required).</param>
        /// <param name="Side">FIX Field 54. (required).</param>
        /// <param name="InstrumentUid">Unique instrument identifier. (required).</param>
        /// <param name="TransactionTime">FIX field 60.  Time the transaction represented by this ExecutionReport occurred. (required).</param>
        /// <param name="OrderQty">FIX field 38.  Order quantity. (required).</param>
        /// <param name="Price">FIX field 44. (required).</param>
        /// <param name="Currency">FIX field 15. (required).</param>
        public ExecutionRequest(string ExecutionId = default(string), string Side = default(string), string InstrumentUid = default(string), DateTimeOffset? TransactionTime = default(DateTimeOffset?), double? OrderQty = default(double?), double? Price = default(double?), string Currency = default(string))
        {
            ...
            {
                throw new InvalidDataException("InstrumentUid is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            if (OrderQty == null)
            {
                throw new InvalidDataException("OrderQty is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
            ...
            if (Price == null)
            {
                throw new InvalidDataException("Price is a required property for ExecutionRequest and cannot be null");
            }
            else
            {
                this.Price = Price;
        ...
        /// </summary>
        /// <value>FIX Field 17.  Unique execution identifier.</value>
        ...
        /// </summary>
        /// <value>FIX field 60.  Time the transaction represented by this ExecutionReport occurred.</value>
        ...
        /// </summary>
        /// <value>FIX field 38.  Order quantity.</value>
