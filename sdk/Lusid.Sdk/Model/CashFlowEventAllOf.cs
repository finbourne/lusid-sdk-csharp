...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CashFlowEventAllOf : IEquatable<CashFlowEventAllOf>
    {
        /// <summary>
        ...
        public CashFlowEventAllOf(CashFlowValue cashFlowValue = default(CashFlowValue), string eventStatus = default(string), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.CashFlowValue = cashFlowValue ?? throw new ArgumentNullException("cashFlowValue is a required property for CashFlowEventAllOf and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for CashFlowEventAllOf and cannot be null");
