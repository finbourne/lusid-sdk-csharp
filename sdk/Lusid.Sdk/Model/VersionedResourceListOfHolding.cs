...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VersionedResourceListOfHolding :  IEquatable<VersionedResourceListOfHolding>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionedResourceListOfHolding" /> class.
        /// </summary>
        ...
        public VersionedResourceListOfHolding(Version Version = default(Version), List<PortfolioHolding> Values = default(List<PortfolioHolding>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VersionedResourceListOfHolding {\n");
        ...
        {
            return this.Equals(input as VersionedResourceListOfHolding);
        }

        /// <summary>
        /// Returns true if VersionedResourceListOfHolding instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionedResourceListOfHolding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionedResourceListOfHolding input)
        {
            if (input == null)
                return false;
