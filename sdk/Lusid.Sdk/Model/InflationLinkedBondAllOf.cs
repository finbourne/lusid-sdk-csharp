...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InflationLinkedBondAllOf : IEquatable<InflationLinkedBondAllOf>
    {
        /// <summary>
        ...
        /// <param name="baseCPIDate">BaseCPIDate. This is optional, if not provided the BaseCPI value will taken from the BaseCPI property,  if that too is not present than the StartDate will be used.  If present, the BaseCPI is calculated for this date, note this is an un-lagged date (similar to StartDate)  so the Bond ObservationLag will be applied to this date when calculating the CPI.  Note that both BaseCPI and BaseCPIDate cannot be set.  Some bonds are issued with a BaseCPI date that does not correspond to the StartDate CPI value, in this  case the value should be provided here or with the actual BaseCPI..</param>
        /// <param name="calculationType">The calculation type applied to the bond coupon and principal amount.  The default CalculationType is &#x60;Standard&#x60; and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly, Ratio]..</param>
        ...
        public InflationLinkedBondAllOf(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset maturityDate = default(DateTimeOffset), FlowConventions flowConventions = default(FlowConventions), decimal couponRate = default(decimal), Dictionary<string, string> identifiers = default(Dictionary<string, string>), string domCcy = default(string), decimal? baseCPI = default(decimal?), DateTimeOffset? baseCPIDate = default(DateTimeOffset?), string calculationType = default(string), int? exDividendDays = default(int?), int indexPrecision = default(int), string inflationIndexName = default(string), string inflationInterpolation = default(string), int inflationRollDay = default(int), string observationLag = default(string), decimal principal = default(decimal), bool principalProtection = default(bool), string stubType = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            this.StartDate = startDate;
            this.MaturityDate = maturityDate;
            // to ensure "flowConventions" is required (not null)
            this.FlowConventions = flowConventions ?? throw new ArgumentNullException("flowConventions is a required property for InflationLinkedBondAllOf and cannot be null");
            this.CouponRate = couponRate;
            // to ensure "domCcy" is required (not null)
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for InflationLinkedBondAllOf and cannot be null");
            // to ensure "inflationIndexName" is required (not null)
            this.InflationIndexName = inflationIndexName ?? throw new ArgumentNullException("inflationIndexName is a required property for InflationLinkedBondAllOf and cannot be null");
        ...
        /// </summary>
        /// <value>BaseCPIDate. This is optional, if not provided the BaseCPI value will taken from the BaseCPI property,  if that too is not present than the StartDate will be used.  If present, the BaseCPI is calculated for this date, note this is an un-lagged date (similar to StartDate)  so the Bond ObservationLag will be applied to this date when calculating the CPI.  Note that both BaseCPI and BaseCPIDate cannot be set.  Some bonds are issued with a BaseCPI date that does not correspond to the StartDate CPI value, in this  case the value should be provided here or with the actual BaseCPI.</value>
        ...
        /// </summary>
        /// <value>The calculation type applied to the bond coupon and principal amount.  The default CalculationType is &#x60;Standard&#x60; and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly, Ratio].</value>
