...
namespace Lusid.Sdk.Model
{
    ...
    public partial class HoldingAdjustmentWithDate : IEquatable<HoldingAdjustmentWithDate>
    {
        /// <summary>
        ...
        public HoldingAdjustmentWithDate(DateTimeOffset effectiveAt = default(DateTimeOffset), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), string instrumentScope = default(string), string instrumentUid = default(string), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), List<TargetTaxLot> taxLots = default(List<TargetTaxLot>), string currency = default(string))
        {
            ...
            this.InstrumentUid = instrumentUid ?? throw new ArgumentNullException("instrumentUid is a required property for HoldingAdjustmentWithDate and cannot be null");
            // to ensure "taxLots" is required (not null)
            this.TaxLots = taxLots ?? throw new ArgumentNullException("taxLots is a required property for HoldingAdjustmentWithDate and cannot be null");
