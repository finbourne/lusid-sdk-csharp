...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreferredShare_allOf_identifiers")]
    public partial class PreferredShareAllOfIdentifiers : IEquatable<PreferredShareAllOfIdentifiers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreferredShareAllOfIdentifiers" /> class.
        /// </summary>
        ...
        public PreferredShareAllOfIdentifiers(string lusidInstrumentId = default(string), string isin = default(string), string sedol = default(string), string cusip = default(string), string clientInternal = default(string), string figi = default(string), string rIC = default(string), string quotePermId = default(string), string rEDCode = default(string), string bBGId = default(string), string iCECode = default(string))
        {
        ...
        {
            return this.Equals(input as PreferredShareAllOfIdentifiers);
        }

        /// <summary>
        /// Returns true if PreferredShareAllOfIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of PreferredShareAllOfIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferredShareAllOfIdentifiers input)
        {
            if (input == null)
            {
                return false;
