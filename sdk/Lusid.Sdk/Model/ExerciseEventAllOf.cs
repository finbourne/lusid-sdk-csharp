...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ExerciseEventAllOf : IEquatable<ExerciseEventAllOf>
    {
        /// <summary>
        ...
        public ExerciseEventAllOf(LusidInstrument instrument = default(LusidInstrument), string eventStatus = default(string), DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.Instrument = instrument ?? throw new ArgumentNullException("instrument is a required property for ExerciseEventAllOf and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for ExerciseEventAllOf and cannot be null");
