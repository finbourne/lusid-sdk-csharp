...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferenceInstrumentAllOf : IEquatable<ReferenceInstrumentAllOf>
    {
        /// <summary>
        ...
        public ReferenceInstrumentAllOf(string instrumentId = default(string), string instrumentIdType = default(string), string scope = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            ...
            this.InstrumentId = instrumentId ?? throw new ArgumentNullException("instrumentId is a required property for ReferenceInstrumentAllOf and cannot be null");
            // to ensure "instrumentIdType" is required (not null)
            this.InstrumentIdType = instrumentIdType ?? throw new ArgumentNullException("instrumentIdType is a required property for ReferenceInstrumentAllOf and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ReferenceInstrumentAllOf and cannot be null");
