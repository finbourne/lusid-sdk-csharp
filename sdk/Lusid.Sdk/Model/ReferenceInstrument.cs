...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferenceInstrument : LusidInstrument, IEquatable<ReferenceInstrument>
    {
        /// <summary>
        ...
        /// <param name="scope">(optional) Scope for the instrument (required).</param>
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond, InflationSwap, SimpleCashFlowLoan (required) (default to &quot;ReferenceInstrument&quot;).</param>
        public ReferenceInstrument(string instrumentId = default(string), string instrumentIdType = default(string), string scope = default(string), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base(instrumentType)
        {
            ...
            this.InstrumentId = instrumentId ?? throw new ArgumentNullException("instrumentId is a required property for ReferenceInstrument and cannot be null");
            // to ensure "instrumentIdType" is required (not null)
            this.InstrumentIdType = instrumentIdType ?? throw new ArgumentNullException("instrumentIdType is a required property for ReferenceInstrument and cannot be null");
            // to ensure "scope" is required (not null)
            this.Scope = scope ?? throw new ArgumentNullException("scope is a required property for ReferenceInstrument and cannot be null");
        }
        ...
        [DataMember(Name = "instrumentIdType", IsRequired = true, EmitDefaultValue = false)]
        public string InstrumentIdType { get; set; }

        /// <summary>
        /// (optional) Scope for the instrument
        /// </summary>
        /// <value>(optional) Scope for the instrument</value>
