...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuoteLineage :  IEquatable<QuoteLineage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteLineage" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuoteLineage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuoteLineage" /> class.
        /// </summary>
        /// <param name="DataVendor">DataVendor (required).</param>
        /// <param name="Contributor">Contributor (required).</param>
        public QuoteLineage(string DataVendor = default(string), string Contributor = default(string))
        {
            // to ensure "DataVendor" is required (not null)
            if (DataVendor == null)
            {
                throw new InvalidDataException("DataVendor is a required property for QuoteLineage and cannot be null");
            }
            else
            {
            ...
            if (Contributor == null)
            {
                throw new InvalidDataException("Contributor is a required property for QuoteLineage and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets DataVendor
        /// </summary>
        [DataMember(Name="dataVendor", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DataVendor: ").Append(DataVendor).Append("\n");
        ...
        {
            return this.Equals(input as QuoteLineage);
        }

        /// <summary>
        /// Returns true if QuoteLineage instances are equal
        /// </summary>
        /// <param name="input">Instance of QuoteLineage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuoteLineage input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DataVendor == input.DataVendor ||
                    (this.DataVendor != null &&
                    this.DataVendor.Equals(input.DataVendor))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.DataVendor != null)
                    hashCode = hashCode * 59 + this.DataVendor.GetHashCode();
