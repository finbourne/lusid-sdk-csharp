...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ConversionEvent : InstrumentEvent, IEquatable<ConversionEvent>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ConversionEvent" /> class.
        /// </summary>
        /// <param name="recordDate">Required.  Date at which positions are struck at the end of the day to  note which parties will receive the relevant amount of  entitlement, due to be distributed on the PaymentDate..</param>
        ...
        /// <param name="mixedLotConstituentsElections">List of possible mixed lot offers for this conversion event, if any. Each election converts the parent position  into one or more distinct new securities and/or cash legs, taking the place of the single event-level  NewInstrument that the other security-bearing elections resolve to.    A conversion may carry more than one of these, describing mutually exclusive multi-destination options.  Only supported when ConversionType is Regular..</param>
        ...
        /// </summary>
        /// <value>Required.  Date at which positions are struck at the end of the day to  note which parties will receive the relevant amount of  entitlement, due to be distributed on the PaymentDate.</value>
        ...
        /// </summary>
        /// <value>The cash price paid in lieu of fractionalUnits. Not required.  If provided, must have FractionalUnitsCashCurrency too.</value>
        ...
        /// </summary>
        /// <value>Optional. Used in calculating cash-in-lieu of fractional shares. Not required.  If provided, must have FractionalUnitsCashPrice too.</value>
        ...
        /// </summary>
        /// <value>List of possible mixed lot offers for this conversion event, if any. Each election converts the parent position  into one or more distinct new securities and/or cash legs, taking the place of the single event-level  NewInstrument that the other security-bearing elections resolve to.    A conversion may carry more than one of these, describing mutually exclusive multi-destination options.  Only supported when ConversionType is Regular.</value>
        ...
        /// </summary>
        /// <value>The type of conversion. Regular for standard conversions; Exchange144A for SEC Rule 144A exchanges.                Supported string (enumeration) values are: [Regular, Exchange144A]. Available values: Regular, Exchange144A.</value>
