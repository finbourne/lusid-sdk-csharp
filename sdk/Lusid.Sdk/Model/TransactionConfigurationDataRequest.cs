...
namespace Lusid.Sdk.Model
{
    ...
    public partial class TransactionConfigurationDataRequest :  IEquatable<TransactionConfigurationDataRequest>
    {
        ...
        public TransactionConfigurationDataRequest(List<TransactionConfigurationTypeAlias> Aliases = default(List<TransactionConfigurationTypeAlias>), List<TransactionConfigurationMovementDataRequest> Movements = default(List<TransactionConfigurationMovementDataRequest>), Dictionary<string, PropertyValue> Properties = default(Dictionary<string, PropertyValue>))
        {
