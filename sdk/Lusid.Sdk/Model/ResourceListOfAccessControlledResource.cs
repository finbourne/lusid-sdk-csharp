...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAccessControlledResource :  IEquatable<ResourceListOfAccessControlledResource>
    {
        ...
        public ResourceListOfAccessControlledResource(List<AccessControlledResource> values = default(List<AccessControlledResource>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
