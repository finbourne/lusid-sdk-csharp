...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfAccessControlledResource :  IEquatable<ResourceListOfAccessControlledResource>
    {
        ...
        public ResourceListOfAccessControlledResource(List<AccessControlledResource> values = default(List<AccessControlledResource>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
