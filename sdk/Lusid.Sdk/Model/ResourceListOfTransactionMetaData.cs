...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfTransactionMetaData :  IEquatable<ResourceListOfTransactionMetaData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfTransactionMetaData" /> class.
        /// </summary>
        ...
        public ResourceListOfTransactionMetaData(List<TransactionConfigurationData> Values = default(List<TransactionConfigurationData>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<TransactionConfigurationData> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfTransactionMetaData {\n");
        ...
        {
            return this.Equals(input as ResourceListOfTransactionMetaData);
        }

        /// <summary>
        /// Returns true if ResourceListOfTransactionMetaData instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfTransactionMetaData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfTransactionMetaData input)
        {
            if (input == null)
                return false;
