...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardTenorCurveDataAllOf : IEquatable<FxForwardTenorCurveDataAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public FxForwardTenorCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<string> tenors = default(List<string>), List<decimal> rates = default(List<decimal>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), List<FxTenorConvention> calendars = default(List<FxTenorConvention>), string spotDaysCalculationType = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            if (domCcy == null)
            {
                throw new ArgumentNullException("domCcy is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            }
            this.DomCcy = domCcy;
            // to ensure "fgnCcy" is required (not null)
            if (fgnCcy == null)
            {
                throw new ArgumentNullException("fgnCcy is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            }
            this.FgnCcy = fgnCcy;
            // to ensure "tenors" is required (not null)
            if (tenors == null)
            {
                throw new ArgumentNullException("tenors is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            }
            this.Tenors = tenors;
            // to ensure "rates" is required (not null)
            if (rates == null)
            {
                throw new ArgumentNullException("rates is a required property for FxForwardTenorCurveDataAllOf and cannot be null");
            }
            this.Rates = rates;
