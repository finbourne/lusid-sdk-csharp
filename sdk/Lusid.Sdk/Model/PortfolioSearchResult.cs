...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioSearchResult :  IEquatable<PortfolioSearchResult>
    {
        ...
        public PortfolioSearchResult(ResourceId Id = default(ResourceId), ResourceId ParentPortfolioId = default(ResourceId), List<Property> Properties = default(List<Property>), List<Link> Links = default(List<Link>))
        {
            this.Id = Id;
