...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioSearchResult :  IEquatable<PortfolioSearchResult>
    {
        ...
        public PortfolioSearchResult(ResourceId id = default(ResourceId), TypeEnum type = default(TypeEnum), string href = default(string), string description = default(string), string displayName = default(string), DateTimeOffset? created = default(DateTimeOffset?), ResourceId parentPortfolioId = default(ResourceId), string baseCurrency = default(string), List<Property> properties = default(List<Property>), List<Link> links = default(List<Link>))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PortfolioSearchResult and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (displayName == null)
            {
                throw new InvalidDataException("displayName is a required property for PortfolioSearchResult and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for PortfolioSearchResult and cannot be null");
            }
            else
            {
