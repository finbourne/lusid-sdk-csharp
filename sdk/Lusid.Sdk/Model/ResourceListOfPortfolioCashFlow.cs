...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfPortfolioCashFlow : IEquatable<ResourceListOfPortfolioCashFlow>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPortfolioCashFlow(List<PortfolioCashFlow> values = default(List<PortfolioCashFlow>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfPortfolioCashFlow and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
