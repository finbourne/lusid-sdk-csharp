...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertLegalEntitiesResponse")]
    public partial class UpsertLegalEntitiesResponse : IEquatable<UpsertLegalEntitiesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertLegalEntitiesResponse" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="values">The legal entities which have been successfully updated or created..</param>
        /// <param name="failed">The legal entities that could not be updated or created or were left unchanged without error along with a reason for their failure..</param>
        /// <param name="links">Collection of links..</param>
        public UpsertLegalEntitiesResponse(string href = default(string), Dictionary<string, LegalEntity> values = default(Dictionary<string, LegalEntity>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        /// </summary>
        /// <value>The legal entities which have been successfully updated or created.</value>
        [DataMember(Name = "values", EmitDefaultValue = true)]
        public Dictionary<string, LegalEntity> Values { get; set; }
        ...
        /// </summary>
        /// <value>The legal entities that could not be updated or created or were left unchanged without error along with a reason for their failure.</value>
        ...
        {
            return this.Equals(input as UpsertLegalEntitiesResponse);
        }

        /// <summary>
        /// Returns true if UpsertLegalEntitiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertLegalEntitiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertLegalEntitiesResponse input)
        {
            if (input == null)
                return false;
