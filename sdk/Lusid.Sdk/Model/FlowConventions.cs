...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FlowConventions : IEquatable<FlowConventions>
    {
        ...
        /// <param name="settleDays">DEPRECATED  Number of Good Business Days between the trade date and the effective or settlement date of the instrument.  This field is now deprecated and not picked up in schedule generation or adjustment to bond accrual start date. Default to 0. (required).</param>
        ...
        /// </summary>
        /// <value>DEPRECATED  Number of Good Business Days between the trade date and the effective or settlement date of the instrument.  This field is now deprecated and not picked up in schedule generation or adjustment to bond accrual start date. Default to 0.</value>
