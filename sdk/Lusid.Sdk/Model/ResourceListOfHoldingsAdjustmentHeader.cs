...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfHoldingsAdjustmentHeader :  IEquatable<ResourceListOfHoldingsAdjustmentHeader>
    {
        ...
        public ResourceListOfHoldingsAdjustmentHeader(List<HoldingsAdjustmentHeader> values = default(List<HoldingsAdjustmentHeader>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
