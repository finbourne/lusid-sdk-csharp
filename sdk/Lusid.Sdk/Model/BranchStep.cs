...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BranchStep : IEquatable<BranchStep>, IValidatableObject
    {
        /// <summary>
        ...
        public BranchStep(string label = default(string), Dictionary<string, List<ComplianceTemplateParameter>> groupedParameters = default(Dictionary<string, List<ComplianceTemplateParameter>>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum))
        {
            ...
            {
                throw new ArgumentNullException("groupedParameters is a required property for BranchStep and cannot be null");
            }
