...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BlockRequest : IEquatable<BlockRequest>
    {
        ...
        public BlockRequest(ResourceId id = default(ResourceId), List<ResourceId> orderIds = default(List<ResourceId>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), Dictionary<string, string> instrumentIdentifiers = default(Dictionary<string, string>), decimal quantity = default(decimal), string side = default(string), string type = default(string), string timeInForce = default(string), DateTimeOffset createdDate = default(DateTimeOffset), CurrencyAndAmount limitPrice = default(CurrencyAndAmount), CurrencyAndAmount stopPrice = default(CurrencyAndAmount))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for BlockRequest and cannot be null");
            // to ensure "orderIds" is required (not null)
            this.OrderIds = orderIds ?? throw new ArgumentNullException("orderIds is a required property for BlockRequest and cannot be null");
            // to ensure "instrumentIdentifiers" is required (not null)
            this.InstrumentIdentifiers = instrumentIdentifiers ?? throw new ArgumentNullException("instrumentIdentifiers is a required property for BlockRequest and cannot be null");
            this.Quantity = quantity;
            // to ensure "side" is required (not null)
            this.Side = side ?? throw new ArgumentNullException("side is a required property for BlockRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for BlockRequest and cannot be null");
            // to ensure "timeInForce" is required (not null)
            this.TimeInForce = timeInForce ?? throw new ArgumentNullException("timeInForce is a required property for BlockRequest and cannot be null");
