...
namespace Lusid.Sdk.Model
{
    ...
    public partial class CreatePortfolioGroupRequest :  IEquatable<CreatePortfolioGroupRequest>
    {
        ...
        public CreatePortfolioGroupRequest(string code = default(string), DateTimeOffset? created = default(DateTimeOffset?), List<ResourceId> values = default(List<ResourceId>), List<ResourceId> subGroups = default(List<ResourceId>), string displayName = default(string), string description = default(string))
        {
