...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AccessControlledAction :  IEquatable<AccessControlledAction>
    {
        ...
        /// Initializes a new instance of the <see cref="AccessControlledAction" /> class.
        /// </summary>
        /// <param name="Action">The fully qualified ActionId that can be access controlled (required).</param>
        ...
        public AccessControlledAction(ActionId Action = default(ActionId), List<IdPathDefinition> LimitedSet = default(List<IdPathDefinition>), List<Link> Links = default(List<Link>))
        {
        ...
        /// </summary>
        /// <value>The fully qualified ActionId that can be access controlled</value>
        ...
        public List<IdPathDefinition> LimitedSet { get; set; }
