...
namespace Lusid.Sdk.Model
{
    ...
    public partial class DiscountFactorCurveDataAllOf : IEquatable<DiscountFactorCurveDataAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public DiscountFactorCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> discountFactors = default(List<decimal>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            if (dates == null)
            {
                throw new ArgumentNullException("dates is a required property for DiscountFactorCurveDataAllOf and cannot be null");
            }
            this.Dates = dates;
            // to ensure "discountFactors" is required (not null)
            if (discountFactors == null)
            {
                throw new ArgumentNullException("discountFactors is a required property for DiscountFactorCurveDataAllOf and cannot be null");
            }
