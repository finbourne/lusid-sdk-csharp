...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregationRequest :  IEquatable<AggregationRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="AggregationRequest" /> class.
        /// </summary>
        /// <param name="RecipeId">The configuration recipe, consisting of recipe scope and recipe name, to use in performing the aggregation..</param>
        /// <param name="InlineRecipe">Target Method for providing a non-named recipe.  If given, this replaces the &#39;RecipeId&#39; used with the bespoke recipe. This is intended to allow use of non-named  recipes to iterate quickly for design purposes. Ultimately it is recommended that production recipes would be stored  in Lusid.    USE OF ANY (INLINE) RECIPE IS AT PRESENT LIABLE TO CHANGE..</param>
        ...
        /// </summary>
        /// <value>The configuration recipe, consisting of recipe scope and recipe name, to use in performing the aggregation.</value>
        ...
        /// </summary>
        /// <value>Target Method for providing a non-named recipe.  If given, this replaces the &#39;RecipeId&#39; used with the bespoke recipe. This is intended to allow use of non-named  recipes to iterate quickly for design purposes. Ultimately it is recommended that production recipes would be stored  in Lusid.    USE OF ANY (INLINE) RECIPE IS AT PRESENT LIABLE TO CHANGE.</value>
