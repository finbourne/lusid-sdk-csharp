...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregationRequest :  IEquatable<AggregationRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="AggregationRequest" /> class.
        /// </summary>
        /// <param name="RecipeId">The configuration recipe, consisting of user scope and recipe name, to use in performing the aggregation. (required).</param>
        ...
        public AggregationRequest(ResourceId RecipeId = default(ResourceId), DateTimeOffset? AsAt = default(DateTimeOffset?), DateTimeOffset? EffectiveAt = default(DateTimeOffset?), List<AggregateSpec> Metrics = default(List<AggregateSpec>), List<string> GroupBy = default(List<string>), List<PropertyFilter> Filters = default(List<PropertyFilter>), int? Limit = default(int?), string Sort = default(string))
        {
        ...
        /// </summary>
        /// <value>The configuration recipe, consisting of user scope and recipe name, to use in performing the aggregation.</value>
