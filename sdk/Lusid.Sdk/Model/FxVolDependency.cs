...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxVolDependency : EconomicDependency, IEquatable<FxVolDependency>
    {
        /// <summary>
        ...
        public FxVolDependency(string domesticCurrency = default(string), string foreignCurrency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base(dependencyType)
        {
            ...
            this.DomesticCurrency = domesticCurrency ?? throw new ArgumentNullException("domesticCurrency is a required property for FxVolDependency and cannot be null");
            // to ensure "foreignCurrency" is required (not null)
            this.ForeignCurrency = foreignCurrency ?? throw new ArgumentNullException("foreignCurrency is a required property for FxVolDependency and cannot be null");
            // to ensure "volType" is required (not null)
            this.VolType = volType ?? throw new ArgumentNullException("volType is a required property for FxVolDependency and cannot be null");
            this.Date = date;
        }
