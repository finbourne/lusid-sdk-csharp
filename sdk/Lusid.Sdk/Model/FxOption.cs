...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxOption : LusidInstrument, IEquatable<FxOption>
    {
        ...
        /// <param name="exerciseType">Type of optionality that is present; European, Bermudan, American.    Supported string (enumeration) values are: [European, Bermudan, American]..</param>
        /// <param name="isCallNotPut">True if the option is a call, false if the option is a put. (required).</param>
        /// <param name="isDeliveryNotCash">True if the option is settled in cash, false if delivery. (required).</param>
        ...
        /// <param name="payoutStyle">PayoutStyle for touch options.  For options without touch optionality (IsTouch&#x3D;&#x3D;false),  PayoutStyle should not be set (ot it can be set to None)  For options with touch optionality (IsTouch&#x3D;&#x3D;true),  PayoutStyle cannot be None.    Supported string (enumeration) values are: [Deferred, Immediate]..</param>
        ...
        /// <param name="instrumentType">The available values are: QuotedSecurity, InterestRateSwap, FxForward, Future, ExoticInstrument, FxOption, CreditDefaultSwap, InterestRateSwaption, Bond, EquityOption, FixedLeg, FloatingLeg, BespokeCashFlowsLeg, Unknown, TermDeposit, ContractForDifference, EquitySwap, CashPerpetual, CapFloor, CashSettled, CdsIndex, Basket, FundingLeg, FxSwap, ForwardRateAgreement, SimpleInstrument, Repo, Equity, ExchangeTradedOption, ReferenceInstrument, ComplexBond, InflationLinkedBond (required) (default to &quot;FxOption&quot;).</param>
        ...
        /// </summary>
        /// <value>Type of optionality that is present; European, Bermudan, American.    Supported string (enumeration) values are: [European, Bermudan, American].</value>
        ...
        /// </summary>
        /// <value>True if the option is settled in cash, false if delivery.</value>
        ...
        /// </summary>
        /// <value>PayoutStyle for touch options.  For options without touch optionality (IsTouch&#x3D;&#x3D;false),  PayoutStyle should not be set (ot it can be set to None)  For options with touch optionality (IsTouch&#x3D;&#x3D;true),  PayoutStyle cannot be None.    Supported string (enumeration) values are: [Deferred, Immediate].</value>
