...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentifierDefinition")]
    public partial class IdentifierDefinition : IEquatable<IdentifierDefinition>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of entity to which the identifier can be attached. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, FundStructure, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, TaskDefinition, Workflow, IdentifierDefinition, SettlementInstruction, TransactionFeeType, PaymentInstruction, Transfer, RecDefinition, RecResult.</value>
        ...
        /// </summary>
        /// <value>Describes whether an identifier value is associated with an entity for all effective dates or applies within a specified effective date range. Available values: Perpetual, TimeVariant.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        protected IdentifierDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentifierDefinition" /> class.
        /// </summary>
        /// <param name="href">The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime..</param>
        /// <param name="domain">The type of entity to which the identifier can be attached. Available values: Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, PortfolioGroup, Person, Order, Allocation, Calendar, LegalEntity, InvestorRecord, InvestmentAccount, Placement, Execution, Block, Participation, Package, OrderInstruction, CustomEntity, InstrumentEvent, Account, ChartOfAccounts, CustodianAccount, CheckDefinition, Abor, AborConfiguration, Fund, FundConfiguration, FundStructure, Fee, Reconciliation, PropertyDefinition, Compliance, DiaryEntry, Leg, DerivedValuation, Timeline, ClosedPeriod, TaskDefinition, Workflow, IdentifierDefinition, SettlementInstruction, TransactionFeeType, PaymentInstruction, Transfer, RecDefinition, RecResult. (required).</param>
        ...
        public IdentifierDefinition(string href = default(string), DomainEnum domain = default(DomainEnum), string identifierScope = default(string), string identifierType = default(string), LifeTimeEnum lifeTime = default(LifeTimeEnum), string hierarchyUsage = default(string), string hierarchyLevel = default(string), string displayName = default(string), string description = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), ModelVersion varVersion = default(ModelVersion))
        {
            ...
            {
                throw new ArgumentNullException("identifierScope is a required property for IdentifierDefinition and cannot be null");
            }
        ...
        {
            return this.Equals(input as IdentifierDefinition);
        }

        /// <summary>
        /// Returns true if IdentifierDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentifierDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentifierDefinition input)
        {
            if (input == null)
            {
                return false;
