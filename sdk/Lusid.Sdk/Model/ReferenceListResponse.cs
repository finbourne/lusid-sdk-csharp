...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ReferenceListResponse : IEquatable<ReferenceListResponse>
    {
        /// <summary>
        ...
        public ReferenceListResponse(ResourceId id = default(ResourceId), string name = default(string), string description = default(string), List<string> tags = default(List<string>), ReferenceList referenceList = default(ReferenceList), Version version = default(Version), List<Link> links = default(List<Link>))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for ReferenceListResponse and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ReferenceListResponse and cannot be null");
            // to ensure "referenceList" is required (not null)
            this.ReferenceList = referenceList ?? throw new ArgumentNullException("referenceList is a required property for ReferenceListResponse and cannot be null");
            // to ensure "version" is required (not null)
            this.Version = version ?? throw new ArgumentNullException("version is a required property for ReferenceListResponse and cannot be null");
