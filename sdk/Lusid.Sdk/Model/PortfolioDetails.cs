...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PortfolioDetails :  IEquatable<PortfolioDetails>
    {
        ...
        public PortfolioDetails(string Href = default(string), ResourceId OriginPortfolioId = default(ResourceId), Version Version = default(Version), string BaseCurrency = default(string), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
