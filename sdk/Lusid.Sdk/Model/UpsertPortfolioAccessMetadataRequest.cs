...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertPortfolioAccessMetadataRequest : IEquatable<UpsertPortfolioAccessMetadataRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpsertPortfolioAccessMetadataRequest(List<AccessMetadataValue> metadata = default(List<AccessMetadataValue>))
        {
            ...
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for UpsertPortfolioAccessMetadataRequest and cannot be null");
            }
