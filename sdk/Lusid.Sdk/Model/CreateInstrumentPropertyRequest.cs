...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateInstrumentPropertyRequest :  IEquatable<CreateInstrumentPropertyRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateInstrumentPropertyRequest" /> class.
        /// </summary>
        /// <param name="InstrumentPropertyKey">The property key of the property, e.g, &#39;Instrument/default/Isin&#39;.</param>
        /// <param name="Property">The value of the property, which must not be empty or null. e.g, &#39;US0378331005&#39;.</param>
        ...
        [DataMember(Name="instrumentPropertyKey", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateInstrumentPropertyRequest {\n");
            sb.Append("  InstrumentPropertyKey: ").Append(InstrumentPropertyKey).Append("\n");
        ...
        {
            return this.Equals(input as CreateInstrumentPropertyRequest);
        }

        /// <summary>
        /// Returns true if CreateInstrumentPropertyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateInstrumentPropertyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateInstrumentPropertyRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.InstrumentPropertyKey == input.InstrumentPropertyKey ||
                    (this.InstrumentPropertyKey != null &&
                    this.InstrumentPropertyKey.Equals(input.InstrumentPropertyKey))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.InstrumentPropertyKey != null)
                    hashCode = hashCode * 59 + this.InstrumentPropertyKey.GetHashCode();
