...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EarlyRedemptionElection")]
    public partial class EarlyRedemptionElection : IEquatable<EarlyRedemptionElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EarlyRedemptionElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EarlyRedemptionElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EarlyRedemptionElection" /> class.
        /// </summary>
        ...
        public EarlyRedemptionElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for EarlyRedemptionElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as EarlyRedemptionElection);
        }

        /// <summary>
        /// Returns true if EarlyRedemptionElection instances are equal
        /// </summary>
        /// <param name="input">Instance of EarlyRedemptionElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EarlyRedemptionElection input)
        {
            if (input == null)
            {
                return false;
