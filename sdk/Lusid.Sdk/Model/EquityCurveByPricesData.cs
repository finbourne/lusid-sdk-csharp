...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityCurveByPricesData : ComplexMarketData, IEquatable<EquityCurveByPricesData>
    {
        /// <summary>
        ...
        /// <param name="marketDataType">The available values are: DiscountFactorCurveData, EquityVolSurfaceData, FxVolSurfaceData, IrVolCubeData, OpaqueMarketData, YieldCurveData, FxForwardCurveData, FxForwardPipsCurveData, FxForwardTenorCurveData, FxForwardTenorPipsCurveData, FxForwardCurveByQuoteReference, CreditSpreadCurveData, EquityCurveByPricesData (required) (default to &quot;EquityCurveByPricesData&quot;).</param>
        public EquityCurveByPricesData(DateTimeOffset baseDate = default(DateTimeOffset), List<DateTimeOffset> dates = default(List<DateTimeOffset>), string lineage = default(string), List<decimal> prices = default(List<decimal>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base(marketDataType)
        {
            this.BaseDate = baseDate;
            // to ensure "dates" is required (not null)
            this.Dates = dates ?? throw new ArgumentNullException("dates is a required property for EquityCurveByPricesData and cannot be null");
            // to ensure "prices" is required (not null)
            this.Prices = prices ?? throw new ArgumentNullException("prices is a required property for EquityCurveByPricesData and cannot be null");
