...
namespace Lusid.Sdk.Model
{
    ...
    public partial class EquityVolDependencyAllOf : IEquatable<EquityVolDependencyAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public EquityVolDependencyAllOf(string code = default(string), string domesticCurrency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum))
        {
            ...
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for EquityVolDependencyAllOf and cannot be null");
            }
            this.Code = code;
            // to ensure "domesticCurrency" is required (not null)
            if (domesticCurrency == null)
            {
                throw new ArgumentNullException("domesticCurrency is a required property for EquityVolDependencyAllOf and cannot be null");
            }
            this.DomesticCurrency = domesticCurrency;
            // to ensure "volType" is required (not null)
            if (volType == null)
            {
                throw new ArgumentNullException("volType is a required property for EquityVolDependencyAllOf and cannot be null");
            }
