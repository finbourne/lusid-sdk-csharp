...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertQuoteRequest :  IEquatable<UpsertQuoteRequest>
    {
        ...
        public UpsertQuoteRequest(QuoteId QuoteId = default(QuoteId), MetricValue MetricValue = default(MetricValue), QuoteLineage QuoteLineage = default(QuoteLineage), DateTimeOffset? EffectiveAt = default(DateTimeOffset?))
        {
            ...
            {
                throw new InvalidDataException("QuoteLineage is a required property for UpsertQuoteRequest and cannot be null");
            }
            else
            {
