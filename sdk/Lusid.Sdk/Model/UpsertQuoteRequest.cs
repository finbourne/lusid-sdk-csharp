...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertQuoteRequest :  IEquatable<UpsertQuoteRequest>
    {
        ...
        public UpsertQuoteRequest(string Id = default(string), MetricValue MetricValue = default(MetricValue))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for UpsertQuoteRequest and cannot be null");
            }
            else
            {
                this.Id = Id;
