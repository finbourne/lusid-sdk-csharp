...
namespace Lusid.Sdk.Model
{
    ...
    /// CdxCreditEventAllOf
    /// </summary>
    [DataContract(Name = "CdxCreditEvent_allOf")]
    public partial class CdxCreditEventAllOf : IEquatable<CdxCreditEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CdxCreditEventAllOf);
        }

        /// <summary>
        /// Returns true if CdxCreditEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CdxCreditEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CdxCreditEventAllOf input)
        {
            if (input == null)
            {
                return false;
