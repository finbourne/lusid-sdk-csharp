...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpdateCheckDefinitionRequest : IEquatable<UpdateCheckDefinitionRequest>, IValidatableObject
    {
        ...
        public UpdateCheckDefinitionRequest(string displayName = default(string), string description = default(string), CheckDefinitionDatasetSchema datasetSchema = default(CheckDefinitionDatasetSchema), List<CheckDefinitionRuleSet> ruleSets = default(List<CheckDefinitionRuleSet>), Dictionary<string, Property> properties = default(Dictionary<string, Property>))
        {
