...
namespace Lusid.Sdk.Model
{
    ...
    public partial class InstrumentProperty :  IEquatable<InstrumentProperty>
    {
        ...
        /// <param name="DeletedProperties">DeletedProperties.</param>
        public InstrumentProperty(string LusidInstrumentId = default(string), List<CreateInstrumentPropertyRequest> Properties = default(List<CreateInstrumentPropertyRequest>), List<DeleteInstrumentPropertyRequest> DeletedProperties = default(List<DeleteInstrumentPropertyRequest>))
        {
        ...
        /// <summary>
        /// Gets or Sets DeletedProperties
        /// </summary>
