...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfCodeType :  IEquatable<ResourceListOfCodeType>
    {
        /// <summary>
        /// Defines Values
        /// </summary>
        ...
        public enum ValuesEnum
        {
            ...
            /// <summary>
            /// Enum ReutersAssetId for value: ReutersAssetId
            /// </summary>
            [EnumMember(Value = "ReutersAssetId")]
            ReutersAssetId = 3,
            
            /// <summary>
            /// Enum CINS for value: CINS
            /// </summary>
            [EnumMember(Value = "CINS")]
            CINS = 4,
            ...
            /// <summary>
            /// Enum CompositeFigi for value: CompositeFigi
            /// </summary>
            [EnumMember(Value = "CompositeFigi")]
            CompositeFigi = 11,
            
            /// <summary>
            /// Enum ShareClassFigi for value: ShareClassFigi
            /// </summary>
            [EnumMember(Value = "ShareClassFigi")]
            ShareClassFigi = 12,
            
            /// <summary>
            /// Enum Wertpapier for value: Wertpapier
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfCodeType" /> class.
        /// </summary>
        ...
        public ResourceListOfCodeType(List<ValuesEnum> Values = default(List<ValuesEnum>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfCodeType {\n");
        ...
        {
            return this.Equals(input as ResourceListOfCodeType);
        }

        /// <summary>
        /// Returns true if ResourceListOfCodeType instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfCodeType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfCodeType input)
        {
            if (input == null)
                return false;
