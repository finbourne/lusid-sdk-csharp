...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfBlock : IEquatable<ResourceListOfBlock>
    {
        /// <summary>
        ...
        public ResourceListOfBlock(List<Block> values = default(List<Block>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for ResourceListOfBlock and cannot be null");
            this.Href = href;
            this.Links = links;
