...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentPropertyRequest :  IEquatable<UpsertInstrumentPropertyRequest>
    {
        ...
        /// </summary>
        /// <param name="lusidInstrumentId">Unique instrument identifier.</param>
        /// <param name="properties">A collection of properties to create or update.</param>
        /// <param name="deletedProperties">A collection of property keys to remove property values from, if any are set for the instrument.</param>
        ...
        /// </summary>
        /// <value>A collection of properties to create or update</value>
        ...
        /// </summary>
        /// <value>A collection of property keys to remove property values from, if any are set for the instrument</value>
