...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertInstrumentPropertyRequest :  IEquatable<UpsertInstrumentPropertyRequest>
    {
        ...
        /// Initializes a new instance of the <see cref="UpsertInstrumentPropertyRequest" /> class.
        /// </summary>
        /// <param name="lusidInstrumentId">The unique Lusid Instrument Identifier (LUID) of the instrument to update or insert properties on. (required).</param>
        ...
        /// <param name="deletedProperties">Set of unique instrument properties to delete from the instrument..</param>
        public UpsertInstrumentPropertyRequest(string lusidInstrumentId = default(string), List<InstrumentProperty> properties = default(List<InstrumentProperty>), List<DeleteInstrumentPropertyRequest> deletedProperties = default(List<DeleteInstrumentPropertyRequest>))
        {
            // to ensure "lusidInstrumentId" is required (not null)
            if (lusidInstrumentId == null)
            {
                throw new InvalidDataException("lusidInstrumentId is a required property for UpsertInstrumentPropertyRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The unique Lusid Instrument Identifier (LUID) of the instrument to update or insert properties on.</value>
        ...
        /// </summary>
        /// <value>Set of unique instrument properties to delete from the instrument.</value>
        [DataMember(Name="deletedProperties", EmitDefaultValue=false)]
        public List<DeleteInstrumentPropertyRequest> DeletedProperties { get; set; }
