...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AmortisationEventAllOf : IEquatable<AmortisationEventAllOf>
    {
        /// <summary>
        ...
        public AmortisationEventAllOf(decimal amountReduced = default(decimal), string domCcy = default(string), string payReceive = default(string), string eventStatus = default(string), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for AmortisationEventAllOf and cannot be null");
            // to ensure "payReceive" is required (not null)
            this.PayReceive = payReceive ?? throw new ArgumentNullException("payReceive is a required property for AmortisationEventAllOf and cannot be null");
            // to ensure "eventStatus" is required (not null)
            this.EventStatus = eventStatus ?? throw new ArgumentNullException("eventStatus is a required property for AmortisationEventAllOf and cannot be null");
