...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExchangeTradedOption_allOf")]
    public partial class ExchangeTradedOptionAllOf : IEquatable<ExchangeTradedOptionAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeTradedOptionAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExchangeTradedOptionAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeTradedOptionAllOf" /> class.
        /// </summary>
        ...
        public ExchangeTradedOptionAllOf(DateTimeOffset startDate = default(DateTimeOffset), ExchangeTradedOptionContractDetails contractDetails = default(ExchangeTradedOptionContractDetails), decimal contracts = default(decimal), decimal refSpotPrice = default(decimal), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum))
        {
            this.StartDate = startDate;
            // to ensure "contractDetails" is required (not null)
            this.ContractDetails = contractDetails ?? throw new ArgumentNullException("contractDetails is a required property for ExchangeTradedOptionAllOf and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangeTradedOptionAllOf {\n");
        ...
        {
            return this.Equals(input as ExchangeTradedOptionAllOf);
        }

        /// <summary>
        /// Returns true if ExchangeTradedOptionAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ExchangeTradedOptionAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExchangeTradedOptionAllOf input)
        {
            if (input == null)
                return false;
