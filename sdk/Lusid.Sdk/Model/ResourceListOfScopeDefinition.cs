...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfScopeDefinition :  IEquatable<ResourceListOfScopeDefinition>
    {
        ...
        public ResourceListOfScopeDefinition(List<ScopeDefinition> values = default(List<ScopeDefinition>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
