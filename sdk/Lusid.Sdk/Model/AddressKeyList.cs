...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AddressKeyList : ReferenceList, IEquatable<AddressKeyList>
    {
        /// <summary>
        ...
        /// <param name="referenceListType">The reference list values. The available values are: PortfolioGroupIdList, PortfolioIdList, AddressKeyList, StringList, InstrumentList, DecimalList (required) (default to &quot;AddressKeyList&quot;).</param>
        public AddressKeyList(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base(referenceListType)
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for AddressKeyList and cannot be null");
        }
