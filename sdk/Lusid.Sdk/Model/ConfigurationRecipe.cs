...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ConfigurationRecipe :  IEquatable<ConfigurationRecipe>
    {
        ...
        /// <param name="Market">The market configuration that defines where market data used in processing a request is loaded from and how it is resolved..</param>
        /// <param name="Pricing">The pricing configuration that defines which pricing library is used to price a given instrument and what models and preferences are used with those..</param>
        /// <param name="Aggregation">The aggregation configuration that defines how results are amalgamated and what logic to follow when applying sql-like rules..</param>
        ...
        /// </summary>
        /// <value>The market configuration that defines where market data used in processing a request is loaded from and how it is resolved.</value>
        ...
        /// </summary>
        /// <value>The pricing configuration that defines which pricing library is used to price a given instrument and what models and preferences are used with those.</value>
        ...
        /// </summary>
        /// <value>The aggregation configuration that defines how results are amalgamated and what logic to follow when applying sql-like rules.</value>
