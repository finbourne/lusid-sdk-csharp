...
namespace Lusid.Sdk.Model
{
    ...
    public partial class FxForwardCurveDataAllOf : IEquatable<FxForwardCurveDataAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        public FxForwardCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> rates = default(List<decimal>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            if (domCcy == null)
            {
                throw new ArgumentNullException("domCcy is a required property for FxForwardCurveDataAllOf and cannot be null");
            }
            this.DomCcy = domCcy;
            // to ensure "fgnCcy" is required (not null)
            if (fgnCcy == null)
            {
                throw new ArgumentNullException("fgnCcy is a required property for FxForwardCurveDataAllOf and cannot be null");
            }
            this.FgnCcy = fgnCcy;
            // to ensure "dates" is required (not null)
            if (dates == null)
            {
                throw new ArgumentNullException("dates is a required property for FxForwardCurveDataAllOf and cannot be null");
            }
            this.Dates = dates;
            // to ensure "rates" is required (not null)
            if (rates == null)
            {
                throw new ArgumentNullException("rates is a required property for FxForwardCurveDataAllOf and cannot be null");
            }
            this.Rates = rates;
