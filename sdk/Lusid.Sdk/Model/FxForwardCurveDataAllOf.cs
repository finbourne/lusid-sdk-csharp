...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FxForwardCurveData_allOf")]
    public partial class FxForwardCurveDataAllOf : IEquatable<FxForwardCurveDataAllOf>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardCurveDataAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FxForwardCurveDataAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardCurveDataAllOf" /> class.
        /// </summary>
        ...
        public FxForwardCurveDataAllOf(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> rates = default(List<decimal>), string lineage = default(string), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum))
        {
            ...
            this.DomCcy = domCcy ?? throw new ArgumentNullException("domCcy is a required property for FxForwardCurveDataAllOf and cannot be null");
            // to ensure "fgnCcy" is required (not null)
            this.FgnCcy = fgnCcy ?? throw new ArgumentNullException("fgnCcy is a required property for FxForwardCurveDataAllOf and cannot be null");
            // to ensure "dates" is required (not null)
            this.Dates = dates ?? throw new ArgumentNullException("dates is a required property for FxForwardCurveDataAllOf and cannot be null");
        ...
        {
            return this.Equals(input as FxForwardCurveDataAllOf);
        }

        /// <summary>
        /// Returns true if FxForwardCurveDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of FxForwardCurveDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FxForwardCurveDataAllOf input)
        {
            if (input == null)
                return false;
