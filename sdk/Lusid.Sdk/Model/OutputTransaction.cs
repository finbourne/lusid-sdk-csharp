...
namespace Lusid.Sdk.Model
{
    ...
    {
        /// <summary>
        /// Where this transaction came from, either Client or System
        /// </summary>
        /// <value>Where this transaction came from, either Client or System</value>
        ...
        /// <summary>
        /// Transaction status (active, amended or cancelled)
        /// </summary>
        /// <value>Transaction status (active, amended or cancelled)</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <param name="TransactionPrice">Execution price for the transaction.</param>
        /// <param name="TotalConsideration">Total value of the transaction in settlement currency.</param>
        /// <param name="Properties">Properties.</param>
        /// <param name="RealisedGainLoss">Collection of gains or losses.</param>
        public OutputTransaction(Dictionary<string, string> InstrumentIdentifiers = default(Dictionary<string, string>), TransactionPrice TransactionPrice = default(TransactionPrice), CurrencyAndAmount TotalConsideration = default(CurrencyAndAmount), List<PerpetualProperty> Properties = default(List<PerpetualProperty>), List<RealisedGainLoss> RealisedGainLoss = default(List<RealisedGainLoss>))
        {
        ...
        /// </summary>
        /// <value>LUSID transaction type code - Buy, Sell, StockIn, StockOut, etc</value>
        ...
        /// </summary>
        /// <value>LUSID transaction description</value>
        ...
        /// </summary>
        /// <value>Quantity of trade in units of the instrument</value>
        ...
        /// </summary>
        /// <value>Execution price for the transaction</value>
        ...
        /// </summary>
        /// <value>Total value of the transaction in settlement currency</value>
        ...
        /// </summary>
        /// <value>Rate between transaction and settlement currency</value>
        ...
        /// </summary>
        /// <value>Rate between transaction and portfolio currency</value>
        ...
        /// </summary>
        /// <value>Counterparty identifier</value>
        [DataMember(Name="counterpartyId", EmitDefaultValue=false)]
        public string CounterpartyId { get; private set; }


        /// <summary>
        /// Gets or Sets NettingSet
        /// </summary>
        [DataMember(Name="nettingSet", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Date/Time the transaction was booked into LUSID</value>
        ...
        /// </summary>
        /// <value>Date/Time the cancellation was booked into LUSID</value>
        ...
        /// </summary>
        /// <value>Collection of gains or losses</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NettingSet: ").Append(NettingSet).Append("\n");
        ...
        public bool Equals(OutputTransaction input)
        {
            ...
            return 
                ...
                (
                    this.NettingSet == input.NettingSet ||
                    (this.NettingSet != null &&
                    this.NettingSet.Equals(input.NettingSet))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NettingSet != null)
                    hashCode = hashCode * 59 + this.NettingSet.GetHashCode();
