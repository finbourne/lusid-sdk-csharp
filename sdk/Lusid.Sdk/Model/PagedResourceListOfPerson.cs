...
namespace Lusid.Sdk.Model
{
    ...
    public partial class PagedResourceListOfPerson : IEquatable<PagedResourceListOfPerson>
    {
        /// <summary>
        ...
        public PagedResourceListOfPerson(string nextPage = default(string), string previousPage = default(string), List<Person> values = default(List<Person>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfPerson and cannot be null");
