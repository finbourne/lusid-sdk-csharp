...
namespace Lusid.Sdk.Model
{
    ...
    public partial class AggregationResponseNode :  IEquatable<AggregationResponseNode>
    {
        ...
        public AggregationResponseNode(string Key = default(string), string Value = default(string), int? Depth = default(int?), Dictionary<string, Object> Properties = default(Dictionary<string, Object>), List<AggregationResponseNode> Children = default(List<AggregationResponseNode>))
        {
            this.Key = Key;
            this.Value = Value;
            this.Depth = Depth;
