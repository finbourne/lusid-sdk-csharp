...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BoolComplianceParameter_allOf")]
    public partial class BoolComplianceParameterAllOf : IEquatable<BoolComplianceParameterAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoolComplianceParameterAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BoolComplianceParameterAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BoolComplianceParameterAllOf" /> class.
        /// </summary>
        ...
        public BoolComplianceParameterAllOf(bool value = default(bool), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum))
        {
            this.Value = value;
        ...
        {
            return this.Equals(input as BoolComplianceParameterAllOf);
        }

        /// <summary>
        /// Returns true if BoolComplianceParameterAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of BoolComplianceParameterAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BoolComplianceParameterAllOf input)
        {
            if (input == null)
            {
                return false;
