...
namespace Lusid.Sdk.Model
{
    ...
    public partial class Schema :  IEquatable<Schema>
    {
        ...
        public Schema(string Entity = default(string), string Href = default(string), List<KeyValuePairOfStringToFieldSchema> Values = default(List<KeyValuePairOfStringToFieldSchema>), List<Link> Links = default(List<Link>))
        {
            this.Entity = Entity;
            this.Href = Href;
            this.Values = Values;
        ...
        public List<KeyValuePairOfStringToFieldSchema> Values { get; set; }
