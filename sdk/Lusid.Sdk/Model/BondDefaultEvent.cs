...
namespace Lusid.Sdk.Model
{
    ...
    public partial class BondDefaultEvent : InstrumentEvent, IEquatable<BondDefaultEvent>
    {
        /// <summary>
        ...
        public BondDefaultEvent(decimal amount = default(decimal), DateTimeOffset couponPaidDate = default(DateTimeOffset), string defaultStatus = default(string), string defaultType = default(string), DateTimeOffset graceEndDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base(instrumentEventType)
        {
            ...
            this.DefaultStatus = defaultStatus ?? throw new ArgumentNullException("defaultStatus is a required property for BondDefaultEvent and cannot be null");
            // to ensure "defaultType" is required (not null)
            this.DefaultType = defaultType ?? throw new ArgumentNullException("defaultType is a required property for BondDefaultEvent and cannot be null");
        ...
        [DataMember(Name = "couponPaidDate", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "defaultStatus", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "defaultType", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "graceEndDate", IsRequired = true, EmitDefaultValue = false)]
