...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DividendOptionEvent_allOf")]
    public partial class DividendOptionEventAllOf : IEquatable<DividendOptionEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DividendOptionEventAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DividendOptionEventAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DividendOptionEventAllOf" /> class.
        /// </summary>
        ...
        public DividendOptionEventAllOf(DateTimeOffset? announcementDate = default(DateTimeOffset?), List<CashElection> cashElections = default(List<CashElection>), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset? recordDate = default(DateTimeOffset?), List<SecurityElection> securityElections = default(List<SecurityElection>), DateTimeOffset securitySettlementDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum))
        {
            ...
            {
                throw new ArgumentNullException("cashElections is a required property for DividendOptionEventAllOf and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("securityElections is a required property for DividendOptionEventAllOf and cannot be null");
            }
        ...
        {
            return this.Equals(input as DividendOptionEventAllOf);
        }

        /// <summary>
        /// Returns true if DividendOptionEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DividendOptionEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DividendOptionEventAllOf input)
        {
            if (input == null)
            {
                return false;
