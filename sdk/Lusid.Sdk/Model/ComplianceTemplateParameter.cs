...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ComplianceTemplateParameter : IEquatable<ComplianceTemplateParameter>
    {
        /// <summary>
        ...
        /// <param name="isCheckingParameter">Indicates whether this is the Compliance Template Parameter that will be used in the final check process (required).</param>
        public ComplianceTemplateParameter(string name = default(string), string description = default(string), string type = default(string), bool isCheckingParameter = default(bool))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ComplianceTemplateParameter and cannot be null");
            // to ensure "description" is required (not null)
            this.Description = description ?? throw new ArgumentNullException("description is a required property for ComplianceTemplateParameter and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for ComplianceTemplateParameter and cannot be null");
        ...
        /// </summary>
        /// <value>Indicates whether this is the Compliance Template Parameter that will be used in the final check process</value>
        [DataMember(Name = "isCheckingParameter", IsRequired = true, EmitDefaultValue = true)]
        public bool IsCheckingParameter { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsCheckingParameter: ").Append(IsCheckingParameter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(ComplianceTemplateParameter input)
        {
            ...
            return 
                ...
                (
                    this.IsCheckingParameter == input.IsCheckingParameter ||
                    this.IsCheckingParameter.Equals(input.IsCheckingParameter)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.IsCheckingParameter.GetHashCode();
                return hashCode;
            }
        }
