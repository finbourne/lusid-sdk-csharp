...
namespace Lusid.Sdk.Model
{
    ...
    public partial class UpsertComplianceRuleRequest : IEquatable<UpsertComplianceRuleRequest>
    {
        ...
        public UpsertComplianceRuleRequest(ResourceId id = default(ResourceId), string name = default(string), string description = default(string), bool active = default(bool), ResourceId templateId = default(ResourceId), string variation = default(string), Dictionary<string, ComplianceParameter> parameters = default(Dictionary<string, ComplianceParameter>), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>))
        {
