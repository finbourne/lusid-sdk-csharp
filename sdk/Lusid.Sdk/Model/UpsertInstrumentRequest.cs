...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpsertInstrumentRequest :  IEquatable<UpsertInstrumentRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertInstrumentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsertInstrumentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertInstrumentRequest" /> class.
        /// </summary>
        /// <param name="Name">Required. The name of the instrument (required).</param>
        /// <param name="Identifiers">Required. A set of identifiers that uniquely identify this instrument (e.g FIGI, RIC) (required).</param>
        /// <param name="LookThroughPortfolioId">Optional. The identifier of the portfolio that represents this instrument.</param>
        /// <param name="Definition">Expanded instrument definition - in the case of OTC instruments  this contains the definition of the non-exchange traded instrument.  The format for this can be client-defined, but in order to transparently use  vendor libraries it must conform to a format that LUSID understands..</param>
        public UpsertInstrumentRequest(string Name = default(string), Dictionary<string, string> Identifiers = default(Dictionary<string, string>), ResourceId LookThroughPortfolioId = default(ResourceId), InstrumentEconomicDefinition Definition = default(InstrumentEconomicDefinition))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for UpsertInstrumentRequest and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Identifiers == null)
            {
                throw new InvalidDataException("Identifiers is a required property for UpsertInstrumentRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Required. The name of the instrument</value>
        ...
        /// </summary>
        /// <value>Required. A set of identifiers that uniquely identify this instrument (e.g FIGI, RIC)</value>
        ...
        /// </summary>
        /// <value>Optional. The identifier of the portfolio that represents this instrument</value>
        ...
        {
            return this.Equals(input as UpsertInstrumentRequest);
        }

        /// <summary>
        /// Returns true if UpsertInstrumentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertInstrumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertInstrumentRequest input)
        {
            if (input == null)
                return false;
