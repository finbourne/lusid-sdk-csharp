...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfReferenceListResponse")]
    public partial class PagedResourceListOfReferenceListResponse : IEquatable<PagedResourceListOfReferenceListResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfReferenceListResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PagedResourceListOfReferenceListResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResourceListOfReferenceListResponse" /> class.
        /// </summary>
        ...
        public PagedResourceListOfReferenceListResponse(string nextPage = default(string), string previousPage = default(string), List<ReferenceListResponse> values = default(List<ReferenceListResponse>), string href = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            this.Values = values ?? throw new ArgumentNullException("values is a required property for PagedResourceListOfReferenceListResponse and cannot be null");
        ...
        public List<ReferenceListResponse> Values { get; set; }
        ...
        {
            return this.Equals(input as PagedResourceListOfReferenceListResponse);
        }

        /// <summary>
        /// Returns true if PagedResourceListOfReferenceListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResourceListOfReferenceListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResourceListOfReferenceListResponse input)
        {
            if (input == null)
                return false;
