...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfInstrument :  IEquatable<ResourceListOfInstrument>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfInstrument(List<Instrument> values = default(List<Instrument>), string href = default(string), List<Link> links = default(List<Link>))
        {
