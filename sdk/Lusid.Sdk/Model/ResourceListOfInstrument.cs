...
namespace Lusid.Sdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfInstrument :  IEquatable<ResourceListOfInstrument>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfInstrument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfInstrument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfInstrument" /> class.
        /// </summary>
        ...
        public ResourceListOfInstrument(List<Instrument> values = default(List<Instrument>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for ResourceListOfInstrument and cannot be null");
            }
            else
            {
                this.Values = values;
        ...
        {
            return this.Equals(input as ResourceListOfInstrument);
        }

        /// <summary>
        /// Returns true if ResourceListOfInstrument instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfInstrument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfInstrument input)
        {
            if (input == null)
                return false;
