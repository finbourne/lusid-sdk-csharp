...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfDataType :  IEquatable<ResourceListOfDataType>
    {
        ...
        public ResourceListOfDataType(List<DataType> values = default(List<DataType>), string href = default(string), int? count = default(int?), List<Link> links = default(List<Link>))
        {
