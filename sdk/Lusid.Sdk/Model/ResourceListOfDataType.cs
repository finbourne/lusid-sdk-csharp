...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceListOfDataType :  IEquatable<ResourceListOfDataType>
    {
        ...
        public ResourceListOfDataType(List<DataType> values = default(List<DataType>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
