...
namespace Lusid.Sdk.Model
{
    ...
    public partial class ResourceId :  IEquatable<ResourceId>
    {
        ...
        public ResourceId(string scope = default(string), string code = default(string))
        {
            ...
            if (scope == null)
            {
                throw new InvalidDataException("scope is a required property for ResourceId and cannot be null");
            }
            else
            {
                this.Scope = scope;
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for ResourceId and cannot be null");
            }
            else
            {
                this.Code = code;
