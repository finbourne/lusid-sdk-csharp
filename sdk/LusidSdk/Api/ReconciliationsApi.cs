...
namespace LusidSdk.Api
{
    ...
    public interface IReconciliationsApi : IApiAccessor
    {
        ...
        ApiResponse<ResourceListOfReconciliationBreak> ReconcileHoldingsWithHttpInfo (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ResourceListOfReconciliationBreak> ReconcileHoldingsAsync (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<ResourceListOfReconciliationBreak>> ReconcileHoldingsAsyncWithHttpInfo (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null);
    ...
    public partial class ReconciliationsApi : IReconciliationsApi
    {
        ...
        /// <returns></returns>
        public ReconciliationsApi(LusidSdk.Client.Configuration configuration = null)
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ResourceListOfReconciliationBreak</returns>
        public ResourceListOfReconciliationBreak ReconcileHoldings (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfReconciliationBreak> localVarResponse = ReconcileHoldingsWithHttpInfo(request, sortBy, start, limit, filter);
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of ResourceListOfReconciliationBreak</returns>
        public ApiResponse< ResourceListOfReconciliationBreak > ReconcileHoldingsWithHttpInfo (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ResourceListOfReconciliationBreak</returns>
        public async System.Threading.Tasks.Task<ResourceListOfReconciliationBreak> ReconcileHoldingsAsync (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
             ApiResponse<ResourceListOfReconciliationBreak> localVarResponse = await ReconcileHoldingsAsyncWithHttpInfo(request, sortBy, start, limit, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (ResourceListOfReconciliationBreak)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ResourceListOfReconciliationBreak>> ReconcileHoldingsAsyncWithHttpInfo (PortfoliosReconciliationRequest request = null, List<string> sortBy = null, int? start = null, int? limit = null, string filter = null)
        {
