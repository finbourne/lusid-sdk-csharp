...
namespace LusidSdk.Api
{
    ...
    public interface IResultsApi : IApiAccessor
    {
        ...
        /// <param name="date">The date for which the data was loaded</param>
        ...
        ApiResponse<Results> GetResultsWithHttpInfo (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null);
        /// <summary>
        /// Upsert results
        /// </summary>
        /// <remarks>
        ...
        /// <param name="scope">The scope of the data</param>
        /// <param name="key">The key that identifies the data</param>
        /// <param name="date">The date for which the data is relevant</param>
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Results</returns>
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        ApiResponse<Results> UpsertResultsWithHttpInfo (string scope, string key, DateTimeOffset? date, CreateResults request = null);
        ...
        System.Threading.Tasks.Task<Results> GetResultsAsync (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<Results>> GetResultsAsyncWithHttpInfo (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null);
        /// <summary>
        /// Upsert results
        /// </summary>
        /// <remarks>
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Task of Results</returns>
        System.Threading.Tasks.Task<Results> UpsertResultsAsync (string scope, string key, DateTimeOffset? date, CreateResults request = null);
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        System.Threading.Tasks.Task<ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (string scope, string key, DateTimeOffset? date, CreateResults request = null);
    ...
    public partial class ResultsApi : IResultsApi
    {
        ...
        /// <returns></returns>
        public ResultsApi(LusidSdk.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Get results Retrieve some previously stored results
        /// </summary>
        /// <exception cref="LusidSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the data</param>
        /// <param name="key">The key that identifies the data</param>
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Results</returns>
        public Results GetResults (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null)
        {
             ApiResponse<Results> localVarResponse = GetResultsWithHttpInfo(scope, key, date, asAt, sortBy, start, limit);
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        public ApiResponse< Results > GetResultsWithHttpInfo (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ResultsApi->GetResults");
            // verify the required parameter 'key' is set
            if (key == null)
                throw new ApiException(400, "Missing required parameter 'key' when calling ResultsApi->GetResults");
            // verify the required parameter 'date' is set
            if (date == null)
                throw new ApiException(400, "Missing required parameter 'date' when calling ResultsApi->GetResults");

            var localVarPath = "./api/results/{scope}/{key}/{date}";
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of Results</returns>
        public async System.Threading.Tasks.Task<Results> GetResultsAsync (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null)
        {
             ApiResponse<Results> localVarResponse = await GetResultsAsyncWithHttpInfo(scope, key, date, asAt, sortBy, start, limit);
             return localVarResponse.Data;
        ...
        /// <param name="limit">Optional. When paginating, limit the number of returned results to this many. (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Results>> GetResultsAsyncWithHttpInfo (string scope, string key, DateTimeOffset? date, DateTimeOffset? asAt = null, List<string> sortBy = null, int? start = null, int? limit = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ResultsApi->GetResults");
        ...
        /// <summary>
        /// Upsert results Upsert pre-calculated results against a specified scope/key/date combination
        /// </summary>
        /// <exception cref="LusidSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the data</param>
        /// <param name="key">The key that identifies the data</param>
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Results</returns>
        public Results UpsertResults (string scope, string key, DateTimeOffset? date, CreateResults request = null)
        {
             ApiResponse<Results> localVarResponse = UpsertResultsWithHttpInfo(scope, key, date, request);
             return localVarResponse.Data;
        }
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>ApiResponse of Results</returns>
        public ApiResponse< Results > UpsertResultsWithHttpInfo (string scope, string key, DateTimeOffset? date, CreateResults request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ResultsApi->UpsertResults");
            // verify the required parameter 'key' is set
            if (key == null)
                throw new ApiException(400, "Missing required parameter 'key' when calling ResultsApi->UpsertResults");
            // verify the required parameter 'date' is set
            if (date == null)
                throw new ApiException(400, "Missing required parameter 'date' when calling ResultsApi->UpsertResults");
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Task of Results</returns>
        public async System.Threading.Tasks.Task<Results> UpsertResultsAsync (string scope, string key, DateTimeOffset? date, CreateResults request = null)
        {
             ApiResponse<Results> localVarResponse = await UpsertResultsAsyncWithHttpInfo(scope, key, date, request);
             return localVarResponse.Data;
        ...
        /// <param name="request">The results to upload (optional)</param>
        /// <returns>Task of ApiResponse (Results)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Results>> UpsertResultsAsyncWithHttpInfo (string scope, string key, DateTimeOffset? date, CreateResults request = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling ResultsApi->UpsertResults");
