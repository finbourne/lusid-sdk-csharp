...
namespace LusidSdk.Api
{
    ...
    public partial class PortfoliosApi : IPortfoliosApi
    {
        ...
        /// <returns></returns>
        public PortfoliosApi(LusidSdk.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Delete portfolios Delete one, many or all property values from a portfolio for the specified effectiveAt                Specifying no effectiveAt will delete all properties
        /// </summary>
        /// <exception cref="LusidSdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="scope">The scope of the portfolio</param>
        /// <param name="code">Code for the portfolio</param>
