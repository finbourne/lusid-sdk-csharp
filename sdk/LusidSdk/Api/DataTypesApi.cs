...
namespace LusidSdk.Api
{
    ...
    public interface IDataTypesApi : IApiAccessor
    {
        ...
        /// <returns>IUnitDefinition</returns>
        ...
        /// <param name="units">One or more unit identifiers for which the definition is being requested (optional)</param>
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of IUnitDefinition</returns>
        ApiResponse<IUnitDefinition> GetUnitsFromDataTypeWithHttpInfo (string scope, string code, List<string> units = null, string filter = null);
        /// <summary>
        /// List data types
        /// </summary>
        /// <remarks>
        ...
        /// <param name="units">One or more unit identifiers for which the definition is being requested (optional)</param>
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of IUnitDefinition</returns>
        System.Threading.Tasks.Task<IUnitDefinition> GetUnitsFromDataTypeAsync (string scope, string code, List<string> units = null, string filter = null);
        ...
        /// <param name="units">One or more unit identifiers for which the definition is being requested (optional)</param>
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (IUnitDefinition)</returns>
        System.Threading.Tasks.Task<ApiResponse<IUnitDefinition>> GetUnitsFromDataTypeAsyncWithHttpInfo (string scope, string code, List<string> units = null, string filter = null);
        /// <summary>
        /// List data types
        /// </summary>
        /// <remarks>
    ...
    public partial class DataTypesApi : IDataTypesApi
    {
        ...
        /// <returns></returns>
        public DataTypesApi(LusidSdk.Client.Configuration configuration = null)
        {
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>IUnitDefinition</returns>
        public IUnitDefinition GetUnitsFromDataType (string scope, string code, List<string> units = null, string filter = null)
        {
             ApiResponse<IUnitDefinition> localVarResponse = GetUnitsFromDataTypeWithHttpInfo(scope, code, units, filter);
             return localVarResponse.Data;
        }
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>ApiResponse of IUnitDefinition</returns>
        public ApiResponse< IUnitDefinition > GetUnitsFromDataTypeWithHttpInfo (string scope, string code, List<string> units = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
            ...
            return new ApiResponse<IUnitDefinition>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key,  x => String.Join(",", x.Value.ToArray())),
                (IUnitDefinition) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(IUnitDefinition)));
        }
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of IUnitDefinition</returns>
        public async System.Threading.Tasks.Task<IUnitDefinition> GetUnitsFromDataTypeAsync (string scope, string code, List<string> units = null, string filter = null)
        {
             ApiResponse<IUnitDefinition> localVarResponse = await GetUnitsFromDataTypeAsyncWithHttpInfo(scope, code, units, filter);
             return localVarResponse.Data;
        ...
        /// <param name="filter">Optional. Expression to filter the result set (optional)</param>
        /// <returns>Task of ApiResponse (IUnitDefinition)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<IUnitDefinition>> GetUnitsFromDataTypeAsyncWithHttpInfo (string scope, string code, List<string> units = null, string filter = null)
        {
            // verify the required parameter 'scope' is set
            if (scope == null)
                throw new ApiException(400, "Missing required parameter 'scope' when calling DataTypesApi->GetUnitsFromDataType");
