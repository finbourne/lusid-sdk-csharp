...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TryAddClientInstruments :  IEquatable<TryAddClientInstruments>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TryAddClientInstruments" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Values">Values.</param>
        /// <param name="Failed">Failed.</param>
        /// <param name="Links">Links.</param>
        public TryAddClientInstruments(string Href = default(string), Dictionary<string, Instrument> Values = default(Dictionary<string, Instrument>), Dictionary<string, ErrorDetail> Failed = default(Dictionary<string, ErrorDetail>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Values = Values;
            this.Failed = Failed;
        ...
        {
            return this.Equals(input as TryAddClientInstruments);
        }

        /// <summary>
        /// Returns true if TryAddClientInstruments instances are equal
        /// </summary>
        /// <param name="input">Instance of TryAddClientInstruments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TryAddClientInstruments input)
        {
            if (input == null)
                return false;
