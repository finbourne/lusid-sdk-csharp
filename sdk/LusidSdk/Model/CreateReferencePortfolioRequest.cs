...
namespace LusidSdk.Model
{
    ...
    public partial class CreateReferencePortfolioRequest :  IEquatable<CreateReferencePortfolioRequest>
    {
        ...
        public CreateReferencePortfolioRequest(string DisplayName = default(string), string Description = default(string), string Code = default(string), DateTimeOffset? Created = default(DateTimeOffset?))
        {
