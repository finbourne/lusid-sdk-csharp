...
namespace LusidSdk.Model
{
    ...
    public partial class TransactionConfigurationMovementData :  IEquatable<TransactionConfigurationMovementData>
    {
        ...
        public enum SideEnum
        {
            ...
            /// <summary>
            /// Enum Side1 for value: Side1
            /// </summary>
            [EnumMember(Value = "Side1")]
            Side1 = 1,
            
            /// <summary>
            /// Enum Side2 for value: Side2
            /// </summary>
            [EnumMember(Value = "Side2")]
            Side2 = 2,
            
            /// <summary>
            /// Enum BondInt for value: BondInt
            /// </summary>
            [EnumMember(Value = "BondInt")]
            BondInt = 3
        }
        ...
        public TransactionConfigurationMovementData(MovementTypesEnum MovementTypes = default(MovementTypesEnum), SideEnum Side = default(SideEnum), int? Direction = default(int?), List<Property> Properties = default(List<Property>), List<TransactionPropertyMapping> Mappings = default(List<TransactionPropertyMapping>))
        {
