...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpsertPersonalisationResponse :  IEquatable<UpsertPersonalisationResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertPersonalisationResponse" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Links">Links.</param>
        public UpsertPersonalisationResponse(string Href = default(string), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Links = Links;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpsertPersonalisationResponse {\n");
        ...
        {
            return this.Equals(input as UpsertPersonalisationResponse);
        }

        /// <summary>
        /// Returns true if UpsertPersonalisationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertPersonalisationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertPersonalisationResponse input)
        {
            if (input == null)
                return false;
