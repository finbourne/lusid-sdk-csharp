...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfReferencePortfolioConstituent :  IEquatable<ResourceListOfReferencePortfolioConstituent>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfReferencePortfolioConstituent" /> class.
        /// </summary>
        ...
        public ResourceListOfReferencePortfolioConstituent(List<ReferencePortfolioConstituent> Values = default(List<ReferencePortfolioConstituent>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<ReferencePortfolioConstituent> Values { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfReferencePortfolioConstituent {\n");
        ...
        {
            return this.Equals(input as ResourceListOfReferencePortfolioConstituent);
        }

        /// <summary>
        /// Returns true if ResourceListOfReferencePortfolioConstituent instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfReferencePortfolioConstituent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfReferencePortfolioConstituent input)
        {
            if (input == null)
                return false;
