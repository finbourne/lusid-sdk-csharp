...
namespace LusidSdk.Model
{
    ...
    public partial class ReferencePortfolioConstituentRequest :  IEquatable<ReferencePortfolioConstituentRequest>
    {
        ...
        public ReferencePortfolioConstituentRequest(string InstrumentUid = default(string), Dictionary<string, PerpetualPropertyValue> Properties = default(Dictionary<string, PerpetualPropertyValue>), double? Weight = default(double?), TypeEnum? Type = default(TypeEnum?))
        {
