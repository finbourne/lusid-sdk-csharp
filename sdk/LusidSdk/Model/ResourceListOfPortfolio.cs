...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfPortfolio :  IEquatable<ResourceListOfPortfolio>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfPortfolio" /> class.
        /// </summary>
        ...
        public ResourceListOfPortfolio(List<Portfolio> Values = default(List<Portfolio>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public List<Portfolio> Values { get; set; }
        ...
        {
            return this.Equals(input as ResourceListOfPortfolio);
        }

        /// <summary>
        /// Returns true if ResourceListOfPortfolio instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfPortfolio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfPortfolio input)
        {
            if (input == null)
                return false;
