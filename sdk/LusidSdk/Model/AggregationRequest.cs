...
namespace LusidSdk.Model
{
    ...
    public partial class AggregationRequest :  IEquatable<AggregationRequest>
    {
        ...
        /// <param name="LoadReferencePortfolio">LoadReferencePortfolio.</param>
        ...
        public AggregationRequest(ResourceId RecipeId = default(ResourceId), bool? LoadReferencePortfolio = default(bool?), DateTimeOffset? AsAt = default(DateTimeOffset?), DateTimeOffset? EffectiveAt = default(DateTimeOffset?), List<AggregateSpec> Metrics = default(List<AggregateSpec>), List<string> GroupBy = default(List<string>), List<PropertyFilter> Filters = default(List<PropertyFilter>), int? Limit = default(int?), string Sort = default(string))
        {
            // to ensure "RecipeId" is required (not null)
            if (RecipeId == null)
            {
                throw new InvalidDataException("RecipeId is a required property for AggregationRequest and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets LoadReferencePortfolio
        /// </summary>
        [DataMember(Name="loadReferencePortfolio", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  LoadReferencePortfolio: ").Append(LoadReferencePortfolio).Append("\n");
        ...
        public bool Equals(AggregationRequest input)
        {
            ...
            return 
                ...
                (
                    this.LoadReferencePortfolio == input.LoadReferencePortfolio ||
                    (this.LoadReferencePortfolio != null &&
                    this.LoadReferencePortfolio.Equals(input.LoadReferencePortfolio))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.LoadReferencePortfolio != null)
                    hashCode = hashCode * 59 + this.LoadReferencePortfolio.GetHashCode();
                if (this.AsAt != null)
