...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateClientInstrumentRequest :  IEquatable<CreateClientInstrumentRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClientInstrumentRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateClientInstrumentRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClientInstrumentRequest" /> class.
        /// </summary>
        /// <param name="ClientInstrumentId">ClientInstrumentId (required).</param>
        /// <param name="Name">Name (required).</param>
        /// <param name="LookThroughPortfolioId">LookThroughPortfolioId.</param>
        /// <param name="Instrument">Expanded instrument definition - in the case of OTC instruments  this contains the definition of the non-exchange traded instrument.  The format for this can be client-defined, but in order to transparently use  vendor libraries it must conform to a format that LUSID understands..</param>
        public CreateClientInstrumentRequest(string ClientInstrumentId = default(string), string Name = default(string), ResourceId LookThroughPortfolioId = default(ResourceId), InstrumentDefinition Instrument = default(InstrumentDefinition))
        {
            // to ensure "ClientInstrumentId" is required (not null)
            if (ClientInstrumentId == null)
            {
                throw new InvalidDataException("ClientInstrumentId is a required property for CreateClientInstrumentRequest and cannot be null");
            }
            else
            {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for CreateClientInstrumentRequest and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        /// <summary>
        /// Gets or Sets ClientInstrumentId
        /// </summary>
        [DataMember(Name="clientInstrumentId", EmitDefaultValue=false)]
        ...
        /// </summary>
        /// <value>Expanded instrument definition - in the case of OTC instruments  this contains the definition of the non-exchange traded instrument.  The format for this can be client-defined, but in order to transparently use  vendor libraries it must conform to a format that LUSID understands.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClientInstrumentId: ").Append(ClientInstrumentId).Append("\n");
        ...
        {
            return this.Equals(input as CreateClientInstrumentRequest);
        }

        /// <summary>
        /// Returns true if CreateClientInstrumentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateClientInstrumentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateClientInstrumentRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ClientInstrumentId == input.ClientInstrumentId ||
                    (this.ClientInstrumentId != null &&
                    this.ClientInstrumentId.Equals(input.ClientInstrumentId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ClientInstrumentId != null)
                    hashCode = hashCode * 59 + this.ClientInstrumentId.GetHashCode();
                if (this.Name != null)
