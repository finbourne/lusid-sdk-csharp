...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeleteClientInstrumentsResponse :  IEquatable<DeleteClientInstrumentsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteClientInstrumentsResponse" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Failed">Failed.</param>
        /// <param name="Links">Links.</param>
        public DeleteClientInstrumentsResponse(string Href = default(string), Dictionary<string, ErrorDetail> Failed = default(Dictionary<string, ErrorDetail>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Failed = Failed;
            this.Links = Links;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteClientInstrumentsResponse {\n");
        ...
        {
            return this.Equals(input as DeleteClientInstrumentsResponse);
        }

        /// <summary>
        /// Returns true if DeleteClientInstrumentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteClientInstrumentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteClientInstrumentsResponse input)
        {
            if (input == null)
                return false;
