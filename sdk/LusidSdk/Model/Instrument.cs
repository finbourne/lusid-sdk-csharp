...
namespace LusidSdk.Model
{
    ...
    public partial class Instrument :  IEquatable<Instrument>
    {
        ...
        public Instrument(string Href = default(string), string Uid = default(string), Version Version = default(Version), string CommonName = default(string), Dictionary<string, string> Aliases = default(Dictionary<string, string>), List<Property> Properties = default(List<Property>), string MarketIdentifierCode = default(string), ResourceId LookthroughPortfolio = default(ResourceId), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Uid = Uid;
