...
namespace LusidSdk.Model
{
    ...
    public partial class ResultDataSchema :  IEquatable<ResultDataSchema>
    {
        ...
        public ResultDataSchema(List<KeyValuePairOfPropertyKeyToFieldSchema> NodeValueSchema = default(List<KeyValuePairOfPropertyKeyToFieldSchema>), Dictionary<string, FieldSchema> PropertySchema = default(Dictionary<string, FieldSchema>))
        {
        ...
        public List<KeyValuePairOfPropertyKeyToFieldSchema> NodeValueSchema { get; set; }
