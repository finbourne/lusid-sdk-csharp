...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfScope :  IEquatable<ResourceListOfScope>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfScope" /> class.
        /// </summary>
        ...
        public ResourceListOfScope(List<string> Values = default(List<string>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceListOfScope {\n");
        ...
        {
            return this.Equals(input as ResourceListOfScope);
        }

        /// <summary>
        /// Returns true if ResourceListOfScope instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfScope to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfScope input)
        {
            if (input == null)
                return false;
