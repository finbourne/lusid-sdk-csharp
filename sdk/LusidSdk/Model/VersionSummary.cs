...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VersionSummary :  IEquatable<VersionSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VersionSummary" /> class.
        /// </summary>
        /// <param name="Links">Links.</param>
        public VersionSummary(List<Link> Links = default(List<Link>))
        {
            this.Links = Links;
        }
        ...
        {
            return this.Equals(input as VersionSummary);
        }

        /// <summary>
        /// Returns true if VersionSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of VersionSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VersionSummary input)
        {
            if (input == null)
                return false;
