...
using SwaggerDateConverter = LusidSdk.Client.SwaggerDateConverter;

namespace LusidSdk.Model
{
    /// <summary>
    /// AddTransactionPropertyResponse
    /// </summary>
    [DataContract]
    public partial class AddTransactionPropertyResponse :  IEquatable<AddTransactionPropertyResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddTransactionPropertyResponse" /> class.
        /// </summary>
        /// <param name="Href">Href.</param>
        /// <param name="Version">Version.</param>
        /// <param name="Links">Links.</param>
        public AddTransactionPropertyResponse(string Href = default(string), Version Version = default(Version), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddTransactionPropertyResponse {\n");
        ...
        {
            return this.Equals(input as AddTransactionPropertyResponse);
        }

        /// <summary>
        /// Returns true if AddTransactionPropertyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AddTransactionPropertyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddTransactionPropertyResponse input)
        {
            if (input == null)
                return false;
