...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InstrumentProperty :  IEquatable<InstrumentProperty>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentProperty" /> class.
        /// </summary>
        /// <param name="InstrumentUid">Unique instrument identifier.</param>
        /// <param name="Properties">Properties.</param>
        public InstrumentProperty(string InstrumentUid = default(string), List<CreateInstrumentPropertyRequest> Properties = default(List<CreateInstrumentPropertyRequest>))
        {
        ...
        public List<CreateInstrumentPropertyRequest> Properties { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InstrumentProperty {\n");
        ...
        {
            return this.Equals(input as InstrumentProperty);
        }

        /// <summary>
        /// Returns true if InstrumentProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentProperty input)
        {
            if (input == null)
                return false;
