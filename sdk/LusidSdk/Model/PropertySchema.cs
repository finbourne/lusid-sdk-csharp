...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PropertySchema :  IEquatable<PropertySchema>
    {
        /// <summary>
        ...
        public PropertySchema(string Href = default(string), List<KeyValuePairOfPropertyKeyToFieldSchema> Values = default(List<KeyValuePairOfPropertyKeyToFieldSchema>), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Values = Values;
            this.Links = Links;
        ...
        public List<KeyValuePairOfPropertyKeyToFieldSchema> Values { get; set; }
