...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PortfolioProperties :  IEquatable<PortfolioProperties>
    {
        /// <summary>
        ...
        public PortfolioProperties(string Href = default(string), ResourceId OriginPortfolioId = default(ResourceId), List<Property> Properties = default(List<Property>), Version Version = default(Version), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
