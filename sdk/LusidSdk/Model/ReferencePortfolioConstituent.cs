...
namespace LusidSdk.Model
{
    ...
    public partial class ReferencePortfolioConstituent :  IEquatable<ReferencePortfolioConstituent>
    {
        ...
        public ReferencePortfolioConstituent(string InstrumentUid = default(string), List<Property> Properties = default(List<Property>), double? Weight = default(double?), TypeEnum? Type = default(TypeEnum?))
        {
