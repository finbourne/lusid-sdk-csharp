...
namespace LusidSdk.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResourceListOfString :  IEquatable<ResourceListOfString>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfString" /> class.
        /// </summary>
        ...
        public ResourceListOfString(List<string> Values = default(List<string>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
        ...
        {
            return this.Equals(input as ResourceListOfString);
        }

        /// <summary>
        /// Returns true if ResourceListOfString instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceListOfString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceListOfString input)
        {
            if (input == null)
                return false;
