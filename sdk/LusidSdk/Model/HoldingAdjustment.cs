...
namespace LusidSdk.Model
{
    ...
    public partial class HoldingAdjustment :  IEquatable<HoldingAdjustment>
    {
        ...
        public HoldingAdjustment(string InstrumentUid = default(string), List<PerpetualProperty> SubHoldingKeys = default(List<PerpetualProperty>), List<PerpetualProperty> Properties = default(List<PerpetualProperty>), List<TargetTaxLot> TaxLots = default(List<TargetTaxLot>))
        {
