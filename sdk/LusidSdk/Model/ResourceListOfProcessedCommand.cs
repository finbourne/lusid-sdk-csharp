...
namespace LusidSdk.Model
{
    ...
    public partial class ResourceListOfProcessedCommand :  IEquatable<ResourceListOfProcessedCommand>
    {
        ...
        public ResourceListOfProcessedCommand(List<ProcessedCommand> Values = default(List<ProcessedCommand>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
