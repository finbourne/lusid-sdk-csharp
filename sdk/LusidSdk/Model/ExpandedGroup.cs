...
namespace LusidSdk.Model
{
    ...
    public partial class ExpandedGroup :  IEquatable<ExpandedGroup>
    {
        ...
        public ExpandedGroup(string Href = default(string), ResourceId Id = default(ResourceId), string Name = default(string), string Description = default(string), List<CompletePortfolio> Values = default(List<CompletePortfolio>), List<ExpandedGroup> SubGroups = default(List<ExpandedGroup>), Version Version = default(Version), List<Link> Links = default(List<Link>))
        {
            this.Href = Href;
            this.Id = Id;
            this.Name = Name;
