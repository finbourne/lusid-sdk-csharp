...
namespace LusidSdk.Model
{
    ...
    public partial class TargetTaxLot :  IEquatable<TargetTaxLot>
    {
        ...
        public TargetTaxLot(double? Units = default(double?), double? Cost = default(double?), double? PortfolioCost = default(double?), double? Price = default(double?), DateTimeOffset? PurchaseDate = default(DateTimeOffset?), DateTimeOffset? SettlementDate = default(DateTimeOffset?))
        {
