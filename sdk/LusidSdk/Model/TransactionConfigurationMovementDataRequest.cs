...
namespace LusidSdk.Model
{
    ...
    public partial class TransactionConfigurationMovementDataRequest :  IEquatable<TransactionConfigurationMovementDataRequest>
    {
        ...
        public TransactionConfigurationMovementDataRequest(MovementTypesEnum MovementTypes = default(MovementTypesEnum), SideEnum Side = default(SideEnum), int? Direction = default(int?), Dictionary<string, PropertyValue> Properties = default(Dictionary<string, PropertyValue>), List<TransactionPropertyMappingRequest> Mappings = default(List<TransactionPropertyMappingRequest>))
        {
