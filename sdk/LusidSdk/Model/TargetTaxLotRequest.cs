...
namespace LusidSdk.Model
{
    ...
    public partial class TargetTaxLotRequest :  IEquatable<TargetTaxLotRequest>
    {
        ...
        public TargetTaxLotRequest(double? Units = default(double?), double? Cost = default(double?), double? PortfolioCost = default(double?), double? Price = default(double?), DateTimeOffset? PurchaseDate = default(DateTimeOffset?), DateTimeOffset? SettlementDate = default(DateTimeOffset?))
        {
