...
namespace LusidSdk.Model
{
    ...
    public partial class ResourceListOfPropertyDefinition :  IEquatable<ResourceListOfPropertyDefinition>
    {
        ...
        public ResourceListOfPropertyDefinition(List<PropertyDefinition> Values = default(List<PropertyDefinition>), string Href = default(string), int? Count = default(int?), List<Link> Links = default(List<Link>))
        {
            this.Values = Values;
            this.Href = Href;
            this.Count = Count;
