...
namespace LusidSdk.Model
{
    ...
    public partial class CreatePortfolioGroupRequest :  IEquatable<CreatePortfolioGroupRequest>
    {
        ...
        public CreatePortfolioGroupRequest(string Id = default(string), List<ResourceId> Values = default(List<ResourceId>), List<ResourceId> SubGroups = default(List<ResourceId>), string DisplayName = default(string), string Description = default(string))
        {
            // to ensure "Id" is required (not null)
            if (Id == null)
            {
                throw new InvalidDataException("Id is a required property for CreatePortfolioGroupRequest and cannot be null");
            }
            else
            {
                this.Id = Id;
