...
namespace LusidSdk.Model
{
    ...
    public partial class InstrumentDefinition :  IEquatable<InstrumentDefinition>
    {
        ...
        public InstrumentDefinition(string InstrumentFormat = default(string), string Content = default(string))
        {
            // to ensure "InstrumentFormat" is required (not null)
            if (InstrumentFormat == null)
            {
                throw new InvalidDataException("InstrumentFormat is a required property for InstrumentDefinition and cannot be null");
            }
            else
            {
            ...
            if (Content == null)
            {
                throw new InvalidDataException("Content is a required property for InstrumentDefinition and cannot be null");
            }
            else
            {
