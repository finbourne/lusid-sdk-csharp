...
namespace LusidSdk.Model
{
    ...
    public partial class DataType :  IEquatable<DataType>
    {
        ...
        public List<IUnitDefinition> AcceptableUnits { get; set; }
