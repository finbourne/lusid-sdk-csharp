# Lusid.Sdk.Model.CapitalCallEvent
...
**Date** | **DateTimeOffset** | The date the capital call takes effect. | [optional] 
**Amount** | **decimal** | The amount of committed capital called. Must be positive. | 
