# Lusid.Sdk.Model.ProtectionPayoutCashFlowEvent
...
**ExDate** | **DateTimeOffset** | The ex-dividend date of the cashflow. | [optional] 
**PaymentDate** | **DateTimeOffset** | The payment date of the cashflow. | [optional] 
