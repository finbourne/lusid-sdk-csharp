...
**Type** | **string** | The type of the property. Available values: Label, Metric, Information. | [optional] 
**UnitSchema** | **string** | The units that can be associated with the property&#39;s values. This is defined by the property&#39;s data type. Available values: NoUnits, Basic, Iso4217Currency. | [optional] 
...
**LifeTime** | **string** | Describes how the property&#39;s values can change over time. Available values: Perpetual, TimeVariant. | [optional] 
...
**PropertyDefinitionType** | **string** | The definition type. Available values: ValueProperty, DerivedDefinition. | [optional] 
