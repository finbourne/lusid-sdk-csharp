# Lusid.Sdk.Model.PikBondPrincipalEvent
...
**ExDate** | **DateTimeOffset** | The ex date (entitlement date) of the principal payment | [optional] 
**PaymentDate** | **DateTimeOffset** | The payment date of the principal | [optional] 
**Currency** | **string** | The currency in which the principal is expressed | 
**PrincipalPerUnit** | **decimal?** | The principal amount per unit of the held bond&#39;s current face | [optional] 
