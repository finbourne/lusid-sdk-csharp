# Lusid.Sdk.Model.WritebackConfiguration
...
using System;
```
 [SettleExpectedActivityWritebackConfiguration](./SettleExpectedActivityWritebackConfiguration.md)See all compatible oneOf types with WritebackConfiguration

# Example with WritebackConfiguration
{
     Type  =  "SettleExpectedActivityWritebackConfiguration"
};
//Create WritebackConfiguration Instance
var writebackConfigurationInstance = new writebackConfiguration(settleExpectedActivityWritebackConfigurationInstance)
