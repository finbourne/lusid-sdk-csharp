...
**ResultType** | **string** | Reconciliation run general result. Available values: Match, PartialMatch, Break, NotFound, Resolved. | 
**ResultStatus** | **string** | Indicates how a particular result evolves from one run to the next. Available values: New, Confirmed, Changed. | 
**ReviewStatus** | **string** | Status of whether user has provided any input (comments, manual matches, break codes). Available values: Pending, Reviewed, Matched, Invalid. | 
