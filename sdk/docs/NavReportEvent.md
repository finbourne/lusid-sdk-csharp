# Lusid.Sdk.Model.NavReportEvent
...
**Date** | **DateTimeOffset** | The date the net asset value is reported as of. | [optional] 
**NetAssetValue** | **decimal** | The reported net asset value of the interest. | 

```csharp
using Lusid.Sdk.Model;
using System;
decimal netAssetValue = "netAssetValue";
