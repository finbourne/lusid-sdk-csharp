# Lusid.Sdk.Model.DividendSuspensionEvent
...
**TargetPaymentDate** | **DateTimeOffset** | The intrinsically-scheduled dividend payment date this event suppresses. A date the instrument&#39;s  own schedule does not pay on leaves the event with no observable effect. | [optional] 
**AnnouncementDate** | **DateTimeOffset?** | The date the issuer disclosed the suspension. Optional — null when not recorded. When populated,  must be &lt;&#x3D; TargetPaymentDate. | [optional] 
