...
------------ | ------------- | ------------- | -------------
**CalculateInstructionToPortfolioRate** | **bool** | An optional flag that allows for the calculation of the instruction to portfolio rate for instructions with settlement category CashSettlement or DeferredCashReceipt, if it is not provided on the settlement instruction. | 
**CalculateTradeDateToSettlementFxPnL** | **bool** | An optional flag that allows for the calculation of FxPnL between Trade and Settlement Date. | 
