...
**ExDate** | **DateTimeOffset** | The ex date (entitlement date) of the interest payment, usually several weeks prior to the payment date | [optional] 
**PaymentDate** | **DateTimeOffset** | The payment date of the interest that is deferred and capitalised | [optional] 
