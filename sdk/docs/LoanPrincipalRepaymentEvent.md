# Lusid.Sdk.Model.LoanPrincipalRepaymentEvent
...
**WithInterest** | **bool** | If set to true, then active contracts whose balance is reduced by the repayment will have  their accrued interest repaid proportionally to the balance reduction. | [optional] 
