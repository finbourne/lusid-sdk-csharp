# Lusid.Sdk.Model.PikBondCouponEvent
...
**ExDate** | **DateTimeOffset** | The ex date (entitlement date) for making the election. | [optional] 
**PaymentDate** | **DateTimeOffset** | The payment date of the coupon period this election governs. | [optional] 
...
List<PikElection> elections = new List<PikElection>();
