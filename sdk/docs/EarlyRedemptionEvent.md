# Lusid.Sdk.Model.EarlyRedemptionEvent
...
**RedemptionPercentage** | **decimal** | Percentage of the issued amount to be redeemed, value between 0 and 1, where 1 is a full redemption | [optional] 
