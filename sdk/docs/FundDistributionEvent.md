# Lusid.Sdk.Model.FundDistributionEvent
...
**Date** | **DateTimeOffset** | The date the distribution takes effect. | [optional] 
**Amount** | **decimal** | The amount distributed. Must be positive. | 
**IsRecallable** | **bool** | True when the fund may recall the distributed amount: the distribution restores unfunded capital  rather than permanently returning it. Defaults to false. This field is optional. | [optional] 
