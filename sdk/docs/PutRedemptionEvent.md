...
**RetainElections** | [**List&lt;RetainElection&gt;**](RetainElection.md) | List of possible retain elections for this event (PROX) — keep the holding rather than redeem. | [optional] 
...
List<RetainElection> retainElections = new List<RetainElection>();
