...
| [**GetComplianceRuleTemplateByEntityUniqueId**](EntitiesApi.md#getcomplianceruletemplatebyentityuniqueid) | **GET** /api/entities/complianceruletemplates/{entityUniqueId} | [EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId |
...
<a id="getcomplianceruletemplatebyentityuniqueid"></a>
# **GetComplianceRuleTemplateByEntityUniqueId**
> ComplianceRuleTemplateEntity GetComplianceRuleTemplateByEntityUniqueId (string entityUniqueId, DateTimeOffset? asAt = null, List<string>? previews = null)
...
namespace Examples
{
    public static class Program
    {
        public static void Main()
        {
            ...
            var apiInstance = ApiFactoryBuilder.Build(secretsFilename).Api<EntitiesApi>();
            var entityUniqueId = "entityUniqueId_example";  // string | The universally unique identifier of the compliance rule template.
            var asAt = DateTimeOffset.Parse("2013-10-20T19:20:30+01:00");  // DateTimeOffset? | The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified. (optional) 
            var previews = new List<string>?(); // List<string>? | The ids of the staged modifications to be previewed in the response. (optional) 

            try
            {
                // uncomment the below to set overrides at the request level
                // ComplianceRuleTemplateEntity result = apiInstance.GetComplianceRuleTemplateByEntityUniqueId(entityUniqueId, asAt, previews, opts: opts);

                // [EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId
                ComplianceRuleTemplateEntity result = apiInstance.GetComplianceRuleTemplateByEntityUniqueId(entityUniqueId, asAt, previews);
                Console.WriteLine(JsonConvert.SerializeObject(result, Formatting.Indented));
            }
            catch (ApiException e)
            {
                Console.WriteLine("Exception when calling EntitiesApi.GetComplianceRuleTemplateByEntityUniqueId: " + e.Message);
                Console.WriteLine("Status Code: " + e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
#### Using the GetComplianceRuleTemplateByEntityUniqueIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // [EARLY ACCESS] GetComplianceRuleTemplateByEntityUniqueId: Get compliance rule template by EntityUniqueId
    ApiResponse<ComplianceRuleTemplateEntity> response = apiInstance.GetComplianceRuleTemplateByEntityUniqueIdWithHttpInfo(entityUniqueId, asAt, previews);
    Console.WriteLine("Status Code: " + response.StatusCode);
    Console.WriteLine("Response Headers: " + JsonConvert.SerializeObject(response.Headers, Formatting.Indented));
    Console.WriteLine("Response Body: " + JsonConvert.SerializeObject(response.Data, Formatting.Indented));
}
...
{
    Console.WriteLine("Exception when calling EntitiesApi.GetComplianceRuleTemplateByEntityUniqueIdWithHttpInfo: " + e.Message);
    Console.WriteLine("Status Code: " + e.ErrorCode);
    Console.WriteLine(e.StackTrace);
}
```
...
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| **entityUniqueId** | **string** | The universally unique identifier of the compliance rule template. |  |
| **asAt** | **DateTimeOffset?** | The asAt datetime at which to retrieve the compliance rule template. Defaults to returning the latest version of the compliance rule template if not specified. | [optional]  |
| **previews** | [**List&lt;string&gt;?**](string.md) | The ids of the staged modifications to be previewed in the response. | [optional]  |

### Return type

[**ComplianceRuleTemplateEntity**](ComplianceRuleTemplateEntity.md)
...
namespace Examples
{
    public static class Program
    {
        public static void Main()
        {
            ...
            var apiInstance = ApiFactoryBuilder.Build(secretsFilename).Api<EntitiesApi>();
            var entityUniqueId = "entityUniqueId_example";  // string | The universally unique identifier of the valuation point.
            var asAt = DateTimeOffset.Parse("2013-10-20T19:20:30+01:00");  // DateTimeOffset? | The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified. (optional) 
            var previews = new List<string>?(); // List<string>? | The ids of the staged modifications to be previewed in the response. (optional) 

            try
            {
                // uncomment the below to set overrides at the request level
                // ValuationPointEntity result = apiInstance.GetValuationPointByEntityUniqueId(entityUniqueId, asAt, previews, opts: opts);
            ...
            {
                Console.WriteLine("Exception when calling EntitiesApi.GetValuationPointByEntityUniqueId: " + e.Message);
                Console.WriteLine("Status Code: " + e.ErrorCode);
                Console.WriteLine(e.StackTrace);
            }
        }
...
#### Using the GetValuationPointByEntityUniqueIdWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    Console.WriteLine("Exception when calling EntitiesApi.GetValuationPointByEntityUniqueIdWithHttpInfo: " + e.Message);
    Console.WriteLine("Status Code: " + e.ErrorCode);
    Console.WriteLine(e.StackTrace);
}
```
...
| **asAt** | **DateTimeOffset?** | The asAt datetime at which to retrieve the valuation point. Defaults to returning the latest version of the valuation point if not specified. | [optional]  |
| **previews** | [**List&lt;string&gt;?**](string.md) | The ids of the staged modifications to be previewed in the response. | [optional]  |
