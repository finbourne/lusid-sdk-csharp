...
**ExerciseType** | **string** | The optionality type of the underlying option. Available values: None, European, Bermudan, American. | 
**MaturityDate** | **DateTimeOffset** | The maturity date of the option. | [optional] 
**Moneyness** | **string** | The moneyness of the option. Available values: Unknown, InTheMoney, OutOfTheMoney, AtTheMoney. | [optional] 
...
**OptionType** | **string** | Type of optionality that is present. Available values: None, Call, Put. | 
**StartDate** | **DateTimeOffset** | The trade date of the option. | [optional] 
