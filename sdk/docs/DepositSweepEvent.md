# Lusid.Sdk.Model.DepositSweepEvent
...
**SweepDate** | **DateTimeOffset** | Date the sweep is effective, and whose cash balance is swept. | [optional] 
**Currency** | **string** | Currency of the swept cash balance. | 
