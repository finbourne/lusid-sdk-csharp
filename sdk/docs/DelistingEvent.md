# Lusid.Sdk.Model.DelistingEvent
...
**EffectiveDate** | **DateTimeOffset** | The date the security is removed from official board quotation (the trading-status change takes effect). | [optional] 
**AnnouncementDate** | **DateTimeOffset?** | The date the delisting was announced. Optional — null when no separate announcement date is provided.  When populated, must be &lt;&#x3D; EffectiveDate. | [optional] 
