...
**Currency** | **string** | Event settlement currency (ISO 4217). Optional: when absent the settlement currency is  taken from the elected path (TenderOfferCurrency, CashOfferCurrency or  FractionalUnitsCashCurrency as applicable). | [optional] 
...
List<UnknownProceedsElection> unknownProceedsElections = new List<UnknownProceedsElection>();decimal? prorationRate = "example prorationRate";
