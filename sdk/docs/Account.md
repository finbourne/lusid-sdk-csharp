...
**Type** | **string** | The Account type. Available values: Asset, Liabilities, Income, Expense, Capital, Revenue. | 
**Status** | **string** | The Account status. Available values: Active, Inactive, Deleted. | 
**Control** | **string** | This allows users to specify whether this a protected Account that prevents direct manual journal adjustment. Default value: Manual. Available values: Manual, System. | [optional] 
